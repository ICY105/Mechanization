...
execute @s ~ ~-498.5 ~ execute @e[tag=living,r=2,c=1] ~ ~ ~ summon arrow ~ ~ ~ {Tags:["projDamage"],pickup:2,damage:5,Motion:[0.0,3.0,0.0]}
execute @s ~ ~-498.5 ~ execute @e[tag=living,c=1,r=2] ~ ~498.5 ~ scoreboard players set @e[tag=rifleLShot,c=1] timer 120
