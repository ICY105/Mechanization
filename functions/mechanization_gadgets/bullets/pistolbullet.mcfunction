...
execute @s ~ ~-498.5 ~ execute @e[tag=living,r=2,c=1] ~ ~ ~ summon arrow ~ ~ ~ {Tags:["projDamage"],pickup:2,damage:4,Motion:[0.0,3.0,0.0]}
execute @s ~ ~-498.5 ~ execute @e[tag=living,r=2,c=1] ~ ~498.5 ~ scoreboard players set @e[tag=pistolShot,c=1] timer 120
...
execute @s ~ ~-498.5 ~ particle reddust ~ ~ ~ 0.1 0.1 0.4 1 0 force