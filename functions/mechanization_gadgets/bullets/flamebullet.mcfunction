...
execute @s ~ ~-498.5 ~ execute @e[tag=living,c=1,r=2] ~ ~499 ~ scoreboard players set @e[tag=flameShot,c=1] timer 120
...
execute @s[score_timer_min=120] ~ ~-498.5 ~ fill ~-1 ~-1 ~-1 ~1 ~1 ~1 minecraft:fire 0 replace minecraft:air

execute @s ~ ~-498.5 ~ particle flame ~ ~ ~ 0.15 0.15 0.15 0 5 force