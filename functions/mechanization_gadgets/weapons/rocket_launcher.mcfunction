...
scoreboard players set @s[m=!1] stick 1 {Inventory:[{id:"minecraft:tnt"}]}
execute @s[m=!1] ~ ~ ~ clear @s minecraft:tnt 0 1
...
scoreboard players set @s[score_stick_min=1] reloadTime 80
execute @s[score_stick_min=1] ~ ~500 ~ scoreboard players tag @e[tag=b1,c=1,score_timer=0] add rocketShot
