...
# run
execute if score #network.tank fluid.data matches 0..3 as @e[tag=fluid.tank,predicate=fluid:v1.2/has_network_id,sort=nearest] run function fluid:v1.2/network/transfer_fluid
