...
function fluid:v1.2/utils/get_fluids_slot_2
...
execute if score #network.dest.tank fluid.data matches 0 unless score @s fluid.storage.0 matches 1.. run function fluid:v1.2/utils/store_fluids_slot_2
...
execute if score #network.dest.tank fluid.data matches 1 unless score @s fluid.storage.1 matches 1.. run function fluid:v1.2/utils/store_fluids_slot_2
...
execute if score #network.dest.tank fluid.data matches 2 unless score @s fluid.storage.2 matches 1.. run function fluid:v1.2/utils/store_fluids_slot_2
...
execute if score #network.dest.tank fluid.data matches 3 unless score @s fluid.storage.3 matches 1.. run function fluid:v1.2/utils/store_fluids_slot_2
