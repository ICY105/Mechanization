...
execute at @s[tag=chunk_scan.chunk] run function chunk_scan:v2.4/chunk/spread
...
execute at @s positioned ~ 0 ~ unless predicate chunk_scan:world_bottom positioned ~ -64 ~ unless predicate chunk_scan:world_bottom run function chunk_scan:v2.4/chunk/generate_3
