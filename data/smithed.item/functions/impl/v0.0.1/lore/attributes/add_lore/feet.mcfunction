...
data modify storage smithed.item:main lore.temp set from storage smithed.item:main lore.slots.feet
execute store result score $iter smithed.data if data storage smithed.item:main lore.temp[]

execute if score $iter smithed.data matches 1.. run function smithed.item:impl/v0.0.1/lore/attributes/add_lore/feet/add_header
