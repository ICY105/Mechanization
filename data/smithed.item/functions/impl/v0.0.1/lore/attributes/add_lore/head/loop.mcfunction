...
execute if score $oper smithed.data matches 1.. run function smithed.item:impl/v0.0.1/lore/attributes/add_lore/head/set_scale
...
scoreboard players operation $whole smithed.data /= $10000 bolt.expr.const
execute if score $decimal smithed.data matches 1.. run function smithed.item:impl/v0.0.1/lore/attributes/add_lore/head/simplify
execute unless score $decimal smithed.data matches 0 run function smithed.item:impl/v0.0.1/lore/attributes/add_lore/head/high_low
execute if score $decimal smithed.data matches 0 run function smithed.item:impl/v0.0.1/lore/attributes/add_lore/head/high
...
execute if data storage smithed.item:main lore.attr{base: 1b} run function smithed.item:impl/v0.0.1/lore/attributes/add_lore/head/equals

execute unless data storage smithed.item:main lore.attr{base: 1b} run function smithed.item:impl/v0.0.1/lore/attributes/add_lore/head/not_equals
