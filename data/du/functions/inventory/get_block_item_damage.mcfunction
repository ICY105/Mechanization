...
execute if score temp_0 du_data >= in_0 du_data run function du:inventory/damage_block/0-13
execute if score temp_0 du_data < in_0 du_data run function du:inventory/damage_block/14-26
