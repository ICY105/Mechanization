...
execute if score temp_0 du_data >= in_0 du_data run function du:inventory/damage_entity/0-20
execute if score temp_0 du_data < in_0 du_data run function du:inventory/damage_entity/21-42
