...
execute if entity @s[nbt={Inventory:[ {Slot: 101b, tag: {Enchantments: [{lvl: 1s, id: "minecraft:unbreaking"}]}} ]}] run scoreboard players set temp_5 du_data 1
execute if entity @s[nbt={Inventory:[ {Slot: 101b, tag: {Enchantments: [{lvl: 2s, id: "minecraft:unbreaking"}]}} ]}] run scoreboard players set temp_5 du_data 2
execute if entity @s[nbt={Inventory:[ {Slot: 101b, tag: {Enchantments: [{lvl: 3s, id: "minecraft:unbreaking"}]}} ]}] run scoreboard players set temp_5 du_data 3
...
execute if score temp_4 du_data matches 0 if score temp_2 du_data matches ..0 run replaceitem entity @s armor.legs air
