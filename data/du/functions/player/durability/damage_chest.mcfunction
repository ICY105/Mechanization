...
execute if entity @s[nbt={Inventory:[ {Slot: 102b, tag: {Enchantments: [{lvl: 1s, id: "minecraft:unbreaking"}]}} ]}] run scoreboard players set temp_5 du_data 1
execute if entity @s[nbt={Inventory:[ {Slot: 102b, tag: {Enchantments: [{lvl: 2s, id: "minecraft:unbreaking"}]}} ]}] run scoreboard players set temp_5 du_data 2
execute if entity @s[nbt={Inventory:[ {Slot: 102b, tag: {Enchantments: [{lvl: 3s, id: "minecraft:unbreaking"}]}} ]}] run scoreboard players set temp_5 du_data 3
