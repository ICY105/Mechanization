...
execute if entity @s[tag=!du_click_active] run summon villager ~ ~ ~ {Tags:["du_click_villager","du_click_4"],NoGravity:1b,Profession:5,NoAI:1,Silent:1,Team:"du_nopush",ActiveEffects:[{Id:14,Amplifier:0,Duration:2000000,ShowParticles:0b},{Id:11,Amplifier:3,Duration:2000000,ShowParticles:0b},{Id:6,Amplifier:127,Duration:2000000,ShowParticles:0b}],Attributes:[{Name:generic.maxHealth,Base:1000000}],Health:1000000.0f}
...
execute if entity @s[tag=du_moving] as @e[tag=du_click_villager,type=villager,tag=du_click_1] if score @s du_data = temp_0 du_data positioned ~ ~0.5 ~ run tp @s ^1 ^ ^
execute if entity @s[tag=du_moving] as @e[tag=du_click_villager,type=villager,tag=du_click_2] if score @s du_data = temp_0 du_data positioned ~ ~0.5 ~ run tp @s ^0.5 ^ ^1
execute if entity @s[tag=du_moving] as @e[tag=du_click_villager,type=villager,tag=du_click_3] if score @s du_data = temp_0 du_data positioned ~ ~0.5 ~ run tp @s ^ ^ ^1.5
execute if entity @s[tag=du_moving] as @e[tag=du_click_villager,type=villager,tag=du_click_4] if score @s du_data = temp_0 du_data positioned ~ ~0.5 ~ run tp @s ^-0.5 ^ ^1
execute if entity @s[tag=du_moving] as @e[tag=du_click_villager,type=villager,tag=du_click_5] if score @s du_data = temp_0 du_data positioned ~ ~0.5 ~ run tp @s ^-1 ^ ^
