...
execute store result score temp_1 du_data run data get block ~ ~ ~ Items[20].Count
execute if score temp_0 du_data matches 21 run scoreboard players operation in_7 du_data = temp_1 du_data
execute if score temp_0 du_data matches 22 run scoreboard players operation in_8 du_data = temp_1 du_data

execute store result score temp_0 du_data run data get block ~ ~ ~ Items[21].Slot
execute store result score temp_1 du_data run data get block ~ ~ ~ Items[21].Count
execute if score temp_0 du_data matches 22 run scoreboard players operation in_8 du_data = temp_1 du_data
