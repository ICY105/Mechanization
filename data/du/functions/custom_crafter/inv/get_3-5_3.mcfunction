...
execute store result score temp_1 du_data run data get block ~ ~ ~ Items[12].Count
execute if score temp_0 du_data matches 12 run scoreboard players operation in_4 du_data = temp_1 du_data
execute if score temp_0 du_data matches 13 run scoreboard players operation in_5 du_data = temp_1 du_data

execute store result score temp_0 du_data run data get block ~ ~ ~ Items[13].Slot
execute store result score temp_1 du_data run data get block ~ ~ ~ Items[13].Count
execute if score temp_0 du_data matches 13 run scoreboard players operation in_5 du_data = temp_1 du_data
