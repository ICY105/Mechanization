...
execute if entity @s[predicate=smithed.crafter:block/table/invalid_items] run function smithed.crafter:v0.2.0/block/table/crafting/manage_invalids/export
