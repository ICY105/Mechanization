...
execute if entity @e[type=item, nbt={Item: {id: "minecraft:barrel", Count: 1b}}, limit=1, sort=nearest, distance=..3] run function smithed.crafter:v0.2.0/block/table/break/drop_item
kill @s
