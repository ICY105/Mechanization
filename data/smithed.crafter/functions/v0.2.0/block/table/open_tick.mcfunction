...
execute if entity @s[predicate=smithed.crafter:block/table/invalid_items] run function smithed.crafter:v0.2.0/block/table/crafting/manage_invalids/move
...
execute if entity @s[scores={smithed.data=1..}] run function smithed.crafter:v0.2.0/block/table/crafting/output/check
...
execute if entity @s[scores={smithed.data=1..}] if data block ~ ~ ~ Items run function smithed.crafter:v0.2.0/block/table/crafting/input/read_barrel
