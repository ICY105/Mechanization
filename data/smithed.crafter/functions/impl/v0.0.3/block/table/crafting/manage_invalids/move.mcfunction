...
execute if entity @s[predicate=smithed.crafter:block/table/invalid_items] run function smithed.crafter:impl/v0.0.3/block/table/crafting/manage_invalids/export
