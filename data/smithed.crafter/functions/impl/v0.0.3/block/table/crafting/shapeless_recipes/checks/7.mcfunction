...
execute if score $temp1 smithed.data matches 0 store result storage smithed.crafter:main root.temp.simplified[7].Count byte -1 run data get storage smithed.crafter:main root.temp.simplified[7].Count -1.000001
