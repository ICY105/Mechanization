...
# Check Stack Sizes
execute if score #enable nbt_smelting.data matches 1 if score #output_count nbt_smelting.data matches 1 run function nbt_smelting:v1.5/furnace/check_out_stackable
execute if score #enable nbt_smelting.data matches 1 if score #output_count nbt_smelting.data matches 16 run function nbt_smelting:v1.5/furnace/check_out_stackable_16
...
# Start Smelting
execute if score #enable nbt_smelting.data matches 1 if block ~ ~ ~ #nbt_smelting:furnaces{BurnTime:0s,Items:[{Slot:1b}]} run function nbt_smelting:v1.5/furnace/fuel
