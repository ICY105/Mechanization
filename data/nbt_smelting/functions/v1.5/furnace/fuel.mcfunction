...
execute if block ~ ~ ~ #nbt_smelting:furnaces{BurnTime:0s} run function nbt_smelting:v1.5/furnace/fuel_2
...
execute unless block ~ ~ ~ #nbt_smelting:furnaces{BurnTime:0s} if block ~ ~ ~ #nbt_smelting:furnaces[lit=false] run function nbt_smelting:v1.5/furnace/make_lit
