...
# Add fuel if needed
execute if block ~ ~ ~ #nbt_smelting:furnaces{BurnTime:0s,Items:[{Slot:1b}]} run function nbt_smelting:v1.0/furnace/fuel
...
execute if score @s nbt_smelting.data >= #total_cook_time nbt_smelting.data run function nbt_smelting:v1.0/furnace/end
