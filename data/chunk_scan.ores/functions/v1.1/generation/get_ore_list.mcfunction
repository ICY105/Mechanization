...
execute if score #gen.success chunk_scan.ores.data matches 0 if score #gen.loop chunk_scan.ores.data matches 1.. run function chunk_scan.ores:v1.1/generation/get_ore_list_2
execute if score #gen.success chunk_scan.ores.data matches 0 if score #gen.loop chunk_scan.ores.data matches 1.. run data modify storage chunk_scan.ores:generation chunk.list set from storage chunk_scan.ores:generation custom[0].list
