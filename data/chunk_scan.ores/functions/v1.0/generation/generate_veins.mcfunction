...
#displace
execute if score #gen.displace_y chunk_scan.ores.data > #gen.y chunk_scan.ores.data if score #gen.vein_size chunk_scan.ores.data matches 1.. run function chunk_scan.ores:v1.0/generation/displace_x

#loop
scoreboard players remove #gen.veins chunk_scan.ores.data 1
execute if score #gen.veins chunk_scan.ores.data matches 1.. run function chunk_scan.ores:v1.0/generation/generate_veins
