...
#generate ores
execute if score #registry.id chunk_scan.ores.data matches 2.. run function chunk_scan.ores:v1.0/generation/get_ore_list
execute if score #registry.id chunk_scan.ores.data matches 2.. if data storage chunk_scan.ores:generation chunk.list[0] run function chunk_scan.ores:v1.0/generation/process_ore_list
