...
execute if score #registry.temp chunk_scan.ores.data matches 0 if score #registry.loop chunk_scan.ores.data matches 1.. run function chunk_scan.ores:v1.0/registry/register_ore_3
