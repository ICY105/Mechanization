...
execute if score #chunk_scan.ores.major load.status matches 1 if score #chunk_scan.ores.minor load.status matches ..0 run scoreboard players set #chunk_scan.ore.minor load.status 0
