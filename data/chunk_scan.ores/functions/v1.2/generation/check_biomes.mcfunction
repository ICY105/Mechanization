...
execute if data storage chunk_scan.ores:generation chunk{biome:""} run function chunk_scan.ores:v1.2/utils/get_biome
...
execute if score #gen.failed chunk_scan.ores.data matches 1 if data storage chunk_scan.ores:generation chunk.list[0].biomes[0] run function chunk_scan.ores:v1.2/generation/check_biome
