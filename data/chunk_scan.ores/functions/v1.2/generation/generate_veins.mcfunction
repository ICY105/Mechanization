...
#displace
execute if score #gen.displace_y chunk_scan.ores.data > #gen.y chunk_scan.ores.data if score #gen.vein_size chunk_scan.ores.data matches 1.. run function chunk_scan.ores:v1.2/generation/displace_x
