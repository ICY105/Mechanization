...
# destroy entities
execute as @e[tag=player_action.click_entity,predicate=player_action:v1.1/equals_uuid] run tp @s ~ -300 ~
execute as @e[tag=player_action.click_entity,predicate=player_action:v1.1/equals_uuid] run kill @s
