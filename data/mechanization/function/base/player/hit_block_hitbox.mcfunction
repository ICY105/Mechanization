...
execute as @n[type=minecraft:interaction,tag=mechanization.block_hitbox,distance=..12,nbt={attack:{}}] at @s run function mechanization:base/player/hit_block_hitbox_run
