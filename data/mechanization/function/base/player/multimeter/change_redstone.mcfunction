...
execute if score @s mechanization.redstone matches 0 run data modify block ~ ~ ~ CustomName.extra[2].text set value ""
execute if score @s mechanization.redstone matches 1 run data modify block ~ ~ ~ CustomName.extra[2].text set value " \ue104"
execute if score @s mechanization.redstone matches 2 run data modify block ~ ~ ~ CustomName.extra[2].text set value " \ue105"
