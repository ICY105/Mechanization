...
execute as @n[type=minecraft:interaction,tag=mechanization.block_hitbox,distance=..12,nbt={interaction:{}}] at @s run function mechanization:base/player/block_hitbox/right_click_hitbox_2
