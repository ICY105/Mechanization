...
data modify block ~ ~ ~ Page set value 0
...
execute if score @s mechanization.manual matches -1 run loot replace block -30000000 0 3201 container.0 loot mechanization:base/manual/base
execute if score @s mechanization.manual matches -2 run loot replace block -30000000 0 3201 container.0 loot mechanization:base/manual/machines
execute if score @s mechanization.manual matches -3 run loot replace block -30000000 0 3201 container.0 loot mechanization:base/manual/nuclear
execute if score @s mechanization.manual matches -4 run loot replace block -30000000 0 3201 container.0 loot mechanization:base/manual/gadgets
execute if score @s mechanization.manual matches -5 run loot replace block -30000000 0 3201 container.0 loot mechanization:base/manual/assembly
#execute if score @s mechanization.manual matches -9 run loot replace block -30000000 0 3201 container.0 loot mechanization:base/manual/compat
execute if score @s mechanization.manual matches -9..-1 run data modify block ~ ~ ~ Book set from block -30000000 0 3201 Items[0]
