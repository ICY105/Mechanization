...
scoreboard players set #cons.12 mechanization.data 12
scoreboard players set #cons.14 mechanization.data 14
...
scoreboard players set #cons.110 mechanization.data 110
...
scoreboard players set #cons.1000 mechanization.data 1000
