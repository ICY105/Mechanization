...
execute if score #storage mechanization.data matches 1.. run data modify block -30000000 0 3202 front_text.messages[0] set value '{"translate":"item.mechanization.filled_bucket","italic":false,"with":[{"nbt":"output.output_slot.tag.fluid.name","storage":"fluid:io","interpret":true}]}'
