...
scoreboard players set #cons.tin_ore mechanization.data -1
scoreboard players set #cons.titanium_ore mechanization.data -1
scoreboard players set #cons.uranium_ore mechanization.data -1
scoreboard players set #cons.emerald_ore mechanization.data -1

#### Tin Ore

# Y elevation [-2048,2048]
scoreboard players set #registry.min_y chunk_scan.ores.data 24
scoreboard players set #registry.max_y chunk_scan.ores.data 48
...
execute if score #base.cf.tin_rarity mechanization.data matches 1.. run scoreboard players operation #cons.tin_ore mechanization.data = #registry.result_id chunk_scan.ores.data

#### Titanium Ore

# Y elevation [-2048,2048]
scoreboard players set #registry.min_y chunk_scan.ores.data 1
...
execute if score #base.cf.titanium_rarity mechanization.data matches 1.. run scoreboard players operation #cons.titanium_ore mechanization.data = #registry.result_id chunk_scan.ores.data

#### Uranium Ore

# Y elevation [-2048,2048]
scoreboard players set #registry.min_y chunk_scan.ores.data 1
scoreboard players set #registry.max_y chunk_scan.ores.data 24
# number of veins [1,32]
...
execute if score #base.cf.uranium_rarity mechanization.data matches 1.. run scoreboard players operation #cons.uranium_ore mechanization.data = #registry.result_id chunk_scan.ores.data

#### Emerald Ore

# Y elevation [-2048,2048]
scoreboard players set #registry.min_y chunk_scan.ores.data 8
...
execute if score #base.cf.emerald_rarity mechanization.data matches 1.. run scoreboard players operation #cons.emerald_ore mechanization.data = #registry.result_id chunk_scan.ores.data
