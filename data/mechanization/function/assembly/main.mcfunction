...
execute if score #timer.20 mechanization.data matches 6 as @e[type=minecraft:item_frame,tag=mechanization.item_injector] at @s run function mechanization:assembly/blocks/item_injector/item_injector
