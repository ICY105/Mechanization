...
execute if entity @s[type=minecraft:item_display,tag=mechanization.terminal,tag=mechanization.active] at @s run function mechanization:assembly/blocks/mss/terminal
