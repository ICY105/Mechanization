...
execute align xyz as @e[type=minecraft:item_frame,tag=mechanization.item_injector,dx=0,dy=0,dz=0,predicate=mechanization:matches_uuid] run scoreboard players operation @s mechanization.item_id = #id mechanization.data
