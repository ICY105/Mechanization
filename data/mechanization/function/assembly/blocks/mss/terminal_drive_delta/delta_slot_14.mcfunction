...
execute if score #count.2 mechanization.data matches 1.. run data modify storage mechanization:temp list[{Slot:14b}].tag.display.Lore[0] set from block -30000000 0 3202 front_text.messages[0]
