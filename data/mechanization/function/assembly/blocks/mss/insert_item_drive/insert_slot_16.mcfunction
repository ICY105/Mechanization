...
execute if score #complete mechanization.data matches 1 run data modify storage mechanization:networks mss.drive[{Slot:16b}].tag.display.Lore[0] set from block -30000000 0 3202 front_text.messages[0]
...
execute if score #count.4 mechanization.data matches 1.. run data modify storage mechanization:temp obj set from storage mechanization:networks mss.drive[{Slot:16b}]
