...
function mechanization:assembly/blocks/mss/terminal_verify_slots/start
...
execute if entity @s[tag=mechanization.active] if block ~ ~ ~ minecraft:barrel[open=false] run function mechanization:assembly/blocks/mss/get_drive/terminal_insert
