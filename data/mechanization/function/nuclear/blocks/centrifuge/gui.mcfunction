...
# move items
execute if items block ~ ~ ~ container.1 * run function mechanization:nuclear/blocks/centrifuge/m.gui_move_item {slot: 1}
execute if items block ~ ~ ~ container.4 * run function mechanization:nuclear/blocks/centrifuge/m.gui_move_item {slot: 4}
execute if items block ~ ~ ~ container.7 * run function mechanization:nuclear/blocks/centrifuge/m.gui_move_item {slot: 7}
