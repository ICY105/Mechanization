...
# Summon Entity & Init
summon minecraft:item_display ~ ~ ~ {Tags:["mechanization", "mechanization.new", "mechanization.centrifuge", "mechanization.redstone_control", "energy.receive", "fluid.tank", "smithed.block"], CustomName:'{"translate":"block.mechanization.centrifuge"}', item:{id:"minecraft:blast_furnace", tag:{CustomModelData:6423000}, Count:1b}}
setblock ~ ~ ~ minecraft:barrel[facing=up]{CustomName:'[{"translate":"offset.-8","font":"space:default","with":[{"text":"\\uee14","font":"mechanization:gui","color":"white"}]},{"translate":"offset.-171","font":"space:default","with":[{"translate":"block.mechanization.centrifuge","color":"dark_red","italic":false,"font":"minecraft:default"}]}]'}
