...
# Summon Entity & Init
summon minecraft:item_display ~ ~ ~ {Tags:["mechanization", "mechanization.new", "mechanization.control_rod", "mechanization.has_block_hitbox", "mechanization.redstone_control", "smithed.block"], CustomName:'{"translate":"block.mechanization.control_rod"}', item:{id:"minecraft:blast_furnace", components:{"minecraft:item_model":"mechanization:nuclear/block/control_rod"}, count: 1}}
