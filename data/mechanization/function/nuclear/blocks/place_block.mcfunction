...
execute if score #id mechanization.data matches 26 if data storage smithed.custom_block:main blockApi{id:"mechanization:reactor_cell"} run function mechanization:nuclear/blocks/reactor_cell/place
