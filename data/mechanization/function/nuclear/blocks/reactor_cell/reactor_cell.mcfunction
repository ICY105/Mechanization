...
execute if score @s fluid.storage.0 matches 1.. item modify entity @s contents {"function":"minecraft:set_custom_model_data","floats":{"values":[{"type":"minecraft:score","target":{"type":"minecraft:fixed","name":"#model"},"score":"mechanization.data","scale":1}],"mode":"replace_all"}}
...
execute if score @s fluid.storage.0 matches 1.. item modify entity @s contents {"function":"minecraft:set_custom_model_data","tints":{"values":[{"type":"minecraft:score","target":{"type":"minecraft:fixed","name":"#color"},"score":"mechanization.data","scale":1}],"mode":"replace_all"}}
