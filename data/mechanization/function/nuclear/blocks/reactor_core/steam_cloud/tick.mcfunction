...
execute if score #time mechanization.data matches 0 at @s if block ~ ~ ~ minecraft:barrier align xyz as @n[tag=mechanization.steam_condenser,dx=0,dy=0,dz=0] run function mechanization:nuclear/blocks/steam_condenser/collect
