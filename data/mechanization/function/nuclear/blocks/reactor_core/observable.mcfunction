...
data modify storage mechanization:temp list set value [ \
    ...
    {name:[{"translate":"text.mechanization.machine_observer.neutron_flux"}], item_model:"mechanization:nuclear/gui/neutron_flux_icon", min_quantity:0, max_quantity:1000, quantity:0} \
]
