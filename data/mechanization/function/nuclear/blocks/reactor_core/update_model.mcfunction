...
execute if score #top mechanization.data matches 1 run scoreboard players set #model mechanization.data 6423206
execute if score #bottom mechanization.data matches 1 run scoreboard players set #model mechanization.data 6423214
execute if score #top mechanization.data matches 1 if score #bottom mechanization.data matches 1 run scoreboard players set #model mechanization.data 6423210

execute if entity @s[tag=mechanization.reactor_core.uranium] run scoreboard players add #model mechanization.data 1
execute if entity @s[tag=mechanization.reactor_core.mox] run scoreboard players add #model mechanization.data 2
execute if entity @s[tag=mechanization.reactor_core.waste] run scoreboard players add #model mechanization.data 3
