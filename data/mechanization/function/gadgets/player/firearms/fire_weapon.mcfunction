...
execute store result score #player.in energy.data run data get block -30000000 0 3201 Items[0].components."minecraft:custom_data".mechanization.epac.energy
...
execute store result score #damage mechanization.data run data get block -30000000 0 3201 Items[0].components."minecraft:custom_data".mechanization.epac.damage
execute store result score #velocity mechanization.data run data get block -30000000 0 3201 Items[0].components."minecraft:custom_data".mechanization.epac.velocity
execute store result score #range mechanization.data run data get block -30000000 0 3201 Items[0].components."minecraft:custom_data".mechanization.epac.range
execute store result score #count mechanization.data run data get block -30000000 0 3201 Items[0].components."minecraft:custom_data".mechanization.epac.count
execute store result score #bouncy mechanization.data run data get block -30000000 0 3201 Items[0].components."minecraft:custom_data".mechanization.epac.bouncy
execute store success score #sonic mechanization.data run data get block -30000000 0 3201 Items[0].components."minecraft:custom_data".mechanization.upgrades.items[].components."minecraft:custom_data".mechanization{id:"sonic_barrel"}
...
# weapon heat
execute store result score #heat mechanization.data run data get block -30000000 0 3201 Items[0].components."minecraft:custom_data".mechanization.epac.heat
...
execute store result score #fire_rate mechanization.data run data get block -30000000 0 3201 Items[0].components."minecraft:custom_data".mechanization.epac.fire_rate
