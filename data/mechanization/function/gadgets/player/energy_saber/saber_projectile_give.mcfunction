...
execute as @a[sort=nearest,limit=1,distance=..1,predicate=mechanization:is_player,gamemode=!creative] if items entity @s weapon.mainhand * run item replace entity @s weapon.mainhand from block -30000000 0 3201 container.0
