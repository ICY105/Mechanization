...
execute store result score #range mechanization.data run data get block -30000000 0 3201 Items[0].components."minecraft:custom_data".mechanization.upgrades.saber_range
