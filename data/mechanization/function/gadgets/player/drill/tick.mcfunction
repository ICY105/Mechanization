...
execute if score @s mechanization.use_drill matches 1.. unless predicate player_action:v1/sneaking if score #mining_area mechanization.data matches 2.. at @e[type=item,sort=nearest,limit=1,nbt={Age:0s}] align xyz positioned ~0.5 ~0.5 ~0.5 run function mechanization:gadgets/player/drill/mine_area
