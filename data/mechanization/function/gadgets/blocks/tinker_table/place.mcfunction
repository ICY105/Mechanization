...
# Summon Entity & Init
summon minecraft:item_display ~ ~ ~ {Tags:["mechanization", "mechanization.new", "mechanization.tinker_table", "smithed.block"], CustomName:{"translate":"block.mechanization.tinker_table"}, item:{id:"minecraft:blast_furnace", components:{"minecraft:item_model":"mechanization:gadgets/block/tinker_table", "minecraft:custom_model_data":{floats:[1]}}, count: 1}, Passengers:[ \
    {id:"minecraft:item_display", Tags:["mechanization", "mechanization.tinker_table.model", "smithed.block"], CustomName:{"translate":"block.mechanization.tinker_table"}, item:{id:"minecraft:poisonous_potato", components:{"minecraft:item_model":"mechanization:gadgets/block/tinker_table", "minecraft:custom_model_data":{floats:[2]}}, count: 1}} \
]}
