...
execute if data storage mechanization:temp list[].components."minecraft:custom_data".mechanization{id:"portable_battery"} run scoreboard players set #max_storage mechanization.data 64000
...
# special effects
execute if data storage mechanization:temp list[0] run data modify storage mechanization:temp obj.components."minecraft:lore" insert 1 value '{"text":""}'

execute if data storage mechanization:temp list[].components."minecraft:custom_data".mechanization.upgrade{effect:"illuminating"} run data modify storage mechanization:temp obj.components."minecraft:lore" insert 1 value '{"translate":"lore.mechanization.upgrade_illuminating","color":"gray","italic":false}'
execute if data storage mechanization:temp list[].components."minecraft:custom_data".mechanization.upgrade{effect:"shield_recharge"} run data modify storage mechanization:temp obj.components."minecraft:lore" insert 1 value '{"translate":"lore.mechanization.shield_recharge","color":"gray","italic":false}'
...
execute if score #type mechanization.data matches 1 if data storage mechanization:temp list[].components."minecraft:custom_data".mechanization.upgrade{effect:"rebreather"} run data modify storage mechanization:temp obj.components."minecraft:custom_model_data" set value {floats:[1]}
execute if score #type mechanization.data matches 1 if data storage mechanization:temp list[].components."minecraft:custom_data".mechanization.upgrade{effect:"rebreather"} run data modify storage mechanization:temp obj.components."minecraft:equippable".asset_id set value "mechanization:modular_armor_upgrades_2"
execute if score #type mechanization.data matches 1 if data storage mechanization:temp list[].components."minecraft:custom_data".mechanization.upgrade{effect:"night_vision"} run data modify storage mechanization:temp obj.components."minecraft:custom_model_data" set value {floats:[2]}
execute if score #type mechanization.data matches 1 if data storage mechanization:temp list[].components."minecraft:custom_data".mechanization.upgrade{effect:"night_vision"} run data modify storage mechanization:temp obj.components."minecraft:equippable".asset_id set value "mechanization:modular_armor_upgrades_1"
execute if score #type mechanization.data matches 1 if data storage mechanization:temp list[].components."minecraft:custom_data".mechanization.upgrade{effect:"rebreather"} if data storage mechanization:temp list[].components."minecraft:custom_data".mechanization.upgrade{effect:"night_vision"} run data modify storage mechanization:temp obj.components."minecraft:custom_model_data" set value {floats:[3]}
...
execute if score #type mechanization.data matches 2 if data storage mechanization:temp list[{id:"minecraft:elytra"}] run data modify storage mechanization:temp obj.components."minecraft:glider" set value {}
execute if score #type mechanization.data matches 2 if data storage mechanization:temp list[].components."minecraft:custom_data".mechanization.upgrade{effect:"jetpack"} run data modify storage mechanization:temp obj.components."minecraft:glider" set value {}

execute if score #type mechanization.data matches 4 if data storage mechanization:temp list[].components."minecraft:custom_data".mechanization.upgrade{effect:"slowfall"} run data modify storage mechanization:temp obj.components."minecraft:custom_model_data" set value {floats:[1]}
execute if score #type mechanization.data matches 4 if data storage mechanization:temp list[].components."minecraft:custom_data".mechanization.upgrade{effect:"slowfall"} run data modify storage mechanization:temp obj.components."minecraft:equippable".asset_id set value "mechanization:modular_armor_upgrades_1"
execute if score #type mechanization.data matches 4 if data storage mechanization:temp list[].components."minecraft:custom_data".mechanization.upgrade{effect:"wall_walk"} run data modify storage mechanization:temp obj.components."minecraft:custom_model_data" set value {floats:[2]}
execute if score #type mechanization.data matches 4 if data storage mechanization:temp list[].components."minecraft:custom_data".mechanization.upgrade{effect:"wall_walk"} run data modify storage mechanization:temp obj.components."minecraft:equippable".asset_id set value "mechanization:modular_armor_upgrades_2"
execute if score #type mechanization.data matches 4 if data storage mechanization:temp list[].components."minecraft:custom_data".mechanization.upgrade{effect:"slowfall"} if data storage mechanization:temp list[].components."minecraft:custom_data".mechanization.upgrade{effect:"wall_walk"} run data modify storage mechanization:temp obj.components."minecraft:custom_model_data" set value {floats:[3]}
