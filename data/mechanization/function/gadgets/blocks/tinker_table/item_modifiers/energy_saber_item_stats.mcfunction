...
$execute store result score #value mechanization.data run data get storage mechanization:temp obj.components."minecraft:custom_data".mechanization.upgrades.items[$(index)].components."minecraft:custom_data".mechanization.upgrade.stats.attack_speed 10
scoreboard players operation #attack_speed mechanization.data += #value mechanization.data

$execute store result score #value mechanization.data run data get storage mechanization:temp obj.components."minecraft:custom_data".mechanization.upgrades.items[$(index)].components."minecraft:custom_data".mechanization.upgrade.stats.energy_saber_range
