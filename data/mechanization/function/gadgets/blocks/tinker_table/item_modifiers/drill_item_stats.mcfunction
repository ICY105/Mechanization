...
$execute store result score #value mechanization.data run data get storage mechanization:temp list[$(index)].components."minecraft:custom_data".mechanization.upgrade.stats.mining_speed 10
scoreboard players operation #mining_speed mechanization.data += #value mechanization.data

$execute store result score #value mechanization.data run data get storage mechanization:temp list[$(index)].components."minecraft:custom_data".mechanization.upgrade.stats.mining_area
scoreboard players operation #mining_area mechanization.data += #value mechanization.data

$execute store result score #value mechanization.data run data get storage mechanization:temp list[$(index)].components."minecraft:custom_data".mechanization.upgrade.stats.attack_damage
