...
execute if data storage mechanization:temp list[].components."minecraft:custom_data".mechanization.upgrade{effect:"fortune_2"} run scoreboard players set #value mechanization.data 2
execute if data storage mechanization:temp list[].components."minecraft:custom_data".mechanization.upgrade{effect:"fortune_3"} run scoreboard players set #value mechanization.data 3
execute if data storage mechanization:temp list[].components."minecraft:custom_data".mechanization.upgrade{effect:"fortune_4"} run scoreboard players set #value mechanization.data 4
execute if data storage mechanization:temp list[].components."minecraft:custom_data".mechanization.upgrade{effect:"fortune_5"} run scoreboard players set #value mechanization.data 5
