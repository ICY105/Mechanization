...
execute if score #timer.20 mechanization.data matches 8 as @e[type=minecraft:item_display,tag=mechanization.tinker_table] at @s run function mechanization:gadgets/blocks/tinker_table/tinker_table
