...
item replace block ~ ~ ~ container.16 with minecraft:poisonous_potato[minecraft:custom_data={mechanization:{gui_item:1b}},minecraft:tooltip_display={hide_tooltip:1b},!minecraft:food,minecraft:item_model="mechanization:base/gui/invisible"]
