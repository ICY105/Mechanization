...
# Summon Entity & Init
summon minecraft:item_display ~ ~ ~ {Tags:["mechanization", "mechanization.new", "mechanization.energy_relay", "mechanization.has_block_hitbox", "energy.receive", "smithed.block"], CustomName:'{"translate":"block.mechanization.energy_relay"}', item:{id:"minecraft:carrot_on_a_stick", tag:{CustomModelData:6421004}, Count:1b}}
