...
# Summon Entity & Init
summon minecraft:item_display ~ ~ ~ {Tags:["mechanization", "mechanization.new", "mechanization.electric_lamp", "mechanization.redstone_control", "mechanization.observable", "mechanization.has_block_hitbox", "energy.receive", "smithed.block"], CustomName:{"translate":"block.mechanization.electric_lamp"}, item:{id:"minecraft:blast_furnace", components:{"minecraft:item_model":"mechanization:machines/block/electric_lamp"}, Count:1b}}
