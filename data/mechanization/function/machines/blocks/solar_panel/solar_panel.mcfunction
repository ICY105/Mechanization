...
execute if block ~ ~ ~ minecraft:daylight_detector[inverted=false] run item modify entity @s contents {"function": "minecraft:set_components","components": {"minecraft:custom_model_data": {"floats":[2]}}}
execute if block ~ ~ ~ minecraft:daylight_detector[inverted=true] run item modify entity @s contents {"function": "minecraft:set_components","components": {"minecraft:custom_model_data": {"floats":[3]}}}
