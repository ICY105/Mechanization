...
# Summon Entity & Init
summon minecraft:item_display ~ ~ ~ {Tags:["mechanization", "mechanization.new", "mechanization.fluid_tank", "mechanization.fluid_tank.t1", "fluid.tank", "smithed.block"], CustomName:'{"translate":"block.mechanization.tier1_fluid_tank"}', item:{id:"minecraft:leather_boots", components:{"minecraft:item_model":"mechanization:machines/block/tier1_fluid_tank"}, Count:1b}}
