...
execute if data storage mechanization:temp list[0] run function mechanization:machines/blocks/fluid_tank/gui_move
execute if data block -30000000 0 3201 Items[0] run loot spawn ^ ^ ^1 mine -30000000 0 3201 minecraft:air{drop_contents:true}

function mechanization:machines/blocks/fluid_tank/gui_clear
...
execute if entity @s[tag=mechanization.fluid_tank.t1] run scoreboard players add #storage mechanization.data 6422922
execute if entity @s[tag=mechanization.fluid_tank.t2] run scoreboard players add #storage mechanization.data 6422931
execute if entity @s[tag=mechanization.fluid_tank.t3] run scoreboard players add #storage mechanization.data 6422940
