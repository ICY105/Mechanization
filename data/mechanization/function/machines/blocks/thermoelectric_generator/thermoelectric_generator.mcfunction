...
# gui
function mechanization:machines/blocks/thermoelectric_generator/gui

# power
execute if score #active mechanization.data matches 1 store result score #temp.0 mechanization.data run data get entity @s item.tag.fluids[0].temperature
execute if score #active mechanization.data matches 1 store result score #temp.1 mechanization.data run data get entity @s item.tag.fluids[1].temperature
...
execute if score #active mechanization.data matches 1 if score @s fluid.storage.0 matches 0 run data modify entity @s Item.tag.tank_1 set value {}
execute if score #active mechanization.data matches 1 if score @s fluid.storage.1 matches 0 run data modify entity @s Item.tag.tank_2 set value {}
