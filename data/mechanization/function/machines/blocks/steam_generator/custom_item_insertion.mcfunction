...
execute if score #fluid mechanization.data matches 0 unless items block ~ ~ ~ container.10 * if items block -30000000 0 3201 container.* #mechanization:furnace_fuel run return 10
