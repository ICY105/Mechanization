...
execute if items block ~ ~ ~ container.24 #mechanization:gui_item[custom_data~{mechanization:{gui_item:1b}}] run item replace block ~ ~ ~ container.24 with minecraft:air
...
# move items
execute if items block ~ ~ ~ container.3 * run function mechanization:machines/blocks/steam_generator/m.gui_move_item {slot: 3}
execute if items block ~ ~ ~ container.6 * run function mechanization:machines/blocks/steam_generator/m.gui_move_item {slot: 6}

# handle fluid slot IO
scoreboard players set #slot_io.in fluid.data 0
execute if items block ~ ~ ~ container.3 * run function mechanization:machines/blocks/steam_generator/m.gui_insert_fluid {slot: 3, tank: 0, id:"water"}
scoreboard players set #slot_io.in fluid.data 1
execute if items block ~ ~ ~ container.6 * run function mechanization:machines/blocks/steam_generator/m.gui_insert_fluid {slot: 6, tank: 1, id:"steam"}
...
execute if score @s mechanization.data matches 1.. run item replace block ~ ~ ~ container.19 with minecraft:poisonous_potato[minecraft:custom_data={mechanization:{gui_item:1b}},minecraft:tooltip_display={hide_tooltip:1b},minecraft:max_stack_size=1,!minecraft:food,minecraft:item_model="mechanization:machines/gui/fuel_on"]
