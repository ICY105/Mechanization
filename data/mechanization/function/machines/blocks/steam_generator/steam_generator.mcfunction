...
# generate heat
scoreboard players set #steam mechanization.data 120
execute if entity @s[tag=mechanization.upgraded] run scoreboard players add #steam mechanization.data 60
execute if entity @s[tag=mechanization.upgraded.ender] run scoreboard players add #steam mechanization.data 60
execute if entity @s[tag=mechanization.upgraded.nether] run scoreboard players add #steam mechanization.data 360
...
execute if score @s fluid.storage.1 matches 2000.. run scoreboard players operation #storage mechanization.data /= #cons.10 mechanization.data
