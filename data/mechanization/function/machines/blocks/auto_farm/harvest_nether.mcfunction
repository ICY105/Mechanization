...
execute if block ~ ~ ~ minecraft:wheat[age=7] run loot spawn ~ ~ ~ mine ~ ~ ~
execute if block ~ ~ ~ minecraft:wheat[age=7] run setblock ~ ~ ~ minecraft:wheat[age=0] replace

execute if block ~ ~ ~ minecraft:potatoes[age=7] run loot spawn ~ ~ ~ mine ~ ~ ~
execute if block ~ ~ ~ minecraft:potatoes[age=7] run loot spawn ~ ~ ~ mine ~ ~ ~
execute if block ~ ~ ~ minecraft:potatoes[age=7] run setblock ~ ~ ~ minecraft:potatoes[age=0] replace

execute if block ~ ~ ~ minecraft:carrots[age=7] run loot spawn ~ ~ ~ mine ~ ~ ~
execute if block ~ ~ ~ minecraft:carrots[age=7] run loot spawn ~ ~ ~ mine ~ ~ ~
execute if block ~ ~ ~ minecraft:carrots[age=7] run setblock ~ ~ ~ minecraft:carrots[age=0] replace

execute if block ~ ~ ~ minecraft:nether_wart[age=3] run loot spawn ~ ~ ~ mine ~ ~ ~
execute if block ~ ~ ~ minecraft:nether_wart[age=3] run loot spawn ~ ~ ~ mine ~ ~ ~
execute if block ~ ~ ~ minecraft:nether_wart[age=3] run setblock ~ ~ ~ minecraft:nether_wart[age=0] replace

execute if block ~ ~ ~ minecraft:beetroots[age=3] run loot spawn ~ ~ ~ mine ~ ~ ~
execute if block ~ ~ ~ minecraft:beetroots[age=3] run loot spawn ~ ~ ~ mine ~ ~ ~
execute if block ~ ~ ~ minecraft:beetroots[age=3] run setblock ~ ~ ~ minecraft:beetroots[age=0] replace

execute if block ~ ~ ~ minecraft:cocoa[age=2] run loot spawn ~ ~ ~ mine ~ ~ ~
execute if block ~ ~ ~ minecraft:cocoa[age=2] run loot spawn ~ ~ ~ mine ~ ~ ~
execute if block ~ ~ ~ minecraft:cocoa[age=2] run setblock ~ ~ ~ minecraft:cocoa[age=0] replace
