...
execute if score @s energy.storage >= #energy mechanization.data positioned ~ ~ ~ run function mechanization:machines/blocks/block_breaker/nether_2
execute if score @s energy.storage >= #energy mechanization.data positioned ~ ~1 ~ run function mechanization:machines/blocks/block_breaker/nether_2
execute if score @s energy.storage >= #energy mechanization.data positioned ~ ~2 ~ run function mechanization:machines/blocks/block_breaker/nether_2
