...
execute align xyz run summon minecraft:item_display ~0.5 ~0.5 ~0.5 {Tags:["mechanization", "mechanization.new", "mechanization.spawner_controller", "mechanization.upgradable", "mechanization.observable", "mechanization.redstone_control", "energy.receive", "smithed.block"],item:{id:"minecraft:blast_furnace",components:{"minecraft:item_model":"mechanization:machines/block/spawner_controller"},Count:1b}}
