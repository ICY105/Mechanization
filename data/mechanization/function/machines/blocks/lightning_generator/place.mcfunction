...
# Summon Entity & Init
summon minecraft:item_display ~ ~ ~ {Tags:["mechanization", "mechanization.new", "mechanization.ticking", "mechanization.lightning_generator", "mechanization.upgradable", "mechanization.has_block_hitbox", "energy.send", "smithed.block"], CustomName:'{"translate":"block.mechanization.lightning_generator"}', item:{id:"minecraft:blast_furnace", components:{"minecraft:item_model":"mechanization:machines/block/lightning_generator"}, Count:1b}}
