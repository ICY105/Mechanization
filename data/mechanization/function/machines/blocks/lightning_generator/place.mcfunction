...
# Summon Entity & Init
summon minecraft:item_display ~ ~ ~ {Tags:["mechanization", "mechanization.new", "mechanization.ticking", "mechanization.lightning_generator", "mechanization.upgradable", "mechanization.has_block_hitbox", "energy.send", "smithed.block"], CustomName:'{"translate":"block.mechanization.lightning_generator"}', item:{id:"minecraft:blast_furnace", components:{"minecraft:custom_model_data":6422031}, Count:1b}}
