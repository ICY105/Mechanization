...
# ores
execute if score #output_count mechanization.data matches 0..62 if items block ~ ~ ~ container.0 #mechanization:basic_ores run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_ores mechanization.data
execute if score #output_count mechanization.data matches 0..58 if items block ~ ~ ~ container.0 minecraft:redstone_ore run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_ores mechanization.data
execute if score #output_count mechanization.data matches 0..55 if items block ~ ~ ~ container.0 minecraft:lapis_ore run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_ores mechanization.data
execute if score #output_count mechanization.data matches 0..58 if items block ~ ~ ~ container.0 minecraft:deepslate_redstone_ore run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_ores mechanization.data
execute if score #output_count mechanization.data matches 0..55 if items block ~ ~ ~ container.0 minecraft:deepslate_lapis_ore run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_ores mechanization.data
execute if score #output_count mechanization.data matches 0..58 if items block ~ ~ ~ container.0 minecraft:copper_ore run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_ores mechanization.data
execute if score #output_count mechanization.data matches 0..58 if items block ~ ~ ~ container.0 minecraft:deepslate_copper_ore run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_ores mechanization.data

execute if score #output_count mechanization.data matches 0..62 if items block ~ ~ ~ container.0 *[minecraft:custom_data~{smithed:{dict:{ore:{tin:1b}}}}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_ores mechanization.data
execute if score #output_count mechanization.data matches 0..62 if items block ~ ~ ~ container.0 *[minecraft:custom_data~{smithed:{dict:{ore:{titanium:1b}}}}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_ores mechanization.data
execute if score #output_count mechanization.data matches 0..62 if items block ~ ~ ~ container.0 *[minecraft:custom_data~{smithed:{dict:{ore:{uranium:1b}}}}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_ores mechanization.data
...
# logs
execute if score #output_count mechanization.data matches 0..58 if items block ~ ~ ~ container.0 #minecraft:logs run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_other mechanization.data

# extra
execute if score #output_count mechanization.data matches 0..63 if items block ~ ~ ~ container.0 minecraft:cobblestone run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_other mechanization.data
...
execute if score #output_count mechanization.data matches 0..63 if items block ~ ~ ~ container.0 minecraft:gravel run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_other mechanization.data
execute if score #output_count mechanization.data matches 0..61 if items block ~ ~ ~ container.0 minecraft:blaze_rod run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_other mechanization.data
execute if score #output_count mechanization.data matches 0..60 if items block ~ ~ ~ container.0 minecraft:bone run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_other mechanization.data
