...
# Summon Entity & Init
execute if block ~ ~ ~ minecraft:blast_furnace[facing=north] run summon minecraft:item_display ~ ~ ~ {Tags:["mechanization", "mechanization.new", "mechanization.arc_furnace", "mechanization.redstone_control", "mechanization.upgradable", "mechanization.mufflable", "mechanization.rotatable", "fluid.tank", "energy.receive", "smithed.block"], Rotation:[180.0f,0.0f], CustomName:'{"translate":"block.mechanization.arc_furnace"}', item:{id:"minecraft:blast_furnace", tag:{CustomModelData:6422027}, Count:1b}}
execute if block ~ ~ ~ minecraft:blast_furnace[facing=east] run summon minecraft:item_display ~ ~ ~ {Tags:["mechanization", "mechanization.new", "mechanization.arc_furnace", "mechanization.redstone_control", "mechanization.upgradable", "mechanization.mufflable", "mechanization.rotatable", "fluid.tank", "energy.receive", "smithed.block"], Rotation:[270.0f,0.0f], CustomName:'{"translate":"block.mechanization.arc_furnace"}', item:{id:"minecraft:blast_furnace", tag:{CustomModelData:6422027}, Count:1b}}
execute if block ~ ~ ~ minecraft:blast_furnace[facing=south] run summon minecraft:item_display ~ ~ ~ {Tags:["mechanization", "mechanization.new", "mechanization.arc_furnace", "mechanization.redstone_control", "mechanization.upgradable", "mechanization.mufflable", "mechanization.rotatable", "fluid.tank", "energy.receive", "smithed.block"], Rotation:[0.0f,0.0f], CustomName:'{"translate":"block.mechanization.arc_furnace"}', item:{id:"minecraft:blast_furnace", tag:{CustomModelData:6422027}, Count:1b}}
execute if block ~ ~ ~ minecraft:blast_furnace[facing=west] run summon minecraft:item_display ~ ~ ~ {Tags:["mechanization", "mechanization.new", "mechanization.arc_furnace", "mechanization.redstone_control", "mechanization.upgradable", "mechanization.mufflable", "mechanization.rotatable", "fluid.tank", "energy.receive", "smithed.block"], Rotation:[90.0f,0.0f], CustomName:'{"translate":"block.mechanization.arc_furnace"}', item:{id:"minecraft:blast_furnace", tag:{CustomModelData:6422027}, Count:1b}}

setblock ~ ~ ~ minecraft:dropper[facing=up]{CustomName:'[{"translate":"offset.3","font":"space:default","with":[{"text":"\\uee0c","font":"mechanization:gui","color":"white"}]},{"translate":"offset.-57","font":"space:default","with":[{"translate":"block.mechanization.arc_furnace","color":"dark_aqua","italic":false,"font":"minecraft:default"}]}]'}
