...
execute if entity @s[tag=!mechanization.upgraded.nether] if data storage mechanization:temp obj.input_item.components."minecraft:custom_data".smithed.dict.rod run function mechanization:machines/blocks/arc_furnace/recipes/input_rod
execute if entity @s[tag=!mechanization.upgraded.nether] if data storage mechanization:temp obj.input_item.components."minecraft:custom_data".smithed.dict.plate run function mechanization:machines/blocks/arc_furnace/recipes/input_plate
execute if entity @s[tag=!mechanization.upgraded.nether] if data storage mechanization:temp obj.input_item.components."minecraft:custom_data".smithed.dict.gear run function mechanization:machines/blocks/arc_furnace/recipes/input_gear
execute if entity @s[tag=!mechanization.upgraded.nether] if data storage mechanization:temp obj.input_item.components."minecraft:custom_data".smithed.dict run function mechanization:machines/blocks/arc_furnace/recipes/input_misc
