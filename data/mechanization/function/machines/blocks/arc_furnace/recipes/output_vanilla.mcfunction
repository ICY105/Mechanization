...
execute if score @s fluid.storage.0 matches 0 if data storage mechanization:temp obj.input_item{id:"minecraft:raw_iron"} run data modify entity @s item.components."minecraft:custom_data".fluids[0] set from storage fluid:definitions fluid_data[{id:"molten_iron"}]
...
execute if score @s fluid.storage.0 matches 0 if data storage mechanization:temp obj.input_item{id:"minecraft:raw_copper"} run data modify entity @s item.components."minecraft:custom_data".fluids[0] set from storage fluid:definitions fluid_data[{id:"molten_copper"}]
...
execute if score @s fluid.storage.0 matches 0 if data storage mechanization:temp obj.input_item{id:"minecraft:raw_gold"} run data modify entity @s item.components."minecraft:custom_data".fluids[0] set from storage fluid:definitions fluid_data[{id:"molten_gold"}]
...
execute if score @s fluid.storage.0 matches 0 if data storage mechanization:temp obj.input_item{id:"minecraft:raw_iron_block"} run data modify entity @s item.components."minecraft:custom_data".fluids[0] set from storage fluid:definitions fluid_data[{id:"molten_iron"}]
...
execute if score @s fluid.storage.0 matches 0 if data storage mechanization:temp obj.input_item{id:"minecraft:raw_copper_block"} run data modify entity @s item.components."minecraft:custom_data".fluids[0] set from storage fluid:definitions fluid_data[{id:"molten_copper"}]
...
execute if score @s fluid.storage.0 matches 0 if data storage mechanization:temp obj.input_item{id:"minecraft:raw_gold_block"} run data modify entity @s item.components."minecraft:custom_data".fluids[0] set from storage fluid:definitions fluid_data[{id:"molten_gold"}]
...
execute if score @s[tag=!mechanization.upgraded.ender] fluid.storage.0 matches 0 if data storage mechanization:temp obj.input_item{id:"minecraft:iron_ingot"} run data modify entity @s item.components."minecraft:custom_data".fluids[0] set from storage fluid:definitions fluid_data[{id:"molten_iron"}]
...
execute if score @s[tag=!mechanization.upgraded.ender] fluid.storage.0 matches 0 if data storage mechanization:temp obj.input_item{id:"minecraft:copper_ingot"} run data modify entity @s item.components."minecraft:custom_data".fluids[0] set from storage fluid:definitions fluid_data[{id:"molten_copper"}]
...
execute if score @s[tag=!mechanization.upgraded.ender] fluid.storage.0 matches 0 if data storage mechanization:temp obj.input_item{id:"minecraft:gold_ingot"} run data modify entity @s item.components."minecraft:custom_data".fluids[0] set from storage fluid:definitions fluid_data[{id:"molten_gold"}]
...
execute if score @s[tag=!mechanization.upgraded.ender] fluid.storage.0 matches 0 if data storage mechanization:temp obj.input_item{id:"minecraft:netherite_ingot"} run data modify entity @s item.components."minecraft:custom_data".fluids[0] set from storage fluid:definitions fluid_data[{id:"molten_netherite"}]
...
execute if score @s[tag=!mechanization.upgraded.ender] fluid.storage.0 matches 0 if data storage mechanization:temp obj.input_item{id:"minecraft:coal"} run data modify entity @s item.components."minecraft:custom_data".fluids[0] set from storage fluid:definitions fluid_data[{id:"molten_coal"}]
...
execute if score @s[tag=!mechanization.upgraded.ender] fluid.storage.0 matches 0 if data storage mechanization:temp obj.input_item{id:"minecraft:diamond"} run data modify entity @s item.components."minecraft:custom_data".fluids[0] set from storage fluid:definitions fluid_data[{id:"molten_diamond"}]
...
execute if score @s[tag=!mechanization.upgraded.ender] fluid.storage.0 matches 0 if data storage mechanization:temp obj.input_item{id:"minecraft:emerald"} run data modify entity @s item.components."minecraft:custom_data".fluids[0] set from storage fluid:definitions fluid_data[{id:"molten_emerald"}]
...
execute if score @s[tag=!mechanization.upgraded.ender] fluid.storage.0 matches 0 if data storage mechanization:temp obj.input_item{id:"minecraft:redstone"} run data modify entity @s item.components."minecraft:custom_data".fluids[0] set from storage fluid:definitions fluid_data[{id:"molten_redstone"}]
...
execute if score @s[tag=!mechanization.upgraded.ender] fluid.storage.0 matches 0 if data storage mechanization:temp obj.input_item{id:"minecraft:lapis_lazuli"} run data modify entity @s item.components."minecraft:custom_data".fluids[0] set from storage fluid:definitions fluid_data[{id:"molten_lapis_lazuli"}]
...
execute if score @s[tag=!mechanization.upgraded.ender] fluid.storage.0 matches 0 if data storage mechanization:temp obj.input_item{id:"minecraft:amethyst_shard"} run data modify entity @s item.components."minecraft:custom_data".fluids[0] set from storage fluid:definitions fluid_data[{id:"molten_amethyst"}]
...
execute if score @s[tag=!mechanization.upgraded.ender] fluid.storage.0 matches 0 if data storage mechanization:temp obj.input_item{id:"minecraft:quartz"} run data modify entity @s item.components."minecraft:custom_data".fluids[0] set from storage fluid:definitions fluid_data[{id:"molten_quartz"}]
...
execute if score @s[tag=!mechanization.upgraded.ender] fluid.storage.0 matches 0 if data storage mechanization:temp obj.input_item{id:"minecraft:glowstone_dust"} run data modify entity @s item.components."minecraft:custom_data".fluids[0] set from storage fluid:definitions fluid_data[{id:"molten_glowstone"}]
...
execute if score @s[tag=!mechanization.upgraded.ender] fluid.storage.0 matches 0 if data storage mechanization:temp obj.input_item{id:"minecraft:iron_block"} run data modify entity @s item.components."minecraft:custom_data".fluids[0] set from storage fluid:definitions fluid_data[{id:"molten_iron"}]
...
execute if score @s[tag=!mechanization.upgraded.ender] fluid.storage.0 matches 0 if data storage mechanization:temp obj.input_item{id:"minecraft:copper_block"} run data modify entity @s item.components."minecraft:custom_data".fluids[0] set from storage fluid:definitions fluid_data[{id:"molten_copper"}]
...
execute if score @s[tag=!mechanization.upgraded.ender] fluid.storage.0 matches 0 if data storage mechanization:temp obj.input_item{id:"minecraft:gold_block"} run data modify entity @s item.components."minecraft:custom_data".fluids[0] set from storage fluid:definitions fluid_data[{id:"molten_gold"}]
...
execute if score @s[tag=!mechanization.upgraded.ender] fluid.storage.0 matches 0 if data storage mechanization:temp obj.input_item{id:"minecraft:netherite_block"} run data modify entity @s item.components."minecraft:custom_data".fluids[0] set from storage fluid:definitions fluid_data[{id:"molten_netherite"}]
...
execute if score @s[tag=!mechanization.upgraded.ender] fluid.storage.0 matches 0 if data storage mechanization:temp obj.input_item{id:"minecraft:coal_block"} run data modify entity @s item.components."minecraft:custom_data".fluids[0] set from storage fluid:definitions fluid_data[{id:"molten_coal"}]
...
execute if score @s[tag=!mechanization.upgraded.ender] fluid.storage.0 matches 0 if data storage mechanization:temp obj.input_item{id:"minecraft:diamond_block"} run data modify entity @s item.components."minecraft:custom_data".fluids[0] set from storage fluid:definitions fluid_data[{id:"molten_diamond"}]
...
execute if score @s[tag=!mechanization.upgraded.ender] fluid.storage.0 matches 0 if data storage mechanization:temp obj.input_item{id:"minecraft:emerald_block"} run data modify entity @s item.components."minecraft:custom_data".fluids[0] set from storage fluid:definitions fluid_data[{id:"molten_emerald"}]
...
execute if score @s[tag=!mechanization.upgraded.ender] fluid.storage.0 matches 0 if data storage mechanization:temp obj.input_item{id:"minecraft:redstone_block"} run data modify entity @s item.components."minecraft:custom_data".fluids[0] set from storage fluid:definitions fluid_data[{id:"molten_redstone"}]
...
execute if score @s[tag=!mechanization.upgraded.ender] fluid.storage.0 matches 0 if data storage mechanization:temp obj.input_item{id:"minecraft:lapis_lazuli_block"} run data modify entity @s item.components."minecraft:custom_data".fluids[0] set from storage fluid:definitions fluid_data[{id:"molten_lapis_lazuli"}]
...
execute if score @s[tag=!mechanization.upgraded.ender] fluid.storage.0 matches 0 if data storage mechanization:temp obj.input_item{id:"minecraft:amethyst_block"} run data modify entity @s item.components."minecraft:custom_data".fluids[0] set from storage fluid:definitions fluid_data[{id:"molten_amethyst"}]
...
execute if score @s[tag=!mechanization.upgraded.ender] fluid.storage.0 matches 0 if data storage mechanization:temp obj.input_item{id:"minecraft:quartz_block"} run data modify entity @s item.components."minecraft:custom_data".fluids[0] set from storage fluid:definitions fluid_data[{id:"molten_quartz"}]
...
execute if score @s[tag=!mechanization.upgraded.ender] fluid.storage.0 matches 0 if data storage mechanization:temp obj.input_item{id:"minecraft:glowstone"} run data modify entity @s item.components."minecraft:custom_data".fluids[0] set from storage fluid:definitions fluid_data[{id:"molten_glowstone"}]
...
execute if score @s[tag=!mechanization.upgraded.ender] fluid.storage.0 matches 0 if data storage mechanization:temp obj.input_item{id:"minecraft:iron_nugget"} run data modify entity @s item.components."minecraft:custom_data".fluids[0] set from storage fluid:definitions fluid_data[{id:"molten_iron"}]
...
execute if score @s[tag=!mechanization.upgraded.ender] fluid.storage.0 matches 0 if data storage mechanization:temp obj.input_item{id:"minecraft:gold_nugget"} run data modify entity @s item.components."minecraft:custom_data".fluids[0] set from storage fluid:definitions fluid_data[{id:"molten_gold"}]
