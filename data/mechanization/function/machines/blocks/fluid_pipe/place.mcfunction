...
# Summon Entity & Init
summon minecraft:item_display ~ ~ ~ {CustomName:{"translate":"block.mechanization.fluid_pipe"}, item:{id:"minecraft:waxed_copper_block", components:{"minecraft:item_model":"mechanization:machines/block/fluid_pipe"}, count: 1}, \
    Tags:["mechanization", "mechanization.new", "mechanization.fluid_pipe", "mechanization.has_block_hitbox", "fluid.pipe", "smithed.block"]}
