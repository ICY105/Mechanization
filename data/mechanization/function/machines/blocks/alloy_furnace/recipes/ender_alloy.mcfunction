...
execute unless data storage mechanization:temp obj.tank_3.tag{id:"molten_ender_alloy"} run data modify entity @s item.components."minecraft:custom_data".fluids[2] set from storage fluid:definitions fluid_data[{id:"molten_ender_alloy"}]
