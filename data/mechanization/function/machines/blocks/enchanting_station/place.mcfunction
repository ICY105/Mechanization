...
# Summon Entity & Init
summon minecraft:item_display ~ ~ ~ {Tags:["mechanization", "mechanization.new", "mechanization.enchanting_station", "mechanization.upgradable", "mechanization.observable", "mechanization.mufflable", "fluid.tank", "energy.receive", "smithed.block"], CustomName:{"translate":"block.mechanization.enchanting_station"}, item:{id:"minecraft:blast_furnace", components:{"minecraft:item_model":"mechanization:machines/block/enchanting_station"}, count: 1}}
