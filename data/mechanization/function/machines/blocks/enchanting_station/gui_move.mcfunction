...
execute if score #slot mechanization.data matches -1 unless data block ~ ~ ~ Items[{Slot:10b}] run scoreboard players set #slot mechanization.data 10
execute if score #slot mechanization.data matches -1 unless data block ~ ~ ~ Items[{Slot:12b}] run scoreboard players set #slot mechanization.data 12
execute if score #slot mechanization.data matches -1 unless data block ~ ~ ~ Items[{Slot:5b}] run scoreboard players set #slot mechanization.data 6
