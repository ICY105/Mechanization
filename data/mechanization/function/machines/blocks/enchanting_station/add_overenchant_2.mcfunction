...
execute if score #valid mechanization.data matches 1 if score @s fluid.storage.0 >= #total_cost mechanization.data if score #level mechanization.data = #current_level mechanization.data if score #corrected_level mechanization.data <= #max_over_lvl mechanization.data run scoreboard players operation @s fluid.storage.0 -= #total_cost mechanization.data
...
execute if score #valid mechanization.data matches 1 if score @s fluid.storage.0 >= #total_cost mechanization.data if score #level mechanization.data > #current_level mechanization.data if score #level mechanization.data <= #max_over_lvl mechanization.data run function mechanization:machines/blocks/enchanting_station/set_enchant_level
execute if score #valid mechanization.data matches 1 if score @s fluid.storage.0 >= #total_cost mechanization.data if score #level mechanization.data > #current_level mechanization.data if score #level mechanization.data <= #max_over_lvl mechanization.data run scoreboard players set #success mechanization.data 1
execute if score #valid mechanization.data matches 1 if score @s fluid.storage.0 >= #total_cost mechanization.data if score #level mechanization.data > #current_level mechanization.data if score #level mechanization.data <= #max_over_lvl mechanization.data run scoreboard players operation @s fluid.storage.0 -= #total_cost mechanization.data

#loop
data remove storage mechanization:temp list[0]
execute if data storage mechanization:temp list[0] run function mechanization:machines/blocks/enchanting_station/add_overenchant_2
