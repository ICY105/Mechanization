...
# Summon Entity & Init
summon minecraft:item_display ~ ~ ~ {Tags:["mechanization", "mechanization.new", "mechanization.teleporter", "mechanization.has_block_hitbox", "mechanization.observable", "energy.receive", "smithed.block"], CustomName:{"translate":"block.mechanization.teleporter"}, item:{id:"minecraft:blast_furnace", components:{"minecraft:item_model":"mechanization:machines/block/teleporter"}, Count:1b}}
