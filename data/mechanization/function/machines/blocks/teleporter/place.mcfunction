...
# Summon Entity & Init
summon minecraft:item_display ~ ~ ~ {Tags:["mechanization", "mechanization.new", "mechanization.teleporter", "mechanization.has_block_hitbox", "energy.receive", "smithed.block"], item_display:"head", CustomName:'{"translate":"block.mechanization.teleporter"}', item:{id:"minecraft:blast_furnace", components:{"minecraft:custom_model_data":6422017}, Count:1b}}
