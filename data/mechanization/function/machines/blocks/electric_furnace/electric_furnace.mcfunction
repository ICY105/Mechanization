...
execute if score #active mechanization.data matches 1 if score @s energy.storage matches 12.. if entity @s[tag=!mechanization.upgraded] run data merge block ~ ~ ~ {lit_time_remaining:200s}
execute if score #active mechanization.data matches 1 if score @s energy.storage matches 12.. if entity @s[tag=mechanization.upgraded,tag=!mechanization.upgraded.ender,tag=!mechanization.upgraded.nether] run data merge block ~ ~ ~ {lit_time_remaining:200s,cooking_total_time:150s}
execute if score #active mechanization.data matches 1 if score @s energy.storage matches 12.. if entity @s[tag=mechanization.upgraded.ender] run data merge block ~ ~ ~ {lit_time_remaining:200s,cooking_total_time:100s}
execute if score #active mechanization.data matches 1 if score @s energy.storage matches 96.. if entity @s[tag=mechanization.upgraded.nether] run data merge block ~ ~ ~ {lit_time_remaining:200s,cooking_time_spent:1,cooking_total_time:19s}

execute if score #active mechanization.data matches 1 if score @s energy.storage matches ..11 if entity @s[tag=!mechanization.upgraded.nether] run data merge block ~ ~ ~ {lit_time_remaining:1s}
execute if score #active mechanization.data matches 1 if score @s energy.storage matches ..95 if entity @s[tag=mechanization.upgraded.nether] run data merge block ~ ~ ~ {lit_time_remaining:1s}
...
# use power
execute if score #active mechanization.data matches 1 if entity @s[tag=!mechanization.upgraded.nether] run scoreboard players remove @s energy.storage 12
execute if score #active mechanization.data matches 1 if entity @s[tag=mechanization.upgraded.nether] run scoreboard players remove @s energy.storage 96
