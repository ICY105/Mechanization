...
# Summon Entity & Init
summon minecraft:item_display ~ ~ ~ {CustomName:{"translate":"block.mechanization.electric_furnace"}, item:{id:"minecraft:blast_furnace", components:{"minecraft:item_model":"mechanization:machines/block/electric_furnace"}, count: 1}, \
    Tags:["mechanization", "mechanization.new", "mechanization.electric_furnace", "mechanization.redstone_control", "mechanization.upgradable", "mechanization.observable", "mechanization.mufflable", "mechanization.rotatable", "energy.receive", "smithed.block"]}
