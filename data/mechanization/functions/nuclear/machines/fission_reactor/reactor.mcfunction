...
execute if score $base.cf.backup mechanization.data matches 1 unless score @s mech_x matches -2147483648.. store result score @s mech_x run data get entity @s ArmorItems[3].tag.mech_x
execute if score $base.cf.backup mechanization.data matches 1 unless score @s mech_y matches -2147483648.. store result score @s mech_y run data get entity @s ArmorItems[3].tag.mech_y
...
execute if score temp_0 mechanization.data matches 100.. run tag @s[tag=mech_uranium] add mech_active
execute if score temp_0 mechanization.data matches 100.. run tag @s[tag=mech_plutonium] add mech_active
...
execute if score $base.cf.backup mechanization.data matches 1 store result entity @s ArmorItems[3].tag.mech_x int 1 run scoreboard players get @s mech_x
execute if score $base.cf.backup mechanization.data matches 1 store result entity @s ArmorItems[3].tag.mech_y int 1 run scoreboard players get @s mech_y
