...
execute if score temp_0 mech_data < temp_1 mech_data run replaceitem entity @s weapon.mainhand iron_hoe{du_nerf:1b, mech_itemid: 3102, Unbreakable:1, OreDict:["cellSpentFuel"], Damage:11, HideFlags:6, display: {Name: "{\"text\":\"Spent Fuel Cell\",\"color\":\"gray\",\"italic\":false}"}}
