...
execute if score $nuclear.cf.small_explosion mech_data matches 0 if score @s du_move_x matches 2000000.. run function mechanization:nuclear/machines/fission_reactor/explode
execute if score $nuclear.cf.small_explosion mech_data matches 1 if score @s du_move_x matches 2000000.. run function mechanization:nuclear/machines/fission_reactor/explode_small
