...
execute if score temp_0 mechanization.data matches 0..9 run data modify entity @s HandItems[0].tag.display.Name set value '{"translate":"mech.item.depleted_uranium_cell","color":"dark_green","italic":false}'
...
execute if score temp_0 mechanization.data matches 10..39 run data modify entity @s HandItems[0].tag.display.Name set value '{"translate":"mech.item.uranium_cell","color":"dark_green","italic":false}'
...
execute if score temp_0 mechanization.data matches 40..69 run data modify entity @s HandItems[0].tag.display.Name set value '{"translate":"mech.item.uranium_cell","color":"dark_green","italic":false}'
...
execute if score temp_0 mechanization.data matches 70..99 run data modify entity @s HandItems[0].tag.display.Name set value '{"translate":"mech.item.enriched_uranium_cell","color":"dark_green","italic":false}'
...
execute if score temp_0 mechanization.data matches 100.. run data modify entity @s HandItems[0].tag.display.Name set value '{"translate":"mech.item.pure_uranium_cell","color":"dark_green","italic":false}'
