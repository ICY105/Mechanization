...
execute if score $base.timer_100 du_data matches 25 as @e[type=minecraft:armor_stand,tag=mech_fission_reactor] at @s run function mechanization:nuclear/machines/fission_reactor/reactor
