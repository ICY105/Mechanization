...
execute if score #id mechanization.data matches 28 if data storage smithed.custom_block:main blockApi{id:"mechanization:moderator_cell"} run function mechanization:nuclear/blocks/moderator_cell/place
execute if score #id mechanization.data matches 34 if data storage smithed.custom_block:main blockApi{id:"mechanization:water_moderator_cell"} run function mechanization:nuclear/blocks/water_moderator_cell/place
execute if score #id mechanization.data matches 40 if data storage smithed.custom_block:main blockApi{id:"mechanization:heavy_water_moderator_cell"} run function mechanization:nuclear/blocks/heavy_water_moderator_cell/place
