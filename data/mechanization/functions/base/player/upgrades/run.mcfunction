...
execute if score #success mechanization.data matches 1 run data modify storage smithed.actionbar:input message set value {priority:"notification",json:'[{"translate":"text.mechanization.muffler_upgrade.use","color":"gold"}]'}
execute if score #success mechanization.data matches 1 run function #smithed.actionbar:message
