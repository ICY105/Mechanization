...
execute if score #success mechanization.data matches 1 run title @s actionbar [{"translate":"text.mechanization.use_machine_upgrade","color":"dark_green"}]
...
execute if score #success mechanization.data matches 1 run title @s actionbar [{"translate":"text.mechanization.use_machine_upgrade","color":"dark_purple"}]
...
execute if score #success mechanization.data matches 1 run title @s actionbar [{"translate":"text.mechanization.use_machine_upgrade","color":"dark_red"}]
...
execute if score #success mechanization.data matches 1 run title @s actionbar [{"translate":"text.mechanization.muffler_upgrade.use","color":"gold"}]
