...
execute if score #side mechanization.data matches 0 if score #state mechanization.data matches 2 unless score @s mechanization.fluid.in matches -64..64 run scoreboard players set @s fluid.io.up 0
...
execute if score #side mechanization.data matches 1 if score #state mechanization.data matches 2 unless score @s mechanization.fluid.in matches -64..64 run scoreboard players set @s fluid.io.down 0
...
execute if score #side mechanization.data matches 2 if score #state mechanization.data matches 2 unless score @s mechanization.fluid.in matches -64..64 run scoreboard players set @s fluid.io.north 0
...
execute if score #side mechanization.data matches 3 if score #state mechanization.data matches 2 unless score @s mechanization.fluid.in matches -64..64 run scoreboard players set @s fluid.io.south 0
...
execute if score #side mechanization.data matches 4 if score #state mechanization.data matches 2 unless score @s mechanization.fluid.in matches -64..64 run scoreboard players set @s fluid.io.east 0
...
execute if score #side mechanization.data matches 5 if score #state mechanization.data matches 2 unless score @s mechanization.fluid.in matches -64..64 run scoreboard players set @s fluid.io.west 0
