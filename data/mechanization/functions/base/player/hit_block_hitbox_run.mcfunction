...
execute if entity @s[tag=!mechanization.block_hitbox.tier_1,tag=!mechanization.block_hitbox.tier_2,tag=!mechanization.block_hitbox.tier_3] positioned ~ ~1 ~ align xyz as @e[tag=mechanization.has_block_hitbox,dx=0,dy=0,dz=0] run function mechanization:base/utils/break_block/break_machine_t1
