...
execute if data storage nbt_smelting:io item.tag.smithed.dict.raw{structural:1b} store success score #success mechanization.data run loot replace block -30000000 0 3201 container.0 loot mechanization:base/structural_ingot
execute if data storage nbt_smelting:io item.tag.smithed.dict.raw{conductive:1b} store success score #success mechanization.data run loot replace block -30000000 0 3201 container.0 loot mechanization:base/conductive_ingot
...
execute if data storage nbt_smelting:io item.tag.smithed.dict.raw{reinforced_structural:1b} store success score #success mechanization.data run loot replace block -30000000 0 3201 container.0 loot mechanization:base/reinforced_structural_ingot
execute if data storage nbt_smelting:io item.tag.smithed.dict.raw{super_conductive:1b} store success score #success mechanization.data run loot replace block -30000000 0 3201 container.0 loot mechanization:base/super_conductive_ingot
