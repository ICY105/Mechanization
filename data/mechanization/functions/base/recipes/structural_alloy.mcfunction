...
execute unless data block ~ ~ ~ Items[1] if predicate mechanization:recipes/base/structural_alloy_raw_from_block run loot replace block ~ ~ ~ container.16 loot mechanization:base/resources_x9/structural_raw
execute if predicate mechanization:recipes/base/structural_alloy_raw_block run loot replace block ~ ~ ~ container.16 loot mechanization:base/structural_raw_block
