...
execute unless data block ~ ~ ~ Items[1] if predicate mechanization:recipes/base/plutonium_raw_from_block run loot replace block ~ ~ ~ container.16 loot mechanization:base/resources_x9/plutonium_raw
execute if predicate mechanization:recipes/base/plutonium_raw_block run loot replace block ~ ~ ~ container.16 loot mechanization:base/plutonium_raw_block
