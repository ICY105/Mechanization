...
execute if entity @s[tag=mechanization.ender_block] run loot spawn ~ ~ ~ loot mechanization:base/ender_alloy_block
execute if entity @s[tag=mechanization.raw_ender_block] run loot spawn ~ ~ ~ loot mechanization:base/ender_alloy_raw_block
execute if entity @s[tag=mechanization.nether_block] run loot spawn ~ ~ ~ loot mechanization:base/nether_alloy_block
execute if entity @s[tag=mechanization.raw_nether_block] run loot spawn ~ ~ ~ loot mechanization:base/nether_alloy_raw_block
...
execute align xyz run kill @e[type=minecraft:experience_orb,dx=0,dy=0,dz=0]
kill @s
