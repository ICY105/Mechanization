...
execute if score $base.timer_20 du_data matches 2 as @e[type=item_frame,tag=mech_battery2] at @s run function mechanization:base/machines/tier_2_battery
execute if score $base.timer_20 du_data matches 3 as @e[type=item_frame,tag=mech_battery3] at @s run function mechanization:base/machines/tier_3_battery
execute if score $base.timer_20 du_data matches 4 run function mechanization:base/machines/quantum_network/main
execute if score $base.timer_20 du_data matches 5 as @e[type=item_frame,tag=mech_capacitor1] at @s run function mechanization:base/machines/tier_1_capacitor
execute if score $base.timer_20 du_data matches 6 as @e[type=item_frame,tag=mech_capacitor2] at @s run function mechanization:base/machines/tier_2_capacitor
execute if score $base.timer_20 du_data matches 7 as @e[type=item_frame,tag=mech_capacitor3] at @s run function mechanization:base/machines/tier_3_capacitor
