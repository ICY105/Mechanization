...
execute if score $base.timer_20 du_data matches 2 as @e[type=#mechanization:valid_block_entities,tag=mech_transmitter,scores={mech_power=1..}] at @s run function mechanization:base/energy/send_power
execute if score $base.timer_20 du_data matches 3 as @e[type=#mechanization:valid_block_entities,tag=mech_power_storage,scores={mech_power=1..}] at @s run function mechanization:base/energy/send_power
