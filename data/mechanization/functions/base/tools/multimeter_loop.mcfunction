...
execute align xyz positioned ~0.5 ~0.5 ~0.5 if block ~ ~ ~ #mechanization:raytrace_tools if entity @e[distance=..0.5,scores={mech_power=0..}] run function mechanization:base/tools/multimeter_run
