...
execute if score in_0 mech_data matches 0 if block ~ ~ ~ minecraft:smoker run function mechanization:base/tools/wrench_rotate/smoker
execute if score in_0 mech_data matches 0 if block ~ ~ ~ minecraft:blast_furnace run function mechanization:base/tools/wrench_rotate/blast_furnace
...
execute if score in_0 mech_data matches 0 if block ~ ~ ~ minecraft:loom run function mechanization:base/tools/wrench_rotate/loom
execute if score in_0 mech_data matches 0 if block ~ ~ ~ minecraft:stonecutter run function mechanization:base/tools/wrench_rotate/stonecutter
execute if score in_0 mech_data matches 0 if block ~ ~ ~ minecraft:grindstone run function mechanization:base/tools/wrench_rotate/grindstone
execute if score in_0 mech_data matches 0 if block ~ ~ ~ minecraft:bell[attachment=floor] run function mechanization:base/tools/wrench_rotate/bell
...
execute if score in_0 mech_data matches 0 if block ~ ~ ~ minecraft:beehive run function mechanization:base/tools/wrench_rotate/beehive
execute if score in_0 mech_data matches 0 if block ~ ~ ~ minecraft:bee_nest run function mechanization:base/tools/wrench_rotate/bee_nest

#sign
execute if score in_0 mech_data matches 0 if block ~ ~ ~ minecraft:oak_sign run function mechanization:base/tools/wrench_rotate/oak_sign
execute if score in_0 mech_data matches 0 if block ~ ~ ~ minecraft:spruce_sign run function mechanization:base/tools/wrench_rotate/spruce_sign
execute if score in_0 mech_data matches 0 if block ~ ~ ~ minecraft:birch_sign run function mechanization:base/tools/wrench_rotate/birch_sign
execute if score in_0 mech_data matches 0 if block ~ ~ ~ minecraft:jungle_sign run function mechanization:base/tools/wrench_rotate/jungle_sign
execute if score in_0 mech_data matches 0 if block ~ ~ ~ minecraft:acacia_sign run function mechanization:base/tools/wrench_rotate/acacia_sign
execute if score in_0 mech_data matches 0 if block ~ ~ ~ minecraft:dark_oak_sign run function mechanization:base/tools/wrench_rotate/dark_oak_sign
