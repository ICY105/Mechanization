...
execute if block ~ ~ ~ #mechanization:raytrace_tools if score in_0 mech_data matches 1.. positioned ^ ^ ^0.05 run function mechanization:base/tools/machine_upgrade_loop