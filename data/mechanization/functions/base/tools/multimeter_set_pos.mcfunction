...
#store to storage
data modify storage du:temp obj set value {x:0,y:0,z:0}
...
#set multimeter data
data modify block -29999999 0 1602 Text1 set value '{"translate":"mech.text.multimeter.set_pos","color":"gray","italic":false,"with":[{"score":{"name":"$temp_0","objective":"mech_data"}},{"score":{"name":"$temp_1","objective":"mech_data"}},{"score":{"name":"$temp_2","objective":"mech_data"}}]}'
...
#print to chat
title @s actionbar [{"translate":"mech.text.multimeter.set_pos","color":"dark_green","with":[{"score":{"name":"$temp_0","objective":"mech_data"},"color":"dark_aqua"},{"score":{"name":"$temp_1","objective":"mech_data"},"color":"dark_aqua"},{"score":{"name":"$temp_2","objective":"mech_data"},"color":"dark_aqua"}]}]
