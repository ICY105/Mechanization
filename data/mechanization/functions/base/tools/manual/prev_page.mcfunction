...
execute store result score temp_1 mech_data run data get entity @s SelectedItem.tag.manual.page_min
execute if entity @s[tag=mech_manual_open] if score temp_0 mech_data > temp_1 mech_data run scoreboard players remove temp_0 mech_data 1
