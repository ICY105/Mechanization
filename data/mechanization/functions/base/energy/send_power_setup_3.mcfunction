...
scoreboard players operation $temp_0 mech_data = $base.cf.copper_cable.transfer_rate mech_data
...
execute if entity @e[type=#mechanization:valid_block_entities,predicate=mechanization:matches_gridid,tag=mech_super_conductive_cable] run scoreboard players operation $temp_0 mech_data = $base.cf.super_conductive_cable.transfer_rate mech_data
