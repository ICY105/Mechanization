...
#get data
execute store result score temp_2 mech_data run data get block -29999999 0 1601 Items[0].tag.mech_battery.max_energy
execute store result score temp_3 mech_data run data get block -29999999 0 1601 Items[0].tag.mech_battery.base_model
execute store result score temp_4 mech_data run data get block -29999999 0 1601 Items[0].tag.mech_battery.models
...
execute unless score temp_3 mech_data matches 0 if score temp_2 mech_data matches 1.. store result block -29999999 0 1601 Items[0].tag.CustomModelData int 1 run scoreboard players get temp_3 mech_data
