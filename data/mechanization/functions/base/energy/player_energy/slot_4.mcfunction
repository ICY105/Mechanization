...
#get data
execute store result score temp_2 mechanization.data run data get block -29999999 0 1601 Items[4].tag.mech_battery.max_energy
execute store result score temp_3 mechanization.data run data get block -29999999 0 1601 Items[4].tag.mech_battery.base_model
execute store result score temp_4 mechanization.data run data get block -29999999 0 1601 Items[4].tag.mech_battery.models
...
#store data
execute store result block -29999999 0 1601 Items[4].tag.mech_battery.energy int 1 run scoreboard players get temp_1 mech_data
...
data modify block -29999999 0 1601 Items[4].tag.display.Lore[0] set from block -29999999 0 1602 Text1
...
execute unless score temp_3 mechanization.data matches 0 if score temp_2 mechanization.data matches 1.. store result block -29999999 0 1601 Items[4].tag.CustomModelData int 1 run scoreboard players get temp_3 mech_data
