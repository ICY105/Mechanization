...
execute if score temp_2 mech_data matches 1.. store result block -29999999 0 1601 Items[7].tag.CustomModelData int 1 run scoreboard players get temp_3 mech_data
