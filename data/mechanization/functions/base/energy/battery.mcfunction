...
execute if score $in_3 mech_data matches 4 if score $temp_0 mech_data matches 1.. as @e[distance=..4,tag=mech_power_storage,predicate=mechanization:base/valid_get_capacitor,sort=nearest] at @s run function mechanization:base/energy/receive
execute if score $in_3 mech_data matches 8 if score $temp_0 mech_data matches 1.. as @e[distance=..8,tag=mech_power_storage,predicate=mechanization:base/valid_get_capacitor,sort=nearest] at @s run function mechanization:base/energy/receive
execute if score $in_3 mech_data matches 12 if score $temp_0 mech_data matches 1.. as @e[distance=..12,tag=mech_power_storage,predicate=mechanization:base/valid_get_capacitor,sort=nearest] at @s run function mechanization:base/energy/receive
execute if score $in_3 mech_data matches 16 if score $temp_0 mech_data matches 1.. as @e[distance=..16,tag=mech_power_storage,predicate=mechanization:base/valid_get_capacitor,sort=nearest] at @s run function mechanization:base/energy/receive
execute if score $in_3 mech_data matches 20 if score $temp_0 mech_data matches 1.. as @e[distance=..20,tag=mech_power_storage,predicate=mechanization:base/valid_get_capacitor,sort=nearest] at @s run function mechanization:base/energy/receive
execute if score $in_3 mech_data matches 24 if score $temp_0 mech_data matches 1.. as @e[distance=..24,tag=mech_power_storage,predicate=mechanization:base/valid_get_capacitor,sort=nearest] at @s run function mechanization:base/energy/receive
execute if score $in_3 mech_data matches 28 if score $temp_0 mech_data matches 1.. as @e[distance=..28,tag=mech_power_storage,predicate=mechanization:base/valid_get_capacitor,sort=nearest] at @s run function mechanization:base/energy/receive
execute if score $in_3 mech_data matches 32 if score $temp_0 mech_data matches 1.. as @e[distance=..32,tag=mech_power_storage,predicate=mechanization:base/valid_get_capacitor,sort=nearest] at @s run function mechanization:base/energy/receive
