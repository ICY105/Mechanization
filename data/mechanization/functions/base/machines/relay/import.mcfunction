...
execute if entity @s[scores={mech_power=..5400}] as @e[scores={mech_power=600..},distance=1..16,tag=mech_power_storage,tag=!mech_battery_qu] run tag @s[scores={mech_gridid=0}] add mech_posstrans
