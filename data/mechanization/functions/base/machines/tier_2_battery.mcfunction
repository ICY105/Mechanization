...
#get capacity
scoreboard players operation $in_2 mechanization.data = $base.cf.t2_battery.capacity mech_data
execute if entity @s[tag=mech_upgraded] run scoreboard players operation $in_2 mechanization.data = $base.cf.t2_battery.capacity_mu mech_data
execute if entity @s[tag=mech_upgrade_ender] run scoreboard players operation $in_2 mechanization.data = $base.cf.t2_battery.capacity_eu mech_data
execute if entity @s[tag=mech_upgrade_nether] run scoreboard players operation $in_2 mechanization.data = $base.cf.t2_battery.capacity_nu mech_data
...
scoreboard players set $in_2 mechanization.data 6421909
