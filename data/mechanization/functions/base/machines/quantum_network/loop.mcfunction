...
execute as @e[tag=mech_battery_qu,tag=mech_not_checked] if score @s mech_gridid = in_5 mech_data at @s run function mechanization:base/machines/quantum_network/delta
