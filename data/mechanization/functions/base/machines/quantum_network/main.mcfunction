...
tag @e[tag=mech_battery_qu] add mech_not_checked
...
execute as @e[tag=mech_battery_qu,tag=mech_not_checked,limit=1] run function mechanization:base/machines/quantum_network/new
