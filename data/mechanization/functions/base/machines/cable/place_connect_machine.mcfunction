...
execute if score $out_0 mech_data matches 1 if score $in_0 mech_data matches 2 run scoreboard players add $temp_0 mech_data 16
execute if score $out_0 mech_data matches 1 if score $in_0 mech_data matches 3 run scoreboard players add $temp_0 mech_data 32
