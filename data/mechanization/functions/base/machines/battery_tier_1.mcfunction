...
#rate
scoreboard players operation in_0 mech_data = $base.config.t1_rate mech_data
execute if entity @s[tag=mech_upgraded] run scoreboard players operation in_0 mech_data = $base.config.t1_rate_upgrade mech_data
execute if entity @s[tag=mech_upgrade_ender] run scoreboard players operation in_0 mech_data = $base.config.t1_rate_ender_upgrade mech_data
execute if entity @s[tag=mech_upgrade_nether] run scoreboard players operation in_0 mech_data = $base.config.t1_rate_nether_upgrade mech_data

#buffer
scoreboard players set in_1 mech_data 2000

#capacity
scoreboard players operation in_2 mech_data = $base.config.t1_capacity mech_data
execute if entity @s[tag=mech_upgraded] run scoreboard players operation in_2 mech_data = $base.config.t1_capacity_upgrade mech_data
execute if entity @s[tag=mech_upgrade_ender] run scoreboard players operation in_2 mech_data = $base.config.t1_capacity_ender_upgrade mech_data
execute if entity @s[tag=mech_upgrade_nether] run scoreboard players operation in_2 mech_data = $base.config.t1_capacity_nether_upgrade mech_data
