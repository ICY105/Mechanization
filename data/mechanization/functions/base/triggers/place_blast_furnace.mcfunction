...
execute store result score in_0 mechanization.data run data get entity @s SelectedItem.tag.mech_itemid
execute store result score $id mechanization.data run data get entity @s SelectedItem.tag.mech_itemid
