...
execute if score #stored_power mechanization.data matches 1.. as @e[type=item,sort=nearest,limit=1,distance=..1] run data modify entity @s Item.tag.display.Lore append from block -30000000 0 3202 Text1

execute if score #upgrade mechanization.data matches 1 as @e[type=item,sort=nearest,limit=1,distance=..1] run data modify entity @s Item.tag.display.Lore append value '{"translate":"mech.item.machine_upgrade", "color":"gray", "italic":false}'
execute if score #upgrade mechanization.data matches 2 as @e[type=item,sort=nearest,limit=1,distance=..1] run data modify entity @s Item.tag.display.Lore append value '{"translate":"mech.item.nether_upgrade",  "color":"gray", "italic":false}'
execute if score #upgrade mechanization.data matches 3 as @e[type=item,sort=nearest,limit=1,distance=..1] run data modify entity @s Item.tag.display.Lore append value '{"translate":"mech.item.ender_upgrade",   "color":"gray", "italic":false}'
