...
execute if score $base.cf.ore_compatibility mechanization.data matches 1 run scoreboard players set $world.in_4 du_data 1
execute if score $base.cf.ore_compatibility mechanization.data matches 1 run scoreboard players set $world.in_5 du_data 1
...
execute if score $base.cf.tin_rarity mechanization.data matches 1.. run function du:world/registry/register_ore
scoreboard players operation $cons.tin_ore mechanization.data = $world.out_0 du_data
...
#Call Registry Function
data merge storage du:temp {object:{dimension:"minecraft:overworld"}}
execute if score $base.cf.titanium_rarity mechanization.data matches 1.. run function du:world/registry/register_ore
scoreboard players operation $cons.titanium_ore mechanization.data = $world.out_0 du_data
...
#Call Registry Function
data merge storage du:temp {object:{dimension:"minecraft:overworld"}}
execute if score $base.cf.uranium_rarity mechanization.data matches 1.. run function du:world/registry/register_ore
scoreboard players operation $cons.uranium_ore mechanization.data = $world.out_0 du_data
...
#Call Registry Function
data merge storage du:temp {object:{dimension:"minecraft:overworld"}}
execute if score $base.cf.emerald_rarity mechanization.data matches 1.. run function du:world/registry/register_ore
scoreboard players operation $cons.emerald_ore mechanization.data = $world.out_0 du_data
