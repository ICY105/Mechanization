...
execute if data storage mechanization:temp obj{id:"minecraft:potion"}.tag.mechanization{id:"bucket"} run scoreboard players set #out mechanization.data 1
execute if data storage mechanization:temp obj{id:"minecraft:potion"}.tag.mechanization{id:"glass_bucket"} run scoreboard players set #out mechanization.data 1
execute if data storage mechanization:temp obj{id:"minecraft:potion"}.tag.mechanization{id:"vial"} run scoreboard players set #out mechanization.data 1
