...
execute if score $base.timer_20 du_data matches 14 as @e[tag=mech_auto_jukebox] at @s run function mechanization:assembly/machines/auto_jukebox
execute if score $base.timer_20 du_data matches 13 as @e[tag=mech_drive_bay] at @s run function mechanization:assembly/machines/mss/drive_bay
execute if score $base.timer_20 du_data matches 12 as @e[tag=mech_item_extractor] at @s run function mechanization:assembly/machines/item_extractor/item_extractor
execute if score $base.timer_20 du_data matches 11 as @e[tag=mech_item_inserter] at @s run function mechanization:assembly/machines/item_inserter/item_inserter
...
execute if score $base.timer_100 du_data matches 90 as @e[tag=mech_item_pipe] at @s run function mechanization:assembly/machines/item_pipe/item_pipe
