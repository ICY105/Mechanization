...
execute if score #timer.20 mechanization.data matches 12 as @e[type=minecraft:item_display,tag=mechanization.item_extractor] at @s run function mechanization:assembly/blocks/item_extractor/item_extractor
execute if score #timer.20 mechanization.data matches 11 as @e[type=minecraft:item_display,tag=mechanization.item_inserter] at @s run function mechanization:assembly/blocks/item_inserter/item_inserter
