...
execute if score timer_20 du_data matches 14 as @e[tag=mech_item_receiver] at @s run function mechanization:assembly/machines/item_receiver
execute if score timer_20 du_data matches 14 as @e[tag=mech_item_transmitter] at @s run function mechanization:assembly/machines/item_transmitter/item_transmitter
execute if score timer_20 du_data matches 13 as @e[tag=mech_auto_jukebox] at @s run function mechanization:assembly/machines/auto_jukebox
