...
#machine tick
execute if score $base.timer_20 du_data matches 19 as @e[type=minecraft:glow_item_frame,tag=mech_compressor] at @s run function mechanization:assembly/machines/compressor/compressor
...
execute if score $base.timer_2 du_data matches 1 as @e[type=minecraft:glow_item_frame,tag=mech_unlimited_storage] at @s run function mechanization:assembly/machines/unlimited_storage/unlimited_storage
...
execute if score $base.timer_10 du_data matches 9 as @e[type=minecraft:glow_item_frame,tag=mech_terminal,tag=!mech_active] at @s run function mechanization:assembly/machines/mss/terminal
execute as @e[type=minecraft:glow_item_frame,tag=mech_terminal,tag=mech_active] at @s run function mechanization:assembly/machines/mss/terminal
