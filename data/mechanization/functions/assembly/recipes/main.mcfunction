...
#Dye Machine
execute if score in_0 du_data matches 4.. if score in_2 du_data matches 4.. if score in_3 du_data matches 2.. if score in_5 du_data matches 2.. if score in_6 du_data matches 4.. if score in_7 du_data matches 4.. if score in_8 du_data matches 4.. if block ~ ~ ~ barrel{Items:[{Slot:2b, id:"minecraft:blue_dye"},{Slot:3b, id:"minecraft:crafting_table"},{Slot:4b, id:"minecraft:green_dye"},{Slot:11b, tag:{OreDict:["ingotConductive"]}},{Slot:12b, tag:{OreDict:["blockMachineFrame2"]}},{Slot:13b, tag:{OreDict:["ingotConductive"]}},{Slot:20b, id:"minecraft:yellow_dye"},{Slot:21b, id:"minecraft:red_dye"},{Slot:22b, id:"minecraft:black_dye"}]} run function mechanization:assembly/recipes/dye_machine
