...
#custom 3x3
execute if score out_0 mech_data matches 9.. if block ~ ~ ~ dropper{Items:[{Slot:0b,tag:{OreDict:["ingotCopper"]} }]		} store success score temp_1 mech_data run function give:mech_assembly/copper_block
execute if score out_0 mech_data matches 9.. if block ~ ~ ~ dropper{Items:[{Slot:0b,tag:{OreDict:["ingotTin"]} }]			} store success score temp_1 mech_data run function give:mech_assembly/tin_block
execute if score out_0 mech_data matches 9.. if block ~ ~ ~ dropper{Items:[{Slot:0b,tag:{OreDict:["ingotTitanium"]} }]		} store success score temp_1 mech_data run function give:mech_assembly/titanium_block
execute if score out_0 mech_data matches 9.. if block ~ ~ ~ dropper{Items:[{Slot:0b,tag:{OreDict:["gemCrystalComposite"]} }]} store success score temp_1 mech_data run function give:mech_assembly/crystal_block
execute if score out_0 mech_data matches 9.. if block ~ ~ ~ dropper{Items:[{Slot:0b,tag:{OreDict:["ingotUranium"]} }]		} store success score temp_1 mech_data run function give:mech_assembly/uranium_block
execute if score out_0 mech_data matches 9.. if block ~ ~ ~ dropper{Items:[{Slot:0b,tag:{OreDict:["ingotPlutonium"]} }]		} store success score temp_1 mech_data run function give:mech_assembly/plutonium_block
execute if score out_0 mech_data matches 9.. if block ~ ~ ~ dropper{Items:[{Slot:0b,id:"minecraft:flint"}]					} store success score temp_1 mech_data run function give:mech_assembly/flint_block
execute if score out_0 mech_data matches 9.. if block ~ ~ ~ dropper{Items:[{Slot:0b,id:"minecraft:charcoal"}]				} store success score temp_1 mech_data run function give:mech_assembly/charcoal_block

execute if score out_0 mech_data matches 9.. if block ~ ~ ~ dropper{Items:[{Slot:0b,id:"minecraft:nether_star"}]			} store success score temp_1 mech_data run function give:mech_assembly/nether_star_block
execute if score out_0 mech_data matches 9.. if block ~ ~ ~ dropper{Items:[{Slot:0b,id:"minecraft:rotten_flesh"}]					} store success score temp_1 mech_data run function give:mech_assembly/flesh_block
execute if score out_0 mech_data matches 9.. if block ~ ~ ~ dropper{Items:[{Slot:0b,id:"minecraft:sugar_cane"}]				} store success score temp_1 mech_data run function give:mech_assembly/sugar_cane_block
...
execute if score out_0 mech_data matches 4.. if block ~ ~ ~ dropper{Items:[{Slot:0b,id:"minecraft:ender_pearl"}]	} store success score temp_1 mech_data run function give:mech_assembly/ender_block
