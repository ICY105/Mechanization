...
execute if data entity @s Item.tag.item.id run data modify storage mechanization:temp obj set from entity @s Item.tag.item
execute if data entity @s Item.tag.item.id store success score #failed mechanization.data run data modify storage mechanization:temp obj set from block ~ ~ ~ Items[{Slot:0b}]
