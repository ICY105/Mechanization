...
# run IO commands
execute unless score @s mechanization.data matches 2147483580.. if data block ~ ~ ~ Items[{Slot:0b}] run function mechanization:assembly/machines/unlimited_storage_unit/input
execute if score @s mechanization.data matches 1.. unless data block ~ ~ ~ Items[{Slot:2b,Count:64b}] run function mechanization:assembly/machines/unlimited_storage_unit/output
