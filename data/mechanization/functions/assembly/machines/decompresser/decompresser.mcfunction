...
execute if score @s[nbt={ItemRotation:4b}] mech_power matches 144.. if data block ~ ~ ~ Items[0] rotated 180 0 run function mechanization:assembly/machines/decompresser/check_recipes
execute if score @s[nbt={ItemRotation:2b}] mech_power matches 144.. if data block ~ ~ ~ Items[0] rotated -90 0 run function mechanization:assembly/machines/decompresser/check_recipes
execute if score @s[nbt={ItemRotation:0b}] mech_power matches 144.. if data block ~ ~ ~ Items[0] rotated 0 0 run function mechanization:assembly/machines/decompresser/check_recipes
execute if score @s[nbt={ItemRotation:6b}] mech_power matches 144.. if data block ~ ~ ~ Items[0] rotated 90 0 run function mechanization:assembly/machines/decompresser/check_recipes
