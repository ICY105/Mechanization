...
#3x3 custom
execute if block ~ ~ ~ dropper{Items:[{Slot:3b,tag:{OreDict:["blockCopper"]} }]		} store success score temp_1 mech_data run function give:mech_machines/copper_ingot
execute if block ~ ~ ~ dropper{Items:[{Slot:3b,tag:{OreDict:["blockTin"]} }]		} store success score temp_1 mech_data run function give:mech_machines/tin_ingot
execute if block ~ ~ ~ dropper{Items:[{Slot:3b,tag:{OreDict:["blockTitanium"]} }]	} store success score temp_1 mech_data run function give:mech_machines/titanium_ingot
execute if block ~ ~ ~ dropper{Items:[{Slot:3b,tag:{OreDict:["blockCrystalComposite"]} }]} store success score temp_1 mech_data run function give:mech_machines/crystal_composite
execute if block ~ ~ ~ dropper{Items:[{Slot:3b,tag:{OreDict:["blockUranium"]} }]	} store success score temp_1 mech_data run function give:mech_nuclear/uranium_ingot
execute if block ~ ~ ~ dropper{Items:[{Slot:3b,tag:{OreDict:["blockPlutonium"]} }]	} store success score temp_1 mech_data run function give:mech_nuclear/plutonium_ingot
execute if block ~ ~ ~ dropper{Items:[{Slot:3b,tag:{OreDict:["blockFlint"]} }]		} store success score temp_1 mech_data run summon item ~ ~ ~ {Tags:["mech_comp_new"],Item:{id:"minecraft:flint",Count:9b}}
execute if block ~ ~ ~ dropper{Items:[{Slot:3b,tag:{OreDict:["blockCharcoal"]} }]	} store success score temp_1 mech_data run summon item ~ ~ ~ {Tags:["mech_comp_new"],Item:{id:"minecraft:charcoal",Count:9b}}
