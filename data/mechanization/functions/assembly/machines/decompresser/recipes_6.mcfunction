...
execute if data block ~ ~ ~ Items[{Slot:6b,id:"minecraft:honey_block"}] store success score temp_1 mech_data run summon item ^ ^ ^1 {Item:{id:"minecraft:honey_bottle",Count:4b}}
execute if data block ~ ~ ~ Items[{Slot:6b,id:"minecraft:honeycomb_block"}] store success score temp_1 mech_data run summon item ^ ^ ^1 {Item:{id:"minecraft:honeycomb",Count:4b}}
