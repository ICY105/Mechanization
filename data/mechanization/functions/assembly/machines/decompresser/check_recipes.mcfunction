...
### 2x2
execute if score $temp_1 mech_data matches 0 run function mechanization:assembly/machines/decompresser/check_recipes_4
execute if score $temp_1 mech_data matches 0 run function mechanization:assembly/machines/decompresser/check_recipes_9
execute if score $temp_1 mech_data matches 1 run scoreboard players remove $temp_0 mech_data 1
execute if score $temp_1 mech_data matches 1 run scoreboard players remove @s mech_power 16
