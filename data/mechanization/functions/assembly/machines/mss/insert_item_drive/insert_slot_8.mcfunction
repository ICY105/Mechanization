...
execute store result score temp_1 mechanization.data run data get storage mechanization:networks mss.drive[{Slot:8b}].tag.mss.count
...
execute if score out_0 mechanization.data matches 1 store result storage mechanization:networks mss.drive[{Slot:8b}].tag.mss.count int 1 run scoreboard players get temp_1 mech_data
...
execute if score out_0 mechanization.data matches 1 run data modify storage mechanization:networks mss.drive[{Slot:8b}].tag.display.Lore[0] set from block -29999999 0 1602 Text1

execute if score out_0 mechanization.data matches 1 store result score temp_2 mechanization.data run data get storage mechanization:networks mss.drive[{Slot:8b}].Count
execute if score temp_2 mechanization.data matches 1.. run scoreboard players set out_0 du_data 64
execute if score temp_2 mechanization.data matches 1.. run data modify entity @s ArmorItems[0] set from storage mechanization:networks mss.drive[{Slot:8b}]
...
execute if score temp_2 mechanization.data matches 1.. store result storage mechanization:networks mss.drive[{Slot:8b}].Count byte 1 run scoreboard players get out_0 du_data
