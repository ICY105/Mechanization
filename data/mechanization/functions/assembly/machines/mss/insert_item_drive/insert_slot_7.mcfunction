...
execute if score #complete mechanization.data matches 1 run data modify storage mechanization:networks mss.drive[{Slot:7b}].tag.display.Lore[0] set from block -29999999 0 1602 Text1
...
execute if score #count.4 mechanization.data matches 1.. run data modify entity @s ArmorItems[0] set from storage mechanization:networks mss.drive[{Slot:7b}]
