...
execute as @e[type=minecraft:glow_item_frame,tag=mech_drive_bay,distance=..16,sort=nearest] at @s if score in_0 mech_data matches 1.. run function mechanization:assembly/machines/mss/get_drive/get_drive
