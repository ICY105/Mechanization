...
execute as @e[type=minecraft:glowing_item_frame,tag=mech_drive_bay,distance=..16,sort=nearest] at @s unless data block ~ ~ ~ Items[26] run function mechanization:assembly/machines/mss/get_drive/insert_drive_2
