...
execute if score out_0 mech_data matches 0 as @e[tag=mech_drive_bay,distance=..16,sort=nearest] at @s run function mechanization:assembly/machines/mss/system_insert_item
...
execute if score out_0 mech_data matches 0 as @e[tag=mech_drive_bay,distance=..16,sort=nearest] at @s run function mechanization:assembly/machines/mss/system_add_item
