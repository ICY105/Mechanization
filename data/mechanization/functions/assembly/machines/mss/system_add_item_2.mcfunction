...
execute if score #slot mechanization.data <= #items mechanization.data if score #complete mechanization.data matches 0 run function mechanization:assembly/machines/mss/system_insert_item_2
