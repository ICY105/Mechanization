...
execute if score #count mechanization.data matches 1.. if score #success mechanization.data matches 0 run function mechanization:assembly/machines/stone_cutter/check_recipes_1
...
### 3x3
scoreboard players set #success mechanization.data 0
execute if score #count mechanization.data matches 4.. if score #success mechanization.data matches 0 run function mechanization:assembly/machines/stone_cutter/check_recipes_4
...
execute if data storage mechanization:temp list[0] run function mechanization:assembly/machines/stone_cutter/check_recipes
