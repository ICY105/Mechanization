...
#main
execute if score @s mech_power matches 144.. if block ~ ~ ~ dropper{Items:[{}]} run function mechanization:assembly/machines/stone_cutter/start
execute if entity @s[tag=mech_upgraded] if score @s mech_power matches 144.. if block ~ ~ ~ dropper{Items:[{}]} run function mechanization:assembly/machines/stone_cutter/start
