...
execute if score out_0 mech_data matches 4.. if block ~ ~ ~ dropper{Items:[{Slot:3b,id:"minecraft:chorus_fruit_popped"}]} run summon item ~ ~ ~ {Tags:["mech_comp_new"],Item:{id:"minecraft:purpur_block",Count:4b}}
execute if score out_0 mech_data matches 4.. if block ~ ~ ~ dropper{Items:[{Slot:3b,id:"minecraft:chorus_fruit_popped"}]} run function mechanization:assembly/machines/compressor/remove_items