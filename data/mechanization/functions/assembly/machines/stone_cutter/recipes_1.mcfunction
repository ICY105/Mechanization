...
# 4-input recipes
scoreboard players set temp_1 mech_data 0
execute if score temp_0 mech_data matches 4.. if block ~ ~ ~ dropper{Items:[{Slot:1b,id:"minecraft:prismarine_shard"}]} run summon item ^ ^ ^1 {Tags:["mech_comp_new"],Item:{id:"minecraft:prismarine",Count:4b}}
execute if score temp_0 mech_data matches 4.. if block ~ ~ ~ dropper{Items:[{Slot:1b,id:"minecraft:sand"}]} run summon item ^ ^ ^1 {Tags:["mech_comp_new"],Item:{id:"minecraft:sandstone",Count:4b}}
execute if score temp_0 mech_data matches 4.. if block ~ ~ ~ dropper{Items:[{Slot:1b,id:"minecraft:red_sand"}]} run summon item ^ ^ ^1 {Tags:["mech_comp_new"],Item:{id:"minecraft:red_sandstone",Count:4b}}
execute if score temp_0 mech_data matches 4.. if block ~ ~ ~ dropper{Items:[{Slot:1b,id:"minecraft:brick"}]} run summon item ^ ^ ^1 {Tags:["mech_comp_new"],Item:{id:"minecraft:bricks",Count:4b}}
execute if score temp_0 mech_data matches 4.. if block ~ ~ ~ dropper{Items:[{Slot:1b,id:"minecraft:nether_brick"}]} run summon item ^ ^ ^1 {Tags:["mech_comp_new"],Item:{id:"minecraft:nether_bricks",Count:4b}}
execute if score temp_0 mech_data matches 4.. if block ~ ~ ~ dropper{Items:[{Slot:1b,id:"minecraft:magma_cream"}]} run summon item ^ ^ ^1 {Tags:["mech_comp_new"],Item:{id:"minecraft:magma_block",Count:4b}}
execute if score temp_0 mech_data matches 4.. if block ~ ~ ~ dropper{Items:[{Slot:1b,id:"minecraft:popped_chorus_fruit"}]} run summon item ^ ^ ^1 {Tags:["mech_comp_new"],Item:{id:"minecraft:purpur_block",Count:4b}}
