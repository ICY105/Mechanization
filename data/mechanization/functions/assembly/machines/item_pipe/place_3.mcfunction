...
execute if score #id mechanization.data matches 0.. as @e[tag=mechanization.item_pipe,predicate=mechanization:matches_uuid] run scoreboard players operation @s mechanization.item_id = #id mechanization.data
