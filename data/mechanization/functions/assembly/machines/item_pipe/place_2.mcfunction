...
execute if score $temp_1 mechanization.data matches 0.. as @e[tag=mech_item_pipe,predicate=mechanization:matches_uuid] run scoreboard players operation @s du_uuid = $temp_1 mech_data
