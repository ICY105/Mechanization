...
scoreboard players set $temp_1 mechanization.data 64
scoreboard players operation $temp_1 mechanization.data -= $temp_0 mech_data
execute if score $temp_1 mechanization.data > @s mechanization.data run scoreboard players operation $temp_1 mechanization.data = @s mech_data

scoreboard players operation @s mechanization.data -= $temp_1 mech_data
scoreboard players operation $temp_1 mechanization.data += $temp_0 mech_data
