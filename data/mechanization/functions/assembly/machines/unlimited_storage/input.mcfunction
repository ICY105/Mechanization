...
execute unless score @s mech_data matches 1.. unless data block ~ ~ ~ Items[{Slot:2b}] run data modify entity @s ArmorItems[3].tag.item set from block ~ ~ ~ Items[{Slot:0b}]
...
data modify block -29999999 1 1601 Items prepend from entity @s ArmorItems[3].tag.item
