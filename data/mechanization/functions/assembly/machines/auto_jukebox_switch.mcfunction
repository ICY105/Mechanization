...
#choose record
execute store result score in_0 du_data run data get block ~ ~ ~ Items
function du:math/random

execute if score out_0 du_data matches 0 run data modify block -29999999 0 1600 RecordItem.tag.mech.temp set from block ~ ~ ~ Items[0]
execute if score out_0 du_data matches 1 run data modify block -29999999 0 1600 RecordItem.tag.mech.temp set from block ~ ~ ~ Items[1]
execute if score out_0 du_data matches 2 run data modify block -29999999 0 1600 RecordItem.tag.mech.temp set from block ~ ~ ~ Items[2]
execute if score out_0 du_data matches 3 run data modify block -29999999 0 1600 RecordItem.tag.mech.temp set from block ~ ~ ~ Items[3]
execute if score out_0 du_data matches 4 run data modify block -29999999 0 1600 RecordItem.tag.mech.temp set from block ~ ~ ~ Items[4]
execute if score out_0 du_data matches 5 run data modify block -29999999 0 1600 RecordItem.tag.mech.temp set from block ~ ~ ~ Items[5]
execute if score out_0 du_data matches 6 run data modify block -29999999 0 1600 RecordItem.tag.mech.temp set from block ~ ~ ~ Items[6]
execute if score out_0 du_data matches 7 run data modify block -29999999 0 1600 RecordItem.tag.mech.temp set from block ~ ~ ~ Items[7]
execute if score out_0 du_data matches 8 run data modify block -29999999 0 1600 RecordItem.tag.mech.temp set from block ~ ~ ~ Items[8]
execute if score out_0 du_data matches 9 run data modify block -29999999 0 1600 RecordItem.tag.mech.temp set from block ~ ~ ~ Items[9]
execute if score out_0 du_data matches 10 run data modify block -29999999 0 1600 RecordItem.tag.mech.temp set from block ~ ~ ~ Items[10]
execute if score out_0 du_data matches 11 run data modify block -29999999 0 1600 RecordItem.tag.mech.temp set from block ~ ~ ~ Items[11]
execute if score out_0 du_data matches 12 run data modify block -29999999 0 1600 RecordItem.tag.mech.temp set from block ~ ~ ~ Items[12]
execute if score out_0 du_data matches 13 run data modify block -29999999 0 1600 RecordItem.tag.mech.temp set from block ~ ~ ~ Items[13]
execute if score out_0 du_data matches 14 run data modify block -29999999 0 1600 RecordItem.tag.mech.temp set from block ~ ~ ~ Items[14]
execute if score out_0 du_data matches 15 run data modify block -29999999 0 1600 RecordItem.tag.mech.temp set from block ~ ~ ~ Items[15]
execute if score out_0 du_data matches 16 run data modify block -29999999 0 1600 RecordItem.tag.mech.temp set from block ~ ~ ~ Items[16]
execute if score out_0 du_data matches 17 run data modify block -29999999 0 1600 RecordItem.tag.mech.temp set from block ~ ~ ~ Items[17]
execute if score out_0 du_data matches 18 run data modify block -29999999 0 1600 RecordItem.tag.mech.temp set from block ~ ~ ~ Items[18]
execute if score out_0 du_data matches 19 run data modify block -29999999 0 1600 RecordItem.tag.mech.temp set from block ~ ~ ~ Items[19]
execute if score out_0 du_data matches 20 run data modify block -29999999 0 1600 RecordItem.tag.mech.temp set from block ~ ~ ~ Items[20]
execute if score out_0 du_data matches 21 run data modify block -29999999 0 1600 RecordItem.tag.mech.temp set from block ~ ~ ~ Items[21]
execute if score out_0 du_data matches 22 run data modify block -29999999 0 1600 RecordItem.tag.mech.temp set from block ~ ~ ~ Items[22]
execute if score out_0 du_data matches 23 run data modify block -29999999 0 1600 RecordItem.tag.mech.temp set from block ~ ~ ~ Items[23]
execute if score out_0 du_data matches 24 run data modify block -29999999 0 1600 RecordItem.tag.mech.temp set from block ~ ~ ~ Items[24]
execute if score out_0 du_data matches 25 run data modify block -29999999 0 1600 RecordItem.tag.mech.temp set from block ~ ~ ~ Items[25]
execute if score out_0 du_data matches 26 run data modify block -29999999 0 1600 RecordItem.tag.mech.temp set from block ~ ~ ~ Items[26]
execute if score out_0 du_data matches 27 run data modify block -29999999 0 1600 RecordItem.tag.mech.temp set from block ~ ~ ~ Items[27]
