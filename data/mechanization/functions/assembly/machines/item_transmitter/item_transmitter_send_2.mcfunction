...
execute in minecraft:overworld unless data block -29999999 0 1601 Items[{tag:{du_gui:1b}}] store result score temp_1 mech_data run loot insert -29999999 1 1601 mine -29999999 0 1601 minecraft:diamond_pickaxe{drop_contents:true}
