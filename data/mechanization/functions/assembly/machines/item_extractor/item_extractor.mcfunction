...
execute if score #active mechanization.data matches 1 positioned ^ ^ ^-0.5 align xyz positioned ~0.5 ~ ~0.5 if block ~ ~ ~ #mechanization:inv run function mechanization:assembly/machines/item_extractor/move_item
