...
### 2x2
execute if score #success mechanization.data matches 0 run function mechanization:assembly/machines/decompressor/check_recipes_4
execute if score #success mechanization.data matches 0 run function mechanization:assembly/machines/decompressor/check_recipes_9
execute if score #success mechanization.data matches 1 run scoreboard players remove $#count mechanization.data 1
execute if score #success mechanization.data matches 1 run scoreboard players remove @s energy.storage 16
...
execute if data storage mechanization:temp list[0] run function mechanization:assembly/machines/decompressor/check_recipes
