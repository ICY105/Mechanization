...
# Summon Entity & Init
summon minecraft:glow_item_frame ~ ~ ~ {Tags:["mechanization", "mechanization.ticking", "mechanization.fast_hopper", "smithed.block"], CustomName:'{"translate":"mech.block.fast_hopper"}', Item:{id:"minecraft:blast_furnace", tag:{CustomModelData:6425005}, Count:1b}, ItemRotation:4, Invisible:1b, Invulnerable:1b, Fixed:1b, Silent:1b}
