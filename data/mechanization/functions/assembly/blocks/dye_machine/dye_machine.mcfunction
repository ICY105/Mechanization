...
execute if score #active mechanization.data matches 1 if score @s[nbt={ItemRotation:4b}] energy.storage matches 16.. if data block ~ ~ ~ Items[{Slot:1b}] if data block ~ ~ ~ Items[{Slot:7b}] rotated 180 0 run function mechanization:assembly/blocks/dye_machine/start
execute if score #active mechanization.data matches 1 if score @s[nbt={ItemRotation:2b}] energy.storage matches 16.. if data block ~ ~ ~ Items[{Slot:1b}] if data block ~ ~ ~ Items[{Slot:7b}] rotated -90 0 run function mechanization:assembly/blocks/dye_machine/start
execute if score #active mechanization.data matches 1 if score @s[nbt={ItemRotation:0b}] energy.storage matches 16.. if data block ~ ~ ~ Items[{Slot:1b}] if data block ~ ~ ~ Items[{Slot:7b}] rotated 0 0 run function mechanization:assembly/blocks/dye_machine/start
execute if score #active mechanization.data matches 1 if score @s[nbt={ItemRotation:6b}] energy.storage matches 16.. if data block ~ ~ ~ Items[{Slot:1b}] if data block ~ ~ ~ Items[{Slot:7b}] rotated 90 0 run function mechanization:assembly/blocks/dye_machine/start
