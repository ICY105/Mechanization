...
execute if score #active mechanization.data matches 1 if score @s energy.storage matches 144.. if data block ~ ~ ~ Items[0] run function mechanization:assembly/blocks/stone_cutter/check_recipes
