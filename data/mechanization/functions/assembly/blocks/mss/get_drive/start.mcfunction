...
execute as @e[type=minecraft:glow_item_frame,tag=mechanization.drive_bay,distance=..16] at @s run function mechanization:assembly/blocks/mss/get_drive/count_drives
...
execute as @e[type=minecraft:glow_item_frame,tag=mechanization.drive_bay,distance=..16,sort=nearest] at @s if score #count.0 mechanization.data matches 1.. run function mechanization:assembly/blocks/mss/get_drive/get_drive
