execute store result score #count.2 mechanization.data run data get storage mechanization:temp list[{Slot:10b}].tag.mss.count
...
execute store result storage mechanization:temp list[{Slot:10b}].tag.mss.count int 1 run scoreboard players get #count.2 mechanization.data
