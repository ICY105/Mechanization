...
execute if score #allowed mechanization.data matches 1 if score #slot mechanization.data matches 0.. store result storage mechanization:temp obj.Slot byte 1 run scoreboard players get #slot mechanization.data
execute if score #allowed mechanization.data matches 1 if score #insert mechanization.data matches 0 if score #slot mechanization.data matches 0.. run data modify block ~ ~ ~ Items append from storage mechanization:temp obj
...
execute if score #allowed mechanization.data matches 1 if score #insert mechanization.data matches 1 if score #slot mechanization.data matches 0.. run data modify block -30000000 0 3201 Items append from storage mechanization:temp obj
