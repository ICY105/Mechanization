...
execute as @e[tag=mechanization.item_inserter,sort=nearest,limit=1,distance=..12,nbt={ItemRotation:1b}] at @s run function mechanization:assembly/player/item_filter/interact_2
