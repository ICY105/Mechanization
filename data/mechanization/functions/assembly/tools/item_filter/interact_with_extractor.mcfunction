...
execute as @e[tag=mech_item_extractor,sort=nearest,limit=1,distance=..12,nbt={ItemRotation:1b}] at @s run function mechanization:assembly/tools/item_filter/interact_2
execute if score $temp_0 mech_data matches 1 run item replace entity @s weapon.mainhand with minecraft:air
