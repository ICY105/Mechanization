...
execute if entity @e[tag=mech_unlimited_storage,distance=..5] run tellraw @p ["",{"text":"Items Stored: ","color":"dark_green"},{"score":{"name":"temp_0","objective":"mech_data"},"color":"dark_aqua"}]
