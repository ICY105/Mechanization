tag @s remove mech_upgrade_flight
tag @s remove mech_upgrade_slowfall
...
tag @s remove mech_up_helm
tag @s remove mech_up_chest
tag @s remove mech_up_legs
tag @s remove mech_up_boots