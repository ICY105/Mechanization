...
execute if score @s mech_breakstone matches 1.. if score temp_0 mech_data matches 0 at @e[type=item,sort=nearest,limit=1,nbt={Item:{id:"minecraft:cobblestone",Count:1b},Age:0s}] run fill ~-1 ~-1 ~-1 ~1 ~1 ~1 air replace #mechanization:smash_upgrade
