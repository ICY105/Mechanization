...
execute if entity @s[tag=du_sneaking,x_rotation=75..,tag=!mech_invisible] run function mechanization:base/energy/player_energy
execute if entity @s[tag=du_sneaking,tag=mech_invisible] run scoreboard players set in_0 mech_data 512
execute if entity @s[tag=du_sneaking,tag=mech_invisible] run function mechanization:base/energy/player_energy
