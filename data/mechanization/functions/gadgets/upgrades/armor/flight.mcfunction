...
execute if score $base.timer_10 du_data matches 0 if block ~ ~-1 ~ #du:air if block ~ ~-2 ~ #du:air run function mechanization:base/energy/player_energy
execute if score $base.timer_10 du_data matches 0 if entity @s[x_rotation=-90..-45] if block ~ ~-1 ~ air unless block ~ ~-2 ~ air run function mechanization:base/energy/player_energy
