...
scoreboard players set temp_0 mech_data 80
...
scoreboard players set temp_0 mech_data -350
execute if block ~ ~ ~ dropper{Items:[ {Slot:1b,tag:{OreDict:["upgradeAttackSpeed"]}} ]} run scoreboard players add temp_0 mech_data 40
execute if block ~ ~ ~ dropper{Items:[ {Slot:3b,tag:{OreDict:["upgradeAttackSpeed"]}} ]} run scoreboard players add temp_0 mech_data 40
execute if block ~ ~ ~ dropper{Items:[ {Slot:5b,tag:{OreDict:["upgradeAttackSpeed"]}} ]} run scoreboard players add temp_0 mech_data 40
execute if block ~ ~ ~ dropper{Items:[ {Slot:7b,tag:{OreDict:["upgradeAttackSpeed"]}} ]} run scoreboard players add temp_0 mech_data 40
