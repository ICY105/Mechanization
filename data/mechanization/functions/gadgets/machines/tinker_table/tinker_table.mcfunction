...
execute if block ~ ~ ~ dropper{Items:[{Slot:4b,id:"minecraft:diamond_helmet",tag:{modified:1}},{Slot:1b},{Slot:3b},{Slot:5b},{Slot:7b}]} run function mechanization:gadgets/machines/tinker_table/helmet_upgrade
execute if block ~ ~ ~ dropper{Items:[{Slot:4b,id:"minecraft:diamond_chestplate",tag:{modified:1}},{Slot:1b},{Slot:3b},{Slot:5b},{Slot:7b}]} run function mechanization:gadgets/machines/tinker_table/chestplate_upgrade
execute if block ~ ~ ~ dropper{Items:[{Slot:4b,id:"minecraft:diamond_leggings",tag:{modified:1}},{Slot:1b},{Slot:3b},{Slot:5b},{Slot:7b}]} run function mechanization:gadgets/machines/tinker_table/leggings_upgrade
execute if block ~ ~ ~ dropper{Items:[{Slot:4b,id:"minecraft:diamond_boots",tag:{modified:1}},{Slot:1b},{Slot:3b},{Slot:5b},{Slot:7b}]} run function mechanization:gadgets/machines/tinker_table/boots_upgrade
