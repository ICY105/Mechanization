...
execute if score temp_0 mech_data matches 1 store success block ~ ~ ~ Items[2].tag.AttributeModifiers[0].Amount double 6 if entity @s
execute if score temp_0 mech_data matches 2.. store success block ~ ~ ~ Items[2].tag.AttributeModifiers[0].Amount double 7 if entity @s
