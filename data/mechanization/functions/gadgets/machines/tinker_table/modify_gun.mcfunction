...
execute if block ~ ~ ~ barrel{Items:[{tag:{OreDict:["upgradeBouncy"]}}]} store success block ~ ~ ~ Items[{Slot:17b}].tag.mech_gun.bouncy int 1 if entity @s

scoreboard players set temp_0 mech_data 0
execute if block ~ ~ ~ barrel{Items:[{tag:{OreDict:["upgradeVerticalGrip"]}}]} run scoreboard players set temp_0 mech_data 1
execute if score temp_0 mech_data matches 1 store result score temp_1 mech_data run data get block ~ ~ ~ Items[{Slot:17b}].tag.mech_gun.recoil_x
execute if score temp_0 mech_data matches 1 run scoreboard players remove temp_1 mech_data 1
execute if score temp_0 mech_data matches 1 store result block ~ ~ ~ Items[{Slot:17b}].tag.mech_gun.recoil_x int 1 run scoreboard players get temp_1 mech_data

scoreboard players set temp_0 mech_data 0
execute if block ~ ~ ~ barrel{Items:[{tag:{OreDict:["upgradeAngledGrip"]}}]} run scoreboard players set temp_0 mech_data 1
execute if score temp_0 mech_data matches 1 store result score temp_1 mech_data run data get block ~ ~ ~ Items[{Slot:17b}].tag.mech_gun.recoil_y
execute if score temp_0 mech_data matches 1 run scoreboard players remove temp_1 mech_data 1
execute if score temp_0 mech_data matches 1 store result block ~ ~ ~ Items[{Slot:17b}].tag.mech_gun.recoil_y int 1 run scoreboard players get temp_1 mech_data

scoreboard players set temp_0 mech_data 0
execute if block ~ ~ ~ barrel{Items:[{tag:{OreDict:["upgradeCryoUnit"]}}]} run scoreboard players set temp_0 mech_data 1
execute if score temp_0 mech_data matches 1 store result score temp_1 mech_data run data get block ~ ~ ~ Items[{Slot:17b}].tag.mech_gun.heat
...
execute if score temp_0 mech_data matches 1 run scoreboard players operation temp_1 mech_data /= temp_2 mech_data
execute if score temp_0 mech_data matches 1 store result block ~ ~ ~ Items[{Slot:17b}].tag.mech_gun.heat int 1 run scoreboard players get temp_1 mech_data

scoreboard players set temp_0 mech_data 0
execute if block ~ ~ ~ barrel{Items:[{tag:{OreDict:["upgradePlasmaPump"]}}]} run scoreboard players set temp_0 mech_data 1
execute if score temp_0 mech_data matches 1 store result score temp_1 mech_data run data get block ~ ~ ~ Items[{Slot:17b}].tag.mech_gun.fire_rate
execute if score temp_0 mech_data matches 1 run scoreboard players set temp_2 mech_data 4
execute if score temp_0 mech_data matches 1 run scoreboard players operation temp_1 mech_data *= temp_2 mech_data
execute if score temp_0 mech_data matches 1 run scoreboard players set temp_2 mech_data 5
execute if score temp_0 mech_data matches 1 run scoreboard players operation temp_1 mech_data /= temp_2 mech_data
execute if score temp_0 mech_data matches 1 run scoreboard players add temp_1 mech_data 1
execute if score temp_0 mech_data matches 1 store result block ~ ~ ~ Items[{Slot:17b}].tag.mech_gun.fire_rate int 1 run scoreboard players get temp_1 mech_data

scoreboard players set temp_0 mech_data 0
execute if block ~ ~ ~ barrel{Items:[{tag:{OreDict:["upgradeFluidActuator"]}}]} run scoreboard players set temp_0 mech_data 1
execute if score temp_0 mech_data matches 1 store result score temp_1 mech_data run data get block ~ ~ ~ Items[{Slot:17b}].tag.mech_gun.velocity
execute if score temp_0 mech_data matches 1 run scoreboard players set temp_2 mech_data 5
execute if score temp_0 mech_data matches 1 run scoreboard players operation temp_1 mech_data *= temp_2 mech_data
execute if score temp_0 mech_data matches 1 run scoreboard players set temp_2 mech_data 4
execute if score temp_0 mech_data matches 1 run scoreboard players operation temp_1 mech_data /= temp_2 mech_data
execute if score temp_0 mech_data matches 1 store result block ~ ~ ~ Items[{Slot:17b}].tag.mech_gun.velocity int 1 run scoreboard players get temp_1 mech_data
...
execute if score temp_0 mech_data matches 1.. store result score temp_1 mech_data run data get block ~ ~ ~ Items[{Slot:17b}].tag.mech_gun.damage
...
execute if score temp_0 mech_data matches 1.. store result block ~ ~ ~ Items[{Slot:17b}].tag.mech_gun.damage int 1 run scoreboard players get temp_1 mech_data

#scoreboard players set temp_0 mech_data 0
#execute if block ~ ~ ~ barrel{Items:[{tag:{OreDict:["upgradeSight"]}}]} run scoreboard players set temp_0 mech_data 1
#execute if score temp_0 mech_data matches 1 store result score temp_1 mech_data run data get block ~ ~ ~ Items[{Slot:17b}].tag.Damage
...
#execute if score temp_0 mech_data matches 1 store result block ~ ~ ~ Items[{Slot:17b}].tag.Damage int 1 run scoreboard players get temp_1 mech_data
