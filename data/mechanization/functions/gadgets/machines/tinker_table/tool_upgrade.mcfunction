...
execute if block ~ ~ ~ dropper{Items:[{Slot:4b,id:"minecraft:diamond_pickaxe"}]} run replaceitem block ~ ~ ~ container.4 diamond_pickaxe{mech_itemid: 4200, mech_upgrades:{empowered:0,autosmelt:0,magnetic:0,trash:0,smash:0},modified:2,display:{Lore:["§7Modified"],Name:"{\"text\":\"Titanium Pickaxe\",\"color\":\"light_purple\",\"italic\":false}"}}
execute if block ~ ~ ~ dropper{Items:[{Slot:4b,id:"minecraft:diamond_axe"}]} run replaceitem block ~ ~ ~ container.4 diamond_axe{mech_itemid: 4201, mech_upgrades:{empowered:0,autosmelt:0,magnetic:0,trash:0,smash:0},modified:2,display:{Lore:["§7Modified"],Name:"{\"text\":\"Titanium Axe\",\"color\":\"light_purple\",\"italic\":false}"}}
execute if block ~ ~ ~ dropper{Items:[{Slot:4b,id:"minecraft:diamond_shovel"}]} run replaceitem block ~ ~ ~ container.4 diamond_shovel{mech_itemid: 4202, mech_upgrades:{empowered:0,autosmelt:0,magnetic:0,trash:0,smash:0},modified:2,display:{Lore:["§7Modified"],Name:"{\"text\":\"Titanium Shovel\",\"color\":\"light_purple\",\"italic\":false}"}}
