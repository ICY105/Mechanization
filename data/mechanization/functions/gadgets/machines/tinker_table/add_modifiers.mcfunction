...
execute if data storage du:temp list[0].tag{mech_itemid:4209} run scoreboard players add $temp_0 mech_data 32000
execute if data storage du:temp list[1].tag{mech_itemid:4209} run scoreboard players add $temp_0 mech_data 32000
execute if data storage du:temp list[2].tag{mech_itemid:4209} run scoreboard players add $temp_0 mech_data 32000
execute if data storage du:temp list[3].tag{mech_itemid:4209} run scoreboard players add $temp_0 mech_data 32000
execute if data storage du:temp list[4].tag{mech_itemid:4209} run scoreboard players add $temp_0 mech_data 32000
execute if data storage du:temp list[5].tag{mech_itemid:4209} run scoreboard players add $temp_0 mech_data 32000
...
execute if data block ~ ~ ~ Items[{tag:{mech_itemid:4209}}] run data modify storage du:temp obj.tag.display.Lore append value '[{"translate":"mech.item.portable_battery.lore","color":"gray","italic":false,"with":[{"text":"0"},{"text":"0"}]}]'
