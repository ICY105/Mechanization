...
execute store result entity @s HandItems[0].tag.mech_battery.energy int 1 run scoreboard players get temp_0 mech_data
...
execute unless data entity @s HandItems[0].tag.display.Lore[0] run data modify entity @s HandItems[0].tag.display.Lore set value ['{"text":""}']
data modify entity @s HandItems[0].tag.display.Lore[0] set from block -29999999 0 1602 Text1
...
execute if score temp_2 mech_data matches 1.. store result entity @s HandItems[0].tag.CustomModelData int 1 run scoreboard players get temp_3 mech_data
