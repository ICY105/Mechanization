...
execute positioned ~ ~-1 ~ as @e[type=#mechanization:living,tag=!smithed.ignore,distance=..1,tag=!smithed.strict,nbt={DeathTime:0s}] store success score #success mechanization.data run function mechanization:base/utils/damage_entity
