...
execute if score #range mechanization.data matches 1.. run summon minecraft:armor_stand ~ ~1 ~ {Tags:["mechanization.energy_saber","mechanization.new"],NoGravity:1b,Silent:1b,Invulnerable:1b,Marker:1b,Invisible:1b,NoBasePlate:1b,DisabledSlots:4144959,Pose:{Head:[0f,1f,0f]},CustomName:'{"translate":"mech.item.energy_saber"}'}
