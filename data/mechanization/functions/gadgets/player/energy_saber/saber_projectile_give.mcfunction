...
# give item to player
execute as @a[sort=nearest,limit=1,distance=..1,predicate=mechanization:is_player,gamemode=!creative] if data entity @s SelectedItem run loot give @s mine -30000000 0 3201 minecraft:air{drop_contents:true}
