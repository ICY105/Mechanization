...
execute if score @s mechanization.item_id matches 4 if data entity @s SelectedItem.tag.mechanization{id:"epac"} if score @s mechanization.time matches 1.. if score @s mechanization.weaponheat matches ..1000 run function mechanization:gadgets/player/firearms/recoil
