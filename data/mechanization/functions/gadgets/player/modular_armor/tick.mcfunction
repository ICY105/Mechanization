...
execute if data entity @s Inventory[{Slot:103b}].tag.mechanization.upgrades{type:3b} run function mechanization:gadgets/player/modular_armor/helmet
execute if data entity @s Inventory[{Slot:102b}].tag.mechanization.upgrades{type:3b} run function mechanization:gadgets/player/modular_armor/chestplate
execute if data entity @s Inventory[{Slot:101b}].tag.mechanization.upgrades{type:3b} run function mechanization:gadgets/player/modular_armor/leggings
execute if data entity @s Inventory[{Slot:100b}].tag.mechanization.upgrades{type:3b} run function mechanization:gadgets/player/modular_armor/boots
