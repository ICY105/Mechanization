...
execute if data storage mechanization:temp list[].tag.mechanization.upgrade{effect:"repair"} run scoreboard players set #reinforced mechanization.data 2

execute if score #reinforced mechanization.data matches 1..2 store result score $temp_4 mechanization.data run data get storage mechanization:temp list
execute if score #reinforced mechanization.data matches 1..2 run scoreboard players operation $temp_4 mechanization.data *= #damage mechanization.data
...
execute if score #reinforced mechanization.data matches 1 if data storage mechanization:temp list[5].tag.mechanization.upgrade{effect:"reinforced"} run scoreboard players operation #max_durability mechanization.data -= $temp_4 mechanization.data
execute if score #reinforced mechanization.data matches 2 if data storage mechanization:temp list[5].tag.mechanization.upgrade{effect:"repair"} run scoreboard players operation #max_durability mechanization.data -= $temp_4 mechanization.data
execute if score #reinforced mechanization.data matches 2 unless data storage mechanization:temp list[5].tag.mechanization.upgrade{effect:"repair"} if score #max_durability mechanization.data < #durability mechanization.data run scoreboard players operation #max_durability mechanization.data += #damage mechanization.data
...
execute if score #durability mechanization.data matches 1.. run data modify block -30000000 0 3202 Text1 set value '{"translate":"item.durability","color":"gray","italic":false,"with":[{"score":{"name":"#max_durability","objective":"mechanization.data"}},{"score":{"name":"#durability","objective":"mechanization.data"}}]}'
execute if score #durability mechanization.data matches 1.. run data modify storage mechanization:temp list[5].tag.display.Lore[1] set from block -30000000 0 3202 Text1
...
execute if score #reinforced mechanization.data matches 0 run scoreboard players operation #max_durability mechanization.data -= #damage mechanization.data
execute if score #reinforced mechanization.data matches 1 if data storage mechanization:temp list[4].tag.mechanization.upgrade{effect:"reinforced"} run scoreboard players operation #max_durability mechanization.data -= $temp_4 mechanization.data
execute if score #reinforced mechanization.data matches 2 if data storage mechanization:temp list[4].tag.mechanization.upgrade{effect:"repair"} run scoreboard players operation #max_durability mechanization.data -= $temp_4 mechanization.data
execute if score #reinforced mechanization.data matches 2 unless data storage mechanization:temp list[4].tag.mechanization.upgrade{effect:"repair"} if score #max_durability mechanization.data < #durability mechanization.data run scoreboard players operation #max_durability mechanization.data += #damage mechanization.data
...
execute if score #durability mechanization.data matches 1.. run data modify block -30000000 0 3202 Text1 set value '{"translate":"item.durability","color":"gray","italic":false,"with":[{"score":{"name":"#max_durability","objective":"mechanization.data"}},{"score":{"name":"#durability","objective":"mechanization.data"}}]}'
execute if score #durability mechanization.data matches 1.. run data modify storage mechanization:temp list[4].tag.display.Lore[1] set from block -30000000 0 3202 Text1
execute if score #durability mechanization.data matches 1.. if score #max_durability mechanization.data matches ..0 run scoreboard players set #broken mechanization.data 1
...
execute if score #reinforced mechanization.data matches 0 run scoreboard players operation #max_durability mechanization.data -= #damage mechanization.data
execute if score #reinforced mechanization.data matches 1 if data storage mechanization:temp list[3].tag.mechanization.upgrade{effect:"reinforced"} run scoreboard players operation #max_durability mechanization.data -= $temp_4 mechanization.data
execute if score #reinforced mechanization.data matches 2 if data storage mechanization:temp list[3].tag.mechanization.upgrade{effect:"repair"} run scoreboard players operation #max_durability mechanization.data -= $temp_4 mechanization.data
execute if score #reinforced mechanization.data matches 2 unless data storage mechanization:temp list[3].tag.mechanization.upgrade{effect:"repair"} if score #max_durability mechanization.data < #durability mechanization.data run scoreboard players operation #max_durability mechanization.data += #damage mechanization.data
...
execute if score #durability mechanization.data matches 1.. run data modify block -30000000 0 3202 Text1 set value '{"translate":"item.durability","color":"gray","italic":false,"with":[{"score":{"name":"#max_durability","objective":"mechanization.data"}},{"score":{"name":"#durability","objective":"mechanization.data"}}]}'
execute if score #durability mechanization.data matches 1.. run data modify storage mechanization:temp list[3].tag.display.Lore[1] set from block -30000000 0 3202 Text1
execute if score #durability mechanization.data matches 1.. if score #max_durability mechanization.data matches ..0 run scoreboard players set #broken mechanization.data 1
...
execute if score #reinforced mechanization.data matches 0 run scoreboard players operation #max_durability mechanization.data -= #damage mechanization.data
execute if score #reinforced mechanization.data matches 1 if data storage mechanization:temp list[2].tag.mechanization.upgrade{effect:"reinforced"} run scoreboard players operation #max_durability mechanization.data -= $temp_4 mechanization.data
execute if score #reinforced mechanization.data matches 2 if data storage mechanization:temp list[2].tag.mechanization.upgrade{effect:"repair"} run scoreboard players operation #max_durability mechanization.data -= $temp_4 mechanization.data
execute if score #reinforced mechanization.data matches 2 unless data storage mechanization:temp list[2].tag.mechanization.upgrade{effect:"repair"} if score #max_durability mechanization.data < #durability mechanization.data run scoreboard players operation #max_durability mechanization.data += #damage mechanization.data
...
execute if score #durability mechanization.data matches 1.. run data modify block -30000000 0 3202 Text1 set value '{"translate":"item.durability","color":"gray","italic":false,"with":[{"score":{"name":"#max_durability","objective":"mechanization.data"}},{"score":{"name":"#durability","objective":"mechanization.data"}}]}'
execute if score #durability mechanization.data matches 1.. run data modify storage mechanization:temp list[2].tag.display.Lore[1] set from block -30000000 0 3202 Text1
execute if score #durability mechanization.data matches 1.. if score #max_durability mechanization.data matches ..0 run scoreboard players set #broken mechanization.data 1
...
execute if score #reinforced mechanization.data matches 0 run scoreboard players operation #max_durability mechanization.data -= #damage mechanization.data
execute if score #reinforced mechanization.data matches 1 if data storage mechanization:temp list[1].tag.mechanization.upgrade{effect:"reinforced"} run scoreboard players operation #max_durability mechanization.data -= $temp_4 mechanization.data
execute if score #reinforced mechanization.data matches 2 if data storage mechanization:temp list[1].tag.mechanization.upgrade{effect:"repair"} run scoreboard players operation #max_durability mechanization.data -= $temp_4 mechanization.data
...
execute if score #durability mechanization.data matches 1.. run data modify block -30000000 0 3202 Text1 set value '{"translate":"item.durability","color":"gray","italic":false,"with":[{"score":{"name":"#max_durability","objective":"mechanization.data"}},{"score":{"name":"#durability","objective":"mechanization.data"}}]}'
execute if score #durability mechanization.data matches 1.. run data modify storage mechanization:temp list[1].tag.display.Lore[1] set from block -30000000 0 3202 Text1
execute if score #durability mechanization.data matches 1.. if score #max_durability mechanization.data matches ..0 run scoreboard players set #broken mechanization.data 1
...
execute if score #reinforced mechanization.data matches 0 run scoreboard players operation #max_durability mechanization.data -= #damage mechanization.data
execute if score #reinforced mechanization.data matches 1 if data storage mechanization:temp list[0].tag.mechanization.upgrade{effect:"reinforced"} run scoreboard players operation #max_durability mechanization.data -= $temp_4 mechanization.data
execute if score #reinforced mechanization.data matches 2 if data storage mechanization:temp list[0].tag.mechanization.upgrade{effect:"repair"} run scoreboard players operation #max_durability mechanization.data -= $temp_4 mechanization.data
...
execute if score #durability mechanization.data matches 1.. run data modify block -30000000 0 3202 Text1 set value '{"translate":"item.durability","color":"gray","italic":false,"with":[{"score":{"name":"#max_durability","objective":"mechanization.data"}},{"score":{"name":"#durability","objective":"mechanization.data"}}]}'
execute if score #durability mechanization.data matches 1.. run data modify storage mechanization:temp list[0].tag.display.Lore[1] set from block -30000000 0 3202 Text1
execute if score #durability mechanization.data matches 1.. if score #max_durability mechanization.data matches ..0 run scoreboard players set #broken mechanization.data 1
...
execute if score #broken mechanization.data matches 1 run function mechanization:gadgets/machines/tinker_table/add_modifiers
