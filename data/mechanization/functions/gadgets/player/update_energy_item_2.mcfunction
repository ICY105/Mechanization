...
execute if score #max_storage mechanization.data matches 1.. run data modify storage energy:temp list[0].tag.display.Lore[0] set from block -30000000 0 3202 front_text.messages[0]
