...
scoreboard players add $temp_0 mech_data 20
...
scoreboard players remove @s[tag=!mech_invert] mech_data 1
execute if score @s[tag=!mech_invert] mech_data matches 0 run tag @s add mech_invert
