...
#shield cap
scoreboard players set $in_1 mech_data 0
...
#shield
execute if score $base.timer_100 du_data matches 0 if score $in_1 mech_data matches 1.. run function mechanization:gadgets/tools/modular_armor/shield
execute if score $base.timer_100 du_data matches 49 if score $in_1 mech_data matches 1.. run function mechanization:gadgets/tools/modular_armor/shield
