...
execute positioned ~ ~-1 ~ as @e[type=#du:living,type=!villager,distance=..1,nbt={DeathTime:0s}] store success score temp_0 mech_data run function mechanization:gadgets/tools/firearms/bullet/end_entity 
