...
execute if score in_0 mech_data matches 1..4 run function mechanization:gadgets/tools/firearms/bullet/bounce_x
execute if score in_0 mech_data matches 5..6 run function mechanization:gadgets/tools/firearms/bullet/bounce_y
