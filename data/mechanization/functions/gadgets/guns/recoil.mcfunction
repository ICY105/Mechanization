...
execute if score out_0 du_data matches -8 run tp @s ~ ~ ~ ~-4.0 ~
execute if score out_0 du_data matches -7 run tp @s ~ ~ ~ ~-3.5 ~
execute if score out_0 du_data matches -6 run tp @s ~ ~ ~ ~-3.0 ~
execute if score out_0 du_data matches -5 run tp @s ~ ~ ~ ~-2.5 ~
execute if score out_0 du_data matches -4 run tp @s ~ ~ ~ ~-2.0 ~
execute if score out_0 du_data matches -3 run tp @s ~ ~ ~ ~-1.5 ~
execute if score out_0 du_data matches -2 run tp @s ~ ~ ~ ~-1.0 ~
execute if score out_0 du_data matches -1 run tp @s ~ ~ ~ ~-0.5 ~
