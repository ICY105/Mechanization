...
execute positioned ~ ~-1 ~ store success score temp_0 mech_data at @e[type=!armor_stand,type=!villager,distance=..1,nbt={DeathTime:0s},sort=nearest,limit=1] run summon arrow ~ ~-0.5 ~ {Tags:["mech_bullet_arrow","mech_new_bullet_arrow",],Motion:[0.0,0.25,0.0],pickup:2,damage:1,Color:-1}
