...
execute if score $install mech_data matches -2 run tellraw @a [{"text":"Error: Mechanization requires Datapack Utilities version +2.3.1. You can download that [here].","color":"red","clickEvent":{"action":"open_url","value":"https://github.com/ImCoolYeah105/Datapack-Utilities/releases"}}]
