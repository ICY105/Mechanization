...
execute if score timer_20 du_data matches 11 as @e[tag=mech_block_breaker] at @s run function mechanization:machines/machines/block_breaker/block_breaker
execute if score timer_20 du_data matches 12 as @e[tag=mech_teleporter] at @s run function mechanization:machines/machines/teleporter/teleporter
execute if score timer_20 du_data matches 13 as @e[tag=mech_reformer] at @s run function mechanization:machines/machines/reformer/reformer
...
execute if score timer_20 du_data matches 15 as @e[tag=mech_dim_generator] at @s run function mechanization:machines/machines/dim_gen/dim_gen
...
execute if score timer_20 du_data matches 17 as @e[tag=mech_quarry] at @s run function mechanization:machines/machines/quarry/quarry
...
execute if score timer_2 du_data matches 0 as @e[tag=mech_super_sticky_piston] at @s run function mechanization:machines/machines/super_piston/super_piston
...
execute if score timer_100 du_data matches 50 as @e[tag=mech_lava_fabricator] at @s run function mechanization:machines/machines/lava_fabricator
execute if score timer_100 du_data matches 60 as @e[tag=mech_growth_accelerator] at @s run function mechanization:machines/machines/growth_accelerator/growth_accelerator
execute if score timer_100 du_data matches 70 as @e[tag=mech_fisher] at @s run function mechanization:machines/machines/fisher/fisher
execute if score timer_100 du_data matches 80 as @e[tag=mech_spawner_controller] at @s run function mechanization:machines/machines/spawner_controller
