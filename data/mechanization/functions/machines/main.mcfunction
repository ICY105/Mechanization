...
execute if score $base.timer_20 du_data matches 11 as @e[tag=mech_block_breaker] at @s run function mechanization:machines/machines/block_breaker/block_breaker
execute if score $base.timer_20 du_data matches 12 as @e[tag=mech_teleporter] at @s run function mechanization:machines/machines/teleporter/teleporter
execute if score $base.timer_20 du_data matches 13 as @e[tag=mech_reformer] at @s run function mechanization:machines/machines/reformer/reformer
execute if score $base.timer_20 du_data matches 14 as @e[tag=mech_disenchanter] at @s run function mechanization:machines/machines/disenchanter/disenchanter
