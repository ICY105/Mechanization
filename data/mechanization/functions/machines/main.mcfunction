...
execute if score #timer.20 mechanization.data matches 10 as @e[type=minecraft:item_display,tag=mechanization.liquid_tank] at @s run function mechanization:machines/blocks/fluid_tank/liquid_tank
