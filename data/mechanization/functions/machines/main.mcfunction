...
execute if score $base.timer_20 du_data matches 9 as @e[tag=mech_disenchanter] at @s run function mechanization:machines/machines/disenchanter/disenchanter
