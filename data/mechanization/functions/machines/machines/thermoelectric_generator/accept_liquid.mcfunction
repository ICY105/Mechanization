...
execute unless score @s mech_fluid matches 1.. run data modify entity @s Item.tag.tank_1 set from storage du:temp obj
...
execute unless score @s du_data matches 1.. run data modify entity @s Item.tag.tank_2 set from storage du:temp obj
