...
execute store result score $temp_6 mechanization.data run data get storage du:temp obj.tag.ctc.traits.liquid.temperature
...
execute if score $temp_4 mechanization.data matches 0 if score $out_0 mechanization.data matches 1.. run data modify entity @s Item.tag.tank_1 set from storage du:temp obj

#tank 2
data modify storage du:temp var set from entity @s Item.tag.tank_2.tag.ctc.traits.liquid.id
execute store success score $temp_4 mechanization.data run data modify storage du:temp var set from storage du:temp obj.tag.ctc.traits.liquid.id

execute unless score @s du_data matches 1.. run scoreboard players set $temp_4 mechanization.data 0
...
execute if score $temp_4 mechanization.data matches 0 if score $out_0 mechanization.data matches 1.. run data modify entity @s Item.tag.tank_2 set from storage du:temp obj
