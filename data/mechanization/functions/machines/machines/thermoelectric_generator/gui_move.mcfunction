...
execute if score $temp_0 mechanization.data matches 0 unless data block ~ ~ ~ Items[{Slot:1b}] run scoreboard players set $temp_0 mechanization.data 1
execute if score $temp_0 mechanization.data matches 0 unless data block ~ ~ ~ Items[{Slot:6b}] run scoreboard players set $temp_0 mechanization.data 6
