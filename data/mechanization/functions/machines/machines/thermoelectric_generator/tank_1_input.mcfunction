...
execute if data block ~ ~ ~ Items[{Slot:1b}].tag.ctc.traits.liquid.temperature store result score $temp_1 mech_data run data get block ~ ~ ~ Items[{Slot:1b}].tag.ctc.traits.liquid.temperature

scoreboard players set $in_0 mech_data -1
execute unless score @s mech_fluid matches 1.. if score $temp_1 mech_data matches ..99 run scoreboard players set $in_0 mech_data 0
execute if score @s mech_fluid matches 1.. if score $temp_1 mech_data matches ..99 run data modify storage du:test var set from entity @s Item.tag.tank_1.tag.ctc.traits.liquid.id
execute if score @s mech_fluid matches 1.. if score $temp_1 mech_data matches ..99 store success score $temp_0 mech_data run data modify storage du:test var set from block ~ ~ ~ Items[{Slot:1b}].tag.ctc.traits.liquid.id
execute if score @s mech_fluid matches 1.. if score $temp_1 mech_data matches ..99 if score $temp_0 mech_data matches 0 run scoreboard players set $in_0 mech_data 0

execute unless score @s mech_fluid matches 1.. if data block ~ ~ ~ Items[{Slot:1b,id:"minecraft:water_bucket"}] run scoreboard players set $in_0 mech_data 0
execute if score @s mech_fluid matches 1.. if data block ~ ~ ~ Items[{Slot:1b,id:"minecraft:water_bucket"}] if data entity @s Item.tag.tank.tag.ctc.traits.liquid{id:"water"} run scoreboard players set $in_0 mech_data 0
execute unless score @s mech_fluid matches 1.. if data block ~ ~ ~ Items[{Slot:1b,id:"minecraft:potion",tag:{Potion:"minecraft:water"}}] run scoreboard players set $in_0 mech_data 0
execute if score @s mech_fluid matches 1.. if data block ~ ~ ~ Items[{Slot:1b,id:"minecraft:potion",tag:{Potion:"minecraft:water"}}] if data entity @s Item.tag.tank.tag.ctc.traits.liquid{id:"water"} run scoreboard players set $in_0 mech_data 0
execute unless score @s mech_fluid matches 1.. if data block ~ ~ ~ Items[{Slot:1b,id:"minecraft:powder_snow_bucket"}] run scoreboard players set $in_0 mech_data 0
execute if score @s mech_fluid matches 1.. if data block ~ ~ ~ Items[{Slot:1b,id:"minecraft:powder_snow_bucket"}] if data entity @s Item.tag.tank.tag.ctc.traits.liquid{id:"powder_snow"} run scoreboard players set $in_0 mech_data 0
