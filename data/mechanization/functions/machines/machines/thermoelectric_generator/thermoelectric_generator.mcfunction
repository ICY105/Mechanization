...
execute if score @s mech_fluid matches 25.. if score @s du_data matches 25.. run tag @s add mech_active
execute if score @s[tag=mech_upgrade_nether] mech_fluid matches 25.. run tag @s add mech_active
execute if score @s[tag=mech_upgrade_ender] du_data matches 25.. run tag @s add mech_active
...
execute if score @s[tag=mech_active,tag=mech_upgrade_nether] du_data matches ..24 run scoreboard players set $temp_0 mech_data 500
execute if score @s[tag=mech_active,tag=mech_upgrade_ender] mech_fluid matches ..24 run scoreboard players set $temp_0 mech_data 0
scoreboard players remove $temp_1 mech_data 100
...
execute if entity @s[tag=mech_active] if score @s mech_fluid matches 25.. run scoreboard players remove @s mech_fluid 25
execute if entity @s[tag=mech_active] if score @s du_data matches 25.. run scoreboard players remove @s du_data 25
