...
execute if score temp_0 mech_data matches 1 if entity @s[scores={mech_power=20..},tag=mech_upgraded,tag=!mech_upgrade_ender,tag=!mech_upgrade_nether] run data merge block ~ ~ ~ {BurnTime:200,CookTimeTotal:150}
execute if score temp_0 mech_data matches 1 if entity @s[scores={mech_power=20..},tag=mech_upgrade_ender] run data merge block ~ ~ ~ {BurnTime:200,CookTimeTotal:100}
execute if score temp_0 mech_data matches 1 if entity @s[scores={mech_power=200..},tag=mech_upgrade_nether] run data merge block ~ ~ ~ {BurnTime:200,CookTime:1,CookTimeTotal:19}
...
#display
execute if score temp_0 mech_data matches 1 if entity @s[scores={mech_power=20..},tag=!mech_upgrade_nether] if block ~ ~ ~ furnace[lit=false] run function mechanization:base/utils/set_furnace_lit
execute if score temp_0 mech_data matches 1 if entity @s[scores={mech_power=200..},tag=mech_upgrade_nether] if block ~ ~ ~ furnace[lit=false] run function mechanization:base/utils/set_furnace_lit
