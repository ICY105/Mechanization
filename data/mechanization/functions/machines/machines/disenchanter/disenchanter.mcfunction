...
execute unless block ~ ~ ~ dropper{Items:[{Slot:7b}]} run item replace block ~ ~ ~ container.7 with minecraft:structure_block{CustomModelData:6422205,du_gui:1b,HideFlags:63,display:{Name:"\"\""}}
...
#cleanup
execute unless block ~ ~ ~ dropper run function mechanization:base/utils/break_machine_t3
