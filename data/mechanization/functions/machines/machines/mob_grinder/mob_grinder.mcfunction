...
#spawn loot
execute if score $world.out_0 du_data matches 0 if score @s mech_power >= $machines.cf.mob_grinder.power mech_data if entity @s[tag=!mech_upgrade_ender] as @e[distance=..5,type=#mechanization:mob_grinder,tag=!global.ignore.kill,tag=!global.ignore,tag=!smithed.ignore,tag=!smithed.strict] run loot spawn ~ ~1 ~ kill @s
execute if score $world.out_0 du_data matches 0 if score @s mech_power >= $machines.cf.mob_grinder.power mech_data if entity @s[tag=mech_upgrade_nether] as @e[distance=..5,type=#mechanization:mob_grinder,tag=!global.ignore.kill,tag=!global.ignore,tag=!smithed.ignore,tag=!smithed.strict] run loot spawn ~ ~1 ~ kill @s
...
#kill entities
execute if score $world.out_0 du_data matches 0 if score @s mech_power >= $machines.cf.mob_grinder.power mech_data store result score $temp_0 mech_data run tp @e[distance=..5,type=#mechanization:mob_grinder,tag=!global.ignore.kill,tag=!global.ignore,tag=!smithed.ignore,tag=!smithed.strict] ~ -300 ~
