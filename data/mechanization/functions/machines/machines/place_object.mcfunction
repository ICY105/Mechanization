...
#Electric Furnace
execute if score @s mech_data matches 2003 if entity @s[tag=mech_rot_0] run summon armor_stand ~ ~ ~ {Tags:["mech_ele_furnace","mech_reciever","mech_rotatable","du_furnace"],Marker:1b,Invisible:1,Invulnerable:1,NoGravity:1,DisabledSlots:2039583,Rotation:[0.01f,0.0f],Fire:32676,ArmorItems:[{},{},{},{id:diamond_shovel,Count:1b,tag:{mech_power:0,mech_gridid:0,mech_data:0,Unbreakable:1,Damage:46}}]}
execute if score @s mech_data matches 2003 if entity @s[tag=mech_rot_1] run summon armor_stand ~ ~ ~ {Tags:["mech_ele_furnace","mech_reciever","mech_rotatable","du_furnace"],Marker:1b,Invisible:1,Invulnerable:1,NoGravity:1,DisabledSlots:2039583,Rotation:[90f,0.0f],Fire:32676,ArmorItems:[{},{},{},{id:diamond_shovel,Count:1b,tag:{mech_power:0,mech_gridid:0,mech_data:0,Unbreakable:1,Damage:46}}]}
execute if score @s mech_data matches 2003 if entity @s[tag=mech_rot_2] run summon armor_stand ~ ~ ~ {Tags:["mech_ele_furnace","mech_reciever","mech_rotatable","du_furnace"],Marker:1b,Invisible:1,Invulnerable:1,NoGravity:1,DisabledSlots:2039583,Rotation:[180f,0.0f],Fire:32676,ArmorItems:[{},{},{},{id:diamond_shovel,Count:1b,tag:{mech_power:0,mech_gridid:0,mech_data:0,Unbreakable:1,Damage:46}}]}
execute if score @s mech_data matches 2003 if entity @s[tag=mech_rot_3] run summon armor_stand ~ ~ ~ {Tags:["mech_ele_furnace","mech_reciever","mech_rotatable","du_furnace"],Marker:1b,Invisible:1,Invulnerable:1,NoGravity:1,DisabledSlots:2039583,Rotation:[270f,0.0f],Fire:32676,ArmorItems:[{},{},{},{id:diamond_shovel,Count:1b,tag:{mech_power:0,mech_gridid:0,mech_data:0,Unbreakable:1,Damage:46}}]}
