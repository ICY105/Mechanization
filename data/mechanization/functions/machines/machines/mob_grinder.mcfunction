...
execute if entity @s[tag=!mech_upgraded,scores={mech_power=160..}] store result score temp_0 mech_data run kill @e[distance=..5,nbt={DeathTime:0s},type=!player,type=!armor_stand,type=!wither,type=!ender_dragon,type=!villager,tag=!du_click_entity]
