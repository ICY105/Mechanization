...
execute if score temp_0 mech_data matches 120.. run loot spawn ~ ~-1 ~ fish minecraft:gameplay/fishing ~ ~1 ~ minecraft:fishing_rod{Enchantments:[{lvl:3,id:"minecraft:luck_of_the_sea"}]}
