...
execute store result score temp_0 mech_data in minecraft:overworld run data get block -29999999 0 1600 RecordItem.tag.mech.temp[0].dimension
execute store result score temp_1 mech_data in minecraft:overworld run data get block -29999999 0 1600 RecordItem.tag.mech.temp[0].uuid

execute in minecraft:overworld run data modify entity @s CustomName set from block -29999999 0 1600 RecordItem.tag.mech.temp[0].Name
