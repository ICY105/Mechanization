...
execute if score @s du_data matches 6 store result score temp_0 mech_data run data get storage du:temp obj.valid
execute if score @s du_data matches 6 if score temp_0 mech_data matches 0 run title @a[distance=..0.5] actionbar [{"translate":"mech.block.teleporter.no_destination","color":"green"}] 
