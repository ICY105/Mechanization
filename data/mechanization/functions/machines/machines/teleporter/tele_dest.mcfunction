...
execute if score @s du_data matches 6 run data modify storage du:temp list set from storage mechanization:networks teleporter
execute if score @s du_data matches 6 run function mechanization:machines/machines/teleporter/tele_dest_2

execute if score @s du_data matches 6 store result score temp_0 mech_data run data get storage du:temp list
