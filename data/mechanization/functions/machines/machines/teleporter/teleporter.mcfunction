...
execute if entity @s[tag=!mech_init,scores={du_uuid=0}] run function mechanization:machines/machines/teleporter/init
...
#cleanup
execute unless block ~ ~ ~ barrier run function mechanization:machines/machines/teleporter/remove
