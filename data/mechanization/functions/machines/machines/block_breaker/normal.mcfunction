...
execute if score temp_0 du_data matches 0..1 if entity @s[tag=mech_upgraded,tag=mech_upgrade_ender,scores={mech_power=24..}] run loot spawn ~ ~ ~ mine ~ ~ ~ diamond_pickaxe{Enchantments:[{lvl:1,id:"minecraft:silk_touch"}]}
