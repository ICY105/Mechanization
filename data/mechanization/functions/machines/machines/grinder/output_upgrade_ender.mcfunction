...
#vanilla ores
execute if score out_0 mech_data matches 1 if block ~ ~ ~ furnace{Items:[{Slot:0b,id:"minecraft:coal_ore"}]} run item replace block ~ ~ ~ container.2 with coal 3
...
execute if score out_0 mech_data matches 1 if block ~ ~ ~ furnace{Items:[{Slot:0b,id:"minecraft:lapis_ore"}]} run item replace block ~ ~ ~ container.2 with lapis_lazuli 8
execute if score out_0 mech_data matches 1 if block ~ ~ ~ furnace{Items:[{Slot:0b,id:"minecraft:diamond_ore"}]} run item replace block ~ ~ ~ container.2 with diamond 3
execute if score out_0 mech_data matches 1 if block ~ ~ ~ furnace{Items:[{Slot:0b,id:"minecraft:redstone_ore"}]} run item replace block ~ ~ ~ container.2 with redstone 8
execute if score out_0 mech_data matches 1 if block ~ ~ ~ furnace{Items:[{Slot:0b,id:"minecraft:emerald_ore"}]} run item replace block ~ ~ ~ container.2 with emerald 3
execute if score out_0 mech_data matches 1 if block ~ ~ ~ furnace{Items:[{Slot:0b,id:"minecraft:nether_quartz_ore"}]} run item replace block ~ ~ ~ container.2 with quartz 8
...
execute if score out_0 mech_data matches 1 if block ~ ~ ~ furnace{Items:[{Slot:0b,tag:{OreDict:["oreTin"]}}]} run item replace block ~ ~ ~ container.2 with structure_block{		mech_itemid: 1313, CustomModelData: 6421313, du_smelt_id: 1313, OreDict:["dustTin"], 		display: {Name: "{\"italic\":false,\"color\":\"gray\",\"translate\":\"mech.resource.dust\",\"with\":[{\"translate\":\"mech.resource.tin\"}]}"},HideFlags: 32				} 3
execute if score out_0 mech_data matches 1 if block ~ ~ ~ furnace{Items:[{Slot:0b,tag:{OreDict:["oreTitanium"]}}]} run item replace block ~ ~ ~ container.2 with structure_block{	mech_itemid: 1323, CustomModelData: 6421323, du_smelt_id: 1323, OreDict:["dustTitanium"], 	display: {Name: "{\"italic\":false,\"color\":\"light_purple\",\"translate\":\"mech.resource.dust\",\"with\":[{\"translate\":\"mech.resource.titanium\"}]}"},HideFlags: 32	} 3
...
#Logs
execute if score out_0 mech_data matches 1 if block ~ ~ ~ furnace{Items:[{Slot:0b,id:"minecraft:oak_log"}]} run item replace block ~ ~ ~ container.2 with oak_planks 8
execute if score out_0 mech_data matches 1 if block ~ ~ ~ furnace{Items:[{Slot:0b,id:"minecraft:birch_log"}]} run item replace block ~ ~ ~ container.2 with birch_planks 8
execute if score out_0 mech_data matches 1 if block ~ ~ ~ furnace{Items:[{Slot:0b,id:"minecraft:spruce_log"}]} run item replace block ~ ~ ~ container.2 with spruce_planks 8
execute if score out_0 mech_data matches 1 if block ~ ~ ~ furnace{Items:[{Slot:0b,id:"minecraft:jungle_log"}]} run item replace block ~ ~ ~ container.2 with jungle_planks 8
execute if score out_0 mech_data matches 1 if block ~ ~ ~ furnace{Items:[{Slot:0b,id:"minecraft:dark_oak_log"}]} run item replace block ~ ~ ~ container.2 with dark_oak_planks 8
execute if score out_0 mech_data matches 1 if block ~ ~ ~ furnace{Items:[{Slot:0b,id:"minecraft:acacia_log"}]} run item replace block ~ ~ ~ container.2 with acacia_planks 8
...
execute if score out_0 mech_data matches 1 if block ~ ~ ~ furnace{Items:[{Slot:0b,id:"minecraft:gravel"}]} run item replace block ~ ~ ~ container.2 with flint 2
execute if score out_0 mech_data matches 1 if block ~ ~ ~ furnace{Items:[{Slot:0b,id:"minecraft:blaze_rod"}]} run item replace block ~ ~ ~ container.2 with blaze_powder 4
execute if score out_0 mech_data matches 1 if block ~ ~ ~ furnace{Items:[{Slot:0b,id:"minecraft:bone"}]} run item replace block ~ ~ ~ container.2 with bone_meal 5
