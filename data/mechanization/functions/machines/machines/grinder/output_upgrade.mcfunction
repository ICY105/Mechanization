...
execute if score out_0 mech_data matches 1 if block ~ ~ ~ furnace{Items:[{Slot:0b,tag:{OreDict:["oreTin"]}}]} run replaceitem block ~ ~ ~ container.2 structure_block{		mech_itemid: 1313, CustomModelData: 6421313, du_smelt_id: 1313, OreDict:["dustTin"], 		display: {Name: "{\"italic\":false,\"color\":\"gray\",\"translate\":\"mech.resource.dust\",\"with\":[{\"translate\":\"mech.resource.tin\"}]}"},HideFlags: 32				} 2
execute if score out_0 mech_data matches 1 if block ~ ~ ~ furnace{Items:[{Slot:0b,tag:{OreDict:["oreTitanium"]}}]} run replaceitem block ~ ~ ~ container.2 structure_block{	mech_itemid: 1323, CustomModelData: 6421323, du_smelt_id: 1323, OreDict:["dustTitanium"], 	display: {Name: "{\"italic\":false,\"color\":\"light_purple\",\"translate\":\"mech.resource.dust\",\"with\":[{\"translate\":\"mech.resource.titanium\"}]}"},HideFlags: 32	} 2
...
#Logs
execute if score out_0 mech_data matches 1 if block ~ ~ ~ furnace{Items:[{Slot:0b,id:"minecraft:oak_log"}]} run replaceitem block ~ ~ ~ container.2 oak_planks 6
execute if score out_0 mech_data matches 1 if block ~ ~ ~ furnace{Items:[{Slot:0b,id:"minecraft:birch_log"}]} run replaceitem block ~ ~ ~ container.2 birch_planks 6
execute if score out_0 mech_data matches 1 if block ~ ~ ~ furnace{Items:[{Slot:0b,id:"minecraft:spruce_log"}]} run replaceitem block ~ ~ ~ container.2 spruce_planks 6
execute if score out_0 mech_data matches 1 if block ~ ~ ~ furnace{Items:[{Slot:0b,id:"minecraft:jungle_log"}]} run replaceitem block ~ ~ ~ container.2 jungle_planks 6
execute if score out_0 mech_data matches 1 if block ~ ~ ~ furnace{Items:[{Slot:0b,id:"minecraft:dark_oak_log"}]} run replaceitem block ~ ~ ~ container.2 dark_oak_planks 6
execute if score out_0 mech_data matches 1 if block ~ ~ ~ furnace{Items:[{Slot:0b,id:"minecraft:acacia_log"}]} run replaceitem block ~ ~ ~ container.2 acacia_planks 6
