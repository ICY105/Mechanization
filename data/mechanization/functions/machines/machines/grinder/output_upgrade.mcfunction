...
execute if score out_0 mech_data matches 1 if block ~ ~ ~ furnace{Items:[{Slot:0b,tag:{OreDict:["oreTin"]}}]} run item replace block ~ ~ ~ container.2 with structure_block{		mech_itemid: 1313, CustomModelData: 6421313, du_smelt_id: 1313, OreDict:["dustTin"], 		display: {Name: "{\"italic\":false,\"color\":\"gray\",\"translate\":\"mech.resource.dust\",\"with\":[{\"translate\":\"mech.resource.tin\"}]}"},HideFlags: 32				} 2
execute if score out_0 mech_data matches 1 if block ~ ~ ~ furnace{Items:[{Slot:0b,tag:{OreDict:["oreTitanium"]}}]} run item replace block ~ ~ ~ container.2 with structure_block{	mech_itemid: 1323, CustomModelData: 6421323, du_smelt_id: 1323, OreDict:["dustTitanium"], 	display: {Name: "{\"italic\":false,\"color\":\"light_purple\",\"translate\":\"mech.resource.dust\",\"with\":[{\"translate\":\"mech.resource.titanium\"}]}"},HideFlags: 32	} 2
...
#Logs
execute if score out_0 mech_data matches 1 if block ~ ~ ~ furnace{Items:[{Slot:0b,id:"minecraft:oak_log"}]} run item replace block ~ ~ ~ container.2 with oak_planks 6
execute if score out_0 mech_data matches 1 if block ~ ~ ~ furnace{Items:[{Slot:0b,id:"minecraft:birch_log"}]} run item replace block ~ ~ ~ container.2 with birch_planks 6
execute if score out_0 mech_data matches 1 if block ~ ~ ~ furnace{Items:[{Slot:0b,id:"minecraft:spruce_log"}]} run item replace block ~ ~ ~ container.2 with spruce_planks 6
execute if score out_0 mech_data matches 1 if block ~ ~ ~ furnace{Items:[{Slot:0b,id:"minecraft:jungle_log"}]} run item replace block ~ ~ ~ container.2 with jungle_planks 6
execute if score out_0 mech_data matches 1 if block ~ ~ ~ furnace{Items:[{Slot:0b,id:"minecraft:dark_oak_log"}]} run item replace block ~ ~ ~ container.2 with dark_oak_planks 6
execute if score out_0 mech_data matches 1 if block ~ ~ ~ furnace{Items:[{Slot:0b,id:"minecraft:acacia_log"}]} run item replace block ~ ~ ~ container.2 with acacia_planks 6
