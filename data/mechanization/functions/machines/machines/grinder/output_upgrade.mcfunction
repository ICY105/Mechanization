...
execute if score $out_0 mechanization.data matches 1 if data block ~ ~ ~ Items[{Slot:0b}].tag.ctc.traits{"metal/tin":1b,ore:1b} run loot replace block -29999999 0 1601 container.0 loot mechanization:base/resources_x2/tin_raw
execute if score $out_0 mechanization.data matches 1 if data block ~ ~ ~ Items[{Slot:0b}].tag.ctc.traits{"metal/titanium":1b,ore:1b} run loot replace block -29999999 0 1601 container.0 loot mechanization:base/resources_x2/titanium_raw
execute if score $out_0 mechanization.data matches 1 if data block ~ ~ ~ Items[{Slot:0b}].tag.ctc.traits{"metal/uranium":1b,ore:1b} run loot replace block -29999999 0 1601 container.0 loot mechanization:base/resources_x2/uranium_raw
...
#Logs
execute if score $out_0 mechanization.data matches 1 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:oak_log"}] run item replace block -29999999 0 1601 container.0 with minecraft:oak_planks 6
execute if score $out_0 mechanization.data matches 1 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:birch_log"}] run item replace block -29999999 0 1601 container.0 with minecraft:birch_planks 6
execute if score $out_0 mechanization.data matches 1 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:spruce_log"}] run item replace block -29999999 0 1601 container.0 with minecraft:spruce_planks 6
execute if score $out_0 mechanization.data matches 1 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:jungle_log"}] run item replace block -29999999 0 1601 container.0 with minecraft:jungle_planks 6
execute if score $out_0 mechanization.data matches 1 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:dark_oak_log"}] run item replace block -29999999 0 1601 container.0 with minecraft:dark_oak_planks 6
execute if score $out_0 mechanization.data matches 1 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:acacia_log"}] run item replace block -29999999 0 1601 container.0 with minecraft:acacia_planks 6
execute if score $out_0 mechanization.data matches 1 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:crimson_stem"}] run item replace block -29999999 0 1601 container.0 with minecraft:crimson_planks 6
execute if score $out_0 mechanization.data matches 1 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:warped_stem"}] run item replace block -29999999 0 1601 container.0 with minecraft:warped_planks 6
