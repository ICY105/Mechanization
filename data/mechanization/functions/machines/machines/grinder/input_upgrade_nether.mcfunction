...
#Logs
execute if score $temp_0 mech_data matches 0..62 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:oak_log"}] run scoreboard players operation @s mech_timer = $machines.cf.grinder.speed_other mech_data
execute if score $temp_0 mech_data matches 0..62 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:birch_log"}] run scoreboard players operation @s mech_timer = $machines.cf.grinder.speed_other mech_data
execute if score $temp_0 mech_data matches 0..62 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:spruce_log"}] run scoreboard players operation @s mech_timer = $machines.cf.grinder.speed_other mech_data
execute if score $temp_0 mech_data matches 0..62 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:jungle_log"}] run scoreboard players operation @s mech_timer = $machines.cf.grinder.speed_other mech_data
execute if score $temp_0 mech_data matches 0..62 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:dark_oak_log"}] run scoreboard players operation @s mech_timer = $machines.cf.grinder.speed_other mech_data
execute if score $temp_0 mech_data matches 0..62 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:acacia_log"}] run scoreboard players operation @s mech_timer = $machines.cf.grinder.speed_other mech_data
execute if score $temp_0 mech_data matches 0..62 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:crimson_stem"}] run scoreboard players operation @s mech_timer = $machines.cf.grinder.speed_other mech_data
execute if score $temp_0 mech_data matches 0..62 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:warped_stem"}] run scoreboard players operation @s mech_timer = $machines.cf.grinder.speed_other mech_data
