...
#Extra
execute if score temp_0 mech_data matches 0..62 if block ~ ~ ~ furnace{Items:[{Slot:0b,id:"minecraft:cobblestone"}]} run tag @s add mech_active
...
execute if score temp_0 mech_data matches 0..58 if block ~ ~ ~ furnace{Items:[{Slot:0b,id:"minecraft:bone"}]} run tag @s add mech_active
