...
execute if score #output_count mechanization.data matches 0..63 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:gold_ore"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_ores mechanization.data
execute if score #output_count mechanization.data matches 0..63 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:diamond_ore"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_ores mechanization.data
execute if score #output_count mechanization.data matches 0..63 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:emerald_ore"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_ores mechanization.data
execute if score #output_count mechanization.data matches 0..60 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:redstone_ore"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_ores mechanization.data
execute if score #output_count mechanization.data matches 0..58 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:lapis_ore"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_ores mechanization.data

execute if score #output_count mechanization.data matches 0..63 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:deepslate_coal_ore"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_ores mechanization.data
execute if score #output_count mechanization.data matches 0..63 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:deepslate_iron_ore"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_ores mechanization.data
execute if score #output_count mechanization.data matches 0..63 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:deepslate_copper_ore"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_ores mechanization.data
execute if score #output_count mechanization.data matches 0..63 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:deepslate_gold_ore"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_ores mechanization.data
execute if score #output_count mechanization.data matches 0..63 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:deepslate_diamond_ore"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_ores mechanization.data
execute if score #output_count mechanization.data matches 0..63 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:deepslate_emerald_ore"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_ores mechanization.data
execute if score #output_count mechanization.data matches 0..60 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:deepslate_redstone_ore"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_ores mechanization.data
execute if score #output_count mechanization.data matches 0..58 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:deepslate_lapis_ore"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_ores mechanization.data

execute if score #output_count mechanization.data matches 0..63 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:nether_quartz_ore"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_ores mechanization.data
execute if score #output_count mechanization.data matches 0..63 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:nether_gold_ore"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_ores mechanization.data

execute if score #output_count mechanization.data matches 0..63 if data block ~ ~ ~ Items[{Slot:0b}].tag.smithed.dict.ore.tin run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_ores mechanization.data
...
execute if score #output_count mechanization.data matches 0..60 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:jungle_log"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_other mechanization.data
execute if score #output_count mechanization.data matches 0..60 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:dark_oak_log"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_other mechanization.data
...
execute if score #output_count mechanization.data matches 0..62 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:blaze_rod"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_other mechanization.data
execute if score #output_count mechanization.data matches 0..61 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:bone"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_other mechanization.data
