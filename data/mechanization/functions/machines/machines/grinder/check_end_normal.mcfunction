...
#Extra
execute if score temp_0 mech_data matches 0 if block ~ ~ ~ furnace{Items:[{Slot:0b,id:"minecraft:cobblestone"}]} run replaceitem block ~ ~ ~ container.2 sand 1
execute if score temp_0 mech_data matches 1.. if block ~ ~ ~ furnace{Items:[{Slot:0b,id:"minecraft:cobblestone"},{Slot:2b,id:"minecraft:sand"}]} run scoreboard players add temp_0 mech_data 1
...
execute if score temp_0 mech_data matches 0 if block ~ ~ ~ furnace{Items:[{Slot:0b,id:"minecraft:bone"}]} run replaceitem block ~ ~ ~ container.2 bone_meal 4
execute if score temp_0 mech_data matches 1.. if block ~ ~ ~ furnace{Items:[{Slot:0b,id:"minecraft:bone"},{Slot:2b,id:"minecraft:bone_meal"}]} run scoreboard players add temp_0 mech_data 4
