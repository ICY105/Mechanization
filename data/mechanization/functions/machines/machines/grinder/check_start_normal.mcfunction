...
#TTB Compat
execute if score temp_0 mech_data matches 0..61 if block ~ ~ ~ furnace{Items:[{Slot:0b,tag:{amethyst_ore:1b}}]} run tag @s add mech_active
execute if score temp_0 mech_data matches 0..61 if block ~ ~ ~ furnace{Items:[{Slot:0b,tag:{vulcaanium_ore:1b}}]} run tag @s add mech_active