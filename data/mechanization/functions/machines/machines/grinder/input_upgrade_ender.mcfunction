...
execute if score temp_0 mech_data matches 0..56 if block ~ ~ ~ furnace{Items:[{Slot:0b,id:"minecraft:lapis_ore"}]} run tag @s add mech_active
...
execute if score temp_0 mech_data matches 0..56 if block ~ ~ ~ furnace{Items:[{Slot:0b,id:"minecraft:redstone_ore"}]} run tag @s add mech_active
...
execute if score temp_0 mech_data matches 0..61 if block ~ ~ ~ furnace{Items:[{Slot:0b,id:"minecraft:nether_quartz_ore"}]} run tag @s add mech_active
...
execute if score temp_0 mech_data matches 0..59 if block ~ ~ ~ furnace{Items:[{Slot:0b,id:"minecraft:bone"}]} run tag @s add mech_active
