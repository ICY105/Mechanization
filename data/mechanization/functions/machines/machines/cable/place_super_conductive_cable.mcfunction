...
# Summon Entity & Init
summon minecraft:item_frame ~ ~ ~ {Tags:["mechanization.new", "mechanization.cable", "mechanization.cable.super_conductive", "energy.cable", "smithed.block", "smithed.strict"], CustomName:'{"translate":"mech.block.copper_cable.tier_1"}', Item:{id:"minecraft:weathered_copper", tag:{CustomModelData:6421000}, Count:1b}, Invisible:1b, Invulnerable:1b, Fixed:1b, Silent:1b}
