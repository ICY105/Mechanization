...
execute if score #id mechanization.data matches 34 if data storage smithed.custom_block:main blockApi{id:"mechanization:lightning_generator"} run function mechanization:machines/machines/lightning_generator/place
execute if score #id mechanization.data matches 36 if data storage smithed.custom_block:main blockApi{id:"mechanization:dimensional_generator"} run function mechanization:machines/machines/dimensional_generator/place
...
execute if score #id mechanization.data matches 25 if data storage smithed.custom_block:main blockApi{id:"mechanization:auto_fisher"} run function mechanization:machines/machines/auto_fisher/place
...
execute if score #id mechanization.data matches 27 if data storage smithed.custom_block:main blockApi{id:"mechanization:item_reformer"} run function mechanization:machines/machines/item_reformer/place
