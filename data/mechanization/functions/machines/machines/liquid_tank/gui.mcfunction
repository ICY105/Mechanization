...
#model
scoreboard players operation $temp_0 mech_data = @s mech_fluid
scoreboard players operation $temp_0 mech_data *= $cons.8 du_data
scoreboard players operation $temp_0 mech_data /= $in_1 mech_data
execute if entity @s[tag=mech_t1_liquid_tank] run scoreboard players add $temp_0 mech_data 6422922
execute if entity @s[tag=mech_t2_liquid_tank] run scoreboard players add $temp_0 mech_data 6422931
execute if entity @s[tag=mech_t3_liquid_tank] run scoreboard players add $temp_0 mech_data 6422940
