...
execute if score $temp_4 mechanization.data matches 0 if entity @s[tag=mech_t1_liquid_tank] run scoreboard players operation $temp_5 mechanization.data = $machines.cf.t1_tank.capacity mech_data
execute if score $temp_4 mechanization.data matches 0 if entity @s[tag=mech_t2_liquid_tank] run scoreboard players operation $temp_5 mechanization.data = $machines.cf.t2_tank.capacity mech_data
execute if score $temp_4 mechanization.data matches 0 if entity @s[tag=mech_t3_liquid_tank] run scoreboard players operation $temp_5 mechanization.data = $machines.cf.t3_tank.capacity mech_data
