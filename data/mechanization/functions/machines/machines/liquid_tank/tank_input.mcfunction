...
execute if score @s mech_fluid matches 1.. if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:powdered_snow_bucket"}] if data entity @s Item.tag.tank.tag.ctc.traits.liquid{id:"powdered_snow"} run scoreboard players set $in_0 mech_data 0
