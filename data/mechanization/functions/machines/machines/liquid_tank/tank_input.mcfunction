...
execute if score @s mechanization.fluid.0 matches 1.. if data block ~ ~ ~ Items[{Slot:0b}].tag.mechanization{id:"vial"}.liquid run data modify storage du:test var set from entity @s Item.tag.tank.tag.mechanization.liquid.id
