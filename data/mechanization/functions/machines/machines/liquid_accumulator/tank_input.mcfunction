...
execute if score @s mech_fluid matches 1.. if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:bucket"}] run scoreboard players set $in_0 mech_data 0
execute if score @s mech_fluid matches 1.. if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:glass_bottle"}] run scoreboard players set $in_0 mech_data 0
execute if score @s mech_fluid matches 1.. if data block ~ ~ ~ Items[{Slot:0b}].tag{mech_itemid:1108} unless data block ~ ~ ~ Items[{Slot:0b}].tag.ctc.traits.liquid run scoreboard players set $in_0 mech_data 0
