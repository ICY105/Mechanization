...
execute if block ~ ~ ~ dropper{Items:[{id:"minecraft:rotten_flesh"}]} run scoreboard players add temp_0 mechanization.data 8
...
execute if block ~ ~ ~ dropper{Items:[{id:"minecraft:cod"}]} run scoreboard players add temp_0 mechanization.data 16
execute if block ~ ~ ~ dropper{Items:[{id:"minecraft:salmon"}]} run scoreboard players add temp_0 mechanization.data 16
...
execute if block ~ ~ ~ dropper{Items:[{id:"minecraft:rabbit"}]} run scoreboard players add temp_0 mechanization.data 20
execute if block ~ ~ ~ dropper{Items:[{id:"minecraft:chicken"}]} run scoreboard players add temp_0 mechanization.data 20
...
execute if block ~ ~ ~ dropper{Items:[{id:"minecraft:beef"}]} run scoreboard players add temp_0 mechanization.data 24
execute if block ~ ~ ~ dropper{Items:[{id:"minecraft:porkchop"}]} run scoreboard players add temp_0 mechanization.data 24
execute if block ~ ~ ~ dropper{Items:[{id:"minecraft:mutton"}]} run scoreboard players add temp_0 mechanization.data 24
