...
execute if data storage mechanization:temp list[0] run function mechanization:machines/machines/enchanting_station/gui_clear
...
execute if score @s mechanization.fluid.0 matches 1.. run data modify block ~ ~ ~ Items[{Slot:16b}].tag.display.Name set from block -30000000 0 3202 Text1
...
execute if score @s mechanization.fluid.0 matches 1.. run data modify block ~ ~ ~ Items[{Slot:16b}].tag.display.Lore append from block -30000000 0 3202 Text1
execute if score @s mechanization.fluid.0 matches 1.. run data modify block ~ ~ ~ Items[{Slot:16b}].tag.display.color set from entity @s Item.tag.tank.tag.mechanization.liquid.color
