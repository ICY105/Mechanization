...
execute if data storage mechanization:temp {var:"minecraft:silk_touch"} run function mechanization:machines/machines/enchanting_station/enchantments/silk_touch

execute if data storage mechanization:temp {var:"minecraft:protection"} run function mechanization:machines/machines/enchanting_station/enchantments/protection
execute if data storage mechanization:temp {var:"minecraft:fire_protection"} run function mechanization:machines/machines/enchanting_station/enchantments/fire_protection
...
execute if data storage mechanization:temp {var:"minecraft:feather_falling"} run function mechanization:machines/machines/enchanting_station/enchantments/feather_falling
execute if data storage mechanization:temp {var:"minecraft:depth_strider"} run function mechanization:machines/machines/enchanting_station/enchantments/depth_strider
...
execute if data storage mechanization:temp {var:"minecraft:flame"} run function mechanization:machines/machines/enchanting_station/enchantments/flame
...
execute if data storage mechanization:temp {var:"minecraft:channeling"} run function mechanization:machines/machines/enchanting_station/enchantments/channeling
execute if data storage mechanization:temp {var:"minecraft:loyalty"} run function mechanization:machines/machines/enchanting_station/enchantments/loyalty

execute if data storage mechanization:temp {var:"minecraft:luck_of_the_sea"} run function mechanization:machines/machines/enchanting_station/enchantments/luck_of_the_sea
execute if data storage mechanization:temp {var:"minecraft:lure"} run function mechanization:machines/machines/enchanting_station/enchantments/lure
