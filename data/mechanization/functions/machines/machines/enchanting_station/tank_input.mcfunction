...
execute if data block ~ ~ ~ Items[{Slot:6b}].tag.mechanization.liquid{id:"experience"} run scoreboard players set $in_0 mechanization.data 0

execute if score @s mechanization.fluid.0 matches 1.. if data block ~ ~ ~ Items[{Slot:6b,id:"minecraft:bucket"}] run scoreboard players set $in_0 mechanization.data 0
execute if score @s mechanization.fluid.0 matches 1.. if data block ~ ~ ~ Items[{Slot:6b,id:"minecraft:glass_bottle"}] run scoreboard players set $in_0 mechanization.data 0
execute if score @s mechanization.fluid.0 matches 1.. if data block ~ ~ ~ Items[{Slot:6b}].tag.mechanization{id:"vial"} unless data block ~ ~ ~ Items[{Slot:6b}].tag.mechanization.liquid run scoreboard players set $in_0 mechanization.data 0
