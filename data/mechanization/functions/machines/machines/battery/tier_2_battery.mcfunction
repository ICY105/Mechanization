...
# set capacity
scoreboard players operation @s mechanization.storage_capacity = #base.cf.t2_battery.capacity mechanization.data
scoreboard players operation @s[tag=mechanization.upgraded] mechanization.storage_capacity = #base.cf.t2_battery.capacity.machine_upgrade mechanization.data
scoreboard players operation @s[tag=mechanization.upgraded.ender] mechanization.storage_capacity = #base.cf.t2_battery.capacity.ender_upgrade mechanization.data
scoreboard players operation @s[tag=mechanization.upgraded.nether] mechanization.storage_capacity = #base.cf.t2_battery.capacity.nether_upgrade mechanization.data
