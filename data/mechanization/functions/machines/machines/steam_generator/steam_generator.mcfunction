...
execute unless score @s mechanization.data matches 1.. unless score @s du_data matches 3900.. if score @s mechanization.stored_fluid matches 1.. if data block ~ ~ ~ Items[{Slot:10b}] run function mechanization:machines/machines/steam_generator/add_fuel

function mechanization:machines/machines/steam_generator/gui

#generate heat
scoreboard players set $temp_0 mechanization.data 12
execute if entity @s[tag=mech_upgraded] run scoreboard players add $temp_0 mechanization.data 6
execute if entity @s[tag=mech_upgrade_ender] run scoreboard players add $temp_0 mechanization.data 6
execute if entity @s[tag=mech_upgrade_nether] run scoreboard players add $temp_0 mechanization.data 36
execute if entity @s[tag=mech_upgrade_nether] run scoreboard players remove @s du_data 2
scoreboard players operation $temp_0 mechanization.data *= $machines.cf.steam_gen.power mech_data
scoreboard players operation $temp_0 mechanization.data /= $cons.100 du_data

#convert water + heat into steam
execute if score @s mechanization.data matches 1.. if score @s mechanization.stored_fluid matches 1.. run scoreboard players operation @s du_data += $temp_0 mech_data
execute if score @s mechanization.data matches 1.. if score @s mechanization.stored_fluid matches 1.. run scoreboard players operation @s mechanization.stored_fluid -= $temp_0 mech_data
execute if score @s mechanization.data matches 1.. if score @s mechanization.stored_fluid matches ..-1 run scoreboard players set @s mechanization.stored_fluid 0
execute if score @s mechanization.data matches 1.. if score @s du_data matches 4001.. run scoreboard players set @s du_data 4000

#convert steam into power
scoreboard players operation $temp_0 mechanization.data += $temp_0 mech_data
execute if score @s du_data matches 2000.. run scoreboard players operation $temp_1 mechanization.data = @s du_data
execute if score @s du_data matches 2000.. run scoreboard players remove $temp_1 mechanization.data 2000
execute if score @s du_data matches 2000.. if score $temp_1 mechanization.data > $temp_0 mechanization.data run scoreboard players operation $temp_1 mechanization.data = $temp_0 mech_data
execute if score @s du_data matches 2000.. if score @s mechanization.stored_energy matches ..2000 run scoreboard players operation @s mechanization.stored_energy += $temp_1 mech_data
execute if score @s du_data matches 2000.. run scoreboard players operation @s du_data -= $temp_1 mech_data

#leak steam if no fuel
execute if score @s mechanization.data matches 0 if score @s du_data matches 10.. run scoreboard players remove @s du_data 10
