...
execute if data block ~ ~ ~ Items[{Slot:6b}].tag.ctc.traits.liquid{id:"steam"} run scoreboard players set $in_0 mechanization.data 0
...
execute if score $in_0 mechanization.data matches 0.. if data entity @s Item.tag.steam_item run data modify storage du:temp obj.liquid_item set from entity @s Item.tag.steam_item
...
execute if score $in_0 mechanization.data matches 0.. run data modify entity @s Item.tag.steam_item set from storage du:temp obj.liquid_item
