...
execute if data entity @s Item.tag.water_item.tag.ctc.traits.liquid.molten run scoreboard players add $temp_0 mechanization.data 17
execute store result block ~ ~ ~ Items[{Slot:13b}].tag.CustomModelData int 1 run scoreboard players get $temp_0 mech_data
execute if score @s mechanization.stored_fluid matches 1.. run data modify storage du:temp var set from entity @s Item.tag.water_item.tag.ctc.traits.liquid.name
...
execute if score @s mechanization.stored_fluid matches 1.. run data modify block ~ ~ ~ Items[{Slot:13b}].tag.display.Name set from block -29999999 0 1602 Text1
...
execute if score @s mechanization.stored_fluid matches 1.. run data modify block ~ ~ ~ Items[{Slot:13b}].tag.display.Lore append from block -29999999 0 1602 Text1
execute if score @s mechanization.stored_fluid matches 1.. run data modify block ~ ~ ~ Items[{Slot:13b}].tag.display.color set from entity @s Item.tag.water_item.tag.ctc.traits.liquid.color
...
scoreboard players operation $temp_0 mechanization.data /= $cons.250 du_data
scoreboard players add $temp_0 mechanization.data 6422900
execute if data entity @s Item.tag.steam_item.tag.ctc.traits.liquid.molten run scoreboard players add $temp_0 mechanization.data 17
...
#fuel slot
execute unless score @s mechanization.data matches 1.. run item replace block ~ ~ ~ container.1 with minecraft:structure_block{du_gui:1b,CustomModelData:6422900,display:{Name:'{"text":""}'}}
execute if score @s mechanization.data matches 1.. run item replace block ~ ~ ~ container.1 with minecraft:structure_block{du_gui:1b,CustomModelData:6422901,display:{Name:'{"text":""}'}}
