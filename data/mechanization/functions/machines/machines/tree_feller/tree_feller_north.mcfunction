...
#break wood
execute if score temp_0 mech_data matches 0 if entity @s[scores={mech_power=160..},tag=!mech_upgrade_ender] store result score temp_0 mech_data run fill ~ ~ ~-1 ~ ~16 ~-1 air replace #minecraft:logs
execute if score temp_0 mech_data matches 0 if entity @s[scores={mech_power=160..},tag=mech_upgrade_ender] store result score temp_0 mech_data run fill ~-2 ~ ~1 ~2 ~32 ~-3 air replace #minecraft:logs
