...
execute if score temp_0 mech_data matches 0 if entity @s[scores={mech_power=160..},tag=!mech_upgraded] store result score temp_0 mech_data run fill ~ ~ ~-1 ~ ~12 ~-1 air replace #minecraft:logs
execute if score temp_0 mech_data matches 0 if entity @s[scores={mech_power=160..},tag=mech_upgraded] store result score temp_0 mech_data run fill ~-2 ~ ~1 ~2 ~24 ~-3 air replace #minecraft:logs
