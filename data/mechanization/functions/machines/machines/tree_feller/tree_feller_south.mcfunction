...
#summon result item
execute if entity @s[tag=!mech_upgrade_nether] if score temp_0 mech_data matches 0 run loot spawn ~ ~ ~-1 mine ~ ~ ~1
execute if entity @s[tag=mech_upgrade_nether] if score temp_0 mech_data matches 0 run summon item ~ ~ ~-1 {Item:{id:"minecraft:charcoal",Count:1b}}

#break wood
execute if score temp_0 mech_data matches 0 if entity @s[scores={mech_power=160..},tag=!mech_upgrade_ender] store result score temp_0 mech_data run fill ~ ~ ~1 ~ ~12 ~1 air replace #minecraft:logs
execute if score temp_0 mech_data matches 0 if entity @s[scores={mech_power=160..},tag=mech_upgrade_ender] store result score temp_0 mech_data run fill ~-2 ~ ~-1 ~2 ~24 ~3 air replace #minecraft:logs

#change stack size
execute if score temp_0 mech_data matches 1.. positioned ~ ~ ~-1 store result entity @e[type=item,limit=1,sort=nearest,distance=..0.75] Item.Count int 1 run scoreboard players get temp_0 mech_data
