...
#break wood
execute if score temp_0 mechanization.data matches 0 if entity @s[scores={mech_power=160..},tag=!mech_upgrade_ender] store result score temp_0 mechanization.data run fill ~ ~ ~1 ~ ~12 ~1 air replace #minecraft:logs
execute if score temp_0 mechanization.data matches 0 if entity @s[scores={mech_power=160..},tag=mech_upgrade_ender] store result score temp_0 mechanization.data run fill ~-2 ~ ~-1 ~2 ~24 ~3 air replace #minecraft:logs
