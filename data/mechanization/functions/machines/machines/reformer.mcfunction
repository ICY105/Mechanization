...
execute if score @s mech_power matches 128.. unless block ~ ~ ~ dropper{Items:[{tag:{Unbreakable:1}}]} store result score temp_0 mech_data run data get block ~ ~ ~ Items[0].tag.Damage
