...
execute if score temp_0 mech_data matches 2 align xyz positioned ~-1 ~ ~ as @e[dx=0] at @s run tp @s ~-1 ~ ~
...
execute if score temp_0 mech_data matches 3 align xyz positioned ~-2 ~ ~ as @e[dx=1] at @s run tp @s ~-1 ~ ~
...
execute if score temp_0 mech_data matches 4 align xyz positioned ~-3 ~ ~ as @e[dx=2] at @s run tp @s ~-1 ~ ~
...
execute if score temp_0 mech_data matches 5 align xyz positioned ~-4 ~ ~ as @e[dx=3] at @s run tp @s ~-1 ~ ~
...
execute if score temp_0 mech_data matches 6 align xyz positioned ~-5 ~ ~ as @e[dx=4] at @s run tp @s ~-1 ~ ~
...
execute if score temp_0 mech_data matches 7 align xyz positioned ~-6 ~ ~ as @e[dx=5] at @s run tp @s ~-1 ~ ~
...
execute if score temp_0 mech_data matches 8 align xyz positioned ~-7 ~ ~ as @e[dx=6] at @s run tp @s ~-1 ~ ~
...
execute if score temp_0 mech_data matches 9 align xyz positioned ~-8 ~ ~ as @e[dx=7] at @s run tp @s ~-1 ~ ~
