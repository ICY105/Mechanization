...
execute if score temp_0 mech_data matches 2 positioned ~-0.5 ~-0.5 ~0.5 as @e[dz=0] at @s run tp @s ~ ~ ~1
...
execute if score temp_0 mech_data matches 3 positioned ~-0.5 ~-0.5 ~0.5 as @e[dz=1] at @s run tp @s ~ ~ ~1
...
execute if score temp_0 mech_data matches 4 positioned ~-0.5 ~-0.5 ~0.5 as @e[dz=2] at @s run tp @s ~ ~ ~1
...
execute if score temp_0 mech_data matches 5 positioned ~-0.5 ~-0.5 ~0.5 as @e[dz=3] at @s run tp @s ~ ~ ~1
...
execute if score temp_0 mech_data matches 6 positioned ~-0.5 ~-0.5 ~0.5 as @e[dz=4] at @s run tp @s ~ ~ ~1
...
execute if score temp_0 mech_data matches 7 positioned ~-0.5 ~-0.5 ~0.5 as @e[dz=5] at @s run tp @s ~ ~ ~1
...
execute if score temp_0 mech_data matches 8 positioned ~-0.5 ~-0.5 ~0.5 as @e[dz=6] at @s run tp @s ~ ~ ~1
...
execute if score temp_0 mech_data matches 9 positioned ~-0.5 ~-0.5 ~0.5 as @e[dz=7] at @s run tp @s ~ ~ ~1
