...
execute unless score @s mech_data matches -2147483648.. store result score @s du_uuid run data get entity @s ArmorItems[3].tag.du_uuid

#main
execute if entity @s[nbt={Dimension:0}] run function mechanization:machines/machines/chunk_loader/chunk_loader_normal
execute if entity @s[tag=mech_upgraded,nbt=!{Dimension:0}] run function mechanization:machines/machines/chunk_loader/chunk_loader_upgraded
