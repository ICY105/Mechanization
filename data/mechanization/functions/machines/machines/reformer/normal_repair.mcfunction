...
execute store result score temp_0 mech_data run data get block ~ ~ ~ Items[{Slot:4b}].tag.Damage
...
execute store result block ~ ~ ~ Items[{Slot:4b}].tag.Damage int 1 run scoreboard players get temp_0 mech_data
