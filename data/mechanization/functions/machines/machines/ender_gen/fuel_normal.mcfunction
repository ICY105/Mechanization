...
execute if block ~ ~ ~ furnace{Items:[{Slot:0b,id:"minecraft:end_stone_bricks"}]} run scoreboard players add @s mech_data 1
...
execute if block ~ ~ ~ furnace{Items:[{Slot:0b,id:"minecraft:ender_crystal"}]} run scoreboard players add @s mech_data 12
...
execute if block ~ ~ ~ furnace{Items:[{Slot:0b, tag:{OreDict:["blockEnderPearl"]} }]} run scoreboard players add @s mech_data 20
