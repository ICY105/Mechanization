...
execute if score @s mechanization.timer matches 1 if score @s mechanization.fluid.0 matches 1.. if score @s mechanization.data matches 1.. run function mechanization:machines/machines/casting_basin/recipe/output
