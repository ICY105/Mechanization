...
execute if score @s mechanization.stored_fluid matches 1.. run data modify block ~ ~ ~ Items[{Slot:10b}].tag.display.Name set from block -29999999 0 1602 Text1
...
execute if score @s mechanization.stored_fluid matches 1.. run data modify block ~ ~ ~ Items[{Slot:10b}].tag.display.Lore append from block -29999999 0 1602 Text1
execute if score @s mechanization.stored_fluid matches 1.. run data modify block ~ ~ ~ Items[{Slot:10b}].tag.display.color set from entity @s Item.tag.tank.tag.ctc.traits.liquid.color
