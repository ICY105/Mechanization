...
execute as @e[tag=mech_pipe,distance=0.5..1.4] run function mechanization:machines/machines/liquid_pipe/place_pipe
execute as @e[tag=mech_liquid_dest,distance=0.5..1.4] run function mechanization:machines/machines/liquid_pipe/place_dest
execute as @e[tag=mech_liquid_src,tag=!mech_liquid_dest,distance=0.5..1.4] run function mechanization:machines/machines/liquid_pipe/place_src
