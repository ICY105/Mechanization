...
execute if score $temp_1 mechanization.data matches 1 run data modify storage du:temp obj set value {}
...
execute if score $temp_1 mechanization.data matches 2 run scoreboard players operation $temp_2 mechanization.data = $out_0 mech_data
execute if score $temp_1 mechanization.data matches 2 as @e[type=#mechanization:valid_block_entities,tag=mech_pipe_output,predicate=mechanization:matches_uuid,sort=nearest] run function mechanization:machines/machines/liquid_pipe/output
execute if score $temp_1 mechanization.data matches 2 run scoreboard players operation $in_0 mechanization.data = $out_1 mech_data
execute if score $temp_1 mechanization.data matches 2 run data modify storage du:temp obj set value {}
