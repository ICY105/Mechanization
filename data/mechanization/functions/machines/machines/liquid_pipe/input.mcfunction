...
execute if score $world.out_0 du_data matches 0 align y positioned ~ ~0.9 ~ as @e[tag=mech_liquid_src,distance=..1.3] run function mechanization:machines/machines/liquid_pipe/input_2 
