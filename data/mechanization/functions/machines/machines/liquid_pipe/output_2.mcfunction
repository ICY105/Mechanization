...
execute if score $temp_3 mechanization.data matches 1 run scoreboard players operation $in_0 mechanization.data = $temp_2 mech_data
execute if score $temp_3 mechanization.data matches 1 if score $in_0 mechanization.data > $temp_0 mechanization.data run scoreboard players operation $in_0 mechanization.data = $temp_0 mech_data
...
execute if score $temp_3 mechanization.data matches 1 if score $out_0 mechanization.data matches 1.. run scoreboard players operation $temp_2 mechanization.data -= $out_0 mech_data
execute if score $temp_3 mechanization.data matches 1 if score $out_0 mechanization.data matches 1.. run scoreboard players operation $out_1 mechanization.data += $out_0 mech_data
