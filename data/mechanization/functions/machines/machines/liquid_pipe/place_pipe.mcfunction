...
execute if score $temp_1 mech_data matches 0.. as @e[tag=mech_pipe,predicate=mechanization:matches_uuid] run scoreboard players operation @s du_uuid = $temp_1 mech_data
