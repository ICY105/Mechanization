...
scoreboard players set $temp_2 mech_data 6422900
...
execute if score $temp_1 mech_data matches 0.. as @e[type=minecraft:item_frame,tag=mech_pipe,predicate=mechanization:matches_uuid] run scoreboard players operation @s du_uuid = $temp_1 mech_data
