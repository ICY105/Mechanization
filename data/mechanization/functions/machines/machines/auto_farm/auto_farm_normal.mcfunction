...
execute store result score temp_0 mech_data run fill ~-3 ~ ~-3 ~3 ~ ~3 minecraft:wheat[age=0] replace minecraft:wheat[age=7]
execute if score temp_0 mech_data matches 1.. run summon item ~ ~1 ~ {Tags:["mech_new_crop"],Item:{id:"minecraft:wheat",Count:1b}}
execute if score temp_0 mech_data matches 1.. store result entity @e[tag=mech_new_crop,limit=1] Item.Count int 2 run scoreboard players get temp_0 mech_data
execute if score temp_0 mech_data matches 1.. run tag @e[type=item,tag=mech_new_crop] remove mech_new_crop

#Beetroots
scoreboard players set temp_0 mech_data 0
execute store result score temp_0 mech_data run fill ~-3 ~ ~-3 ~3 ~ ~3 minecraft:beetroots[age=0] replace minecraft:beetroots[age=3]
...
#Potatoes
scoreboard players set temp_0 mech_data 0
execute store result score temp_0 mech_data run fill ~-3 ~ ~-3 ~3 ~ ~3 minecraft:potatoes[age=0] replace minecraft:potatoes[age=7]
...
#Carrots
scoreboard players set temp_0 mech_data 0
execute store result score temp_0 mech_data run fill ~-3 ~ ~-3 ~3 ~ ~3 minecraft:carrots[age=0] replace minecraft:carrots[age=7]
...
#Netherwart
scoreboard players set temp_0 mech_data 0
execute store result score temp_0 mech_data run fill ~-3 ~ ~-3 ~3 ~ ~3 minecraft:nether_wart[age=0] replace minecraft:nether_wart[age=3]
...
#Cocoa
scoreboard players set temp_0 mech_data 0
execute store result score temp_0 mech_data run fill ~-3 ~ ~-3 ~3 ~ ~3 minecraft:cocoa[age=0] replace minecraft:cocoa[age=2]
...
#Pumpkin
scoreboard players set temp_0 mech_data 0
execute store result score temp_0 mech_data run fill ~-3 ~ ~-3 ~3 ~ ~3 minecraft:air replace minecraft:pumpkin
...
#Sugar Cane
scoreboard players set temp_0 mech_data 0
execute store result score temp_0 mech_data run fill ~-3 ~1 ~-3 ~3 ~1 ~3 minecraft:air replace minecraft:sugar_cane
...
#Cactus
scoreboard players set temp_0 mech_data 0
execute store result score temp_0 mech_data run fill ~-3 ~1 ~-3 ~3 ~1 ~3 minecraft:air replace minecraft:cactus
