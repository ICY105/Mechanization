...
execute if score $out_0 mechanization.data matches 1 if score @s mechanization.stored_fluid >= $temp_2 mechanization.data if score $temp_1 mechanization.data = $out_4 mechanization.data if score $in_0 mechanization.data <= $out_3 mechanization.data run function mechanization:machines/machines/ench_station/set_enchant_level
execute if score $out_0 mechanization.data matches 1 if score @s mechanization.stored_fluid >= $temp_2 mechanization.data if score $temp_1 mechanization.data = $out_4 mechanization.data if score $in_0 mechanization.data <= $out_3 mechanization.data run scoreboard players set $temp_0 mechanization.data 1
execute if score $out_0 mechanization.data matches 1 if score @s mechanization.stored_fluid >= $temp_2 mechanization.data if score $temp_1 mechanization.data = $out_4 mechanization.data if score $in_0 mechanization.data <= $out_3 mechanization.data run scoreboard players operation @s mechanization.stored_fluid -= $temp_2 mech_data

execute if score $out_0 mechanization.data matches 1 if score @s mechanization.stored_fluid >= $temp_2 mechanization.data if score $temp_1 mechanization.data > $out_4 mechanization.data if score $temp_1 mechanization.data <= $out_3 mechanization.data run scoreboard players operation $in_0 mechanization.data = $temp_1 mech_data
execute if score $out_0 mechanization.data matches 1 if score @s mechanization.stored_fluid >= $temp_2 mechanization.data if score $temp_1 mechanization.data > $out_4 mechanization.data if score $temp_1 mechanization.data <= $out_3 mechanization.data run function mechanization:machines/machines/ench_station/set_enchant_level
execute if score $out_0 mechanization.data matches 1 if score @s mechanization.stored_fluid >= $temp_2 mechanization.data if score $temp_1 mechanization.data > $out_4 mechanization.data if score $temp_1 mechanization.data <= $out_3 mechanization.data run scoreboard players set $temp_0 mechanization.data 1
execute if score $out_0 mechanization.data matches 1 if score @s mechanization.stored_fluid >= $temp_2 mechanization.data if score $temp_1 mechanization.data > $out_4 mechanization.data if score $temp_1 mechanization.data <= $out_3 mechanization.data run scoreboard players operation @s mechanization.stored_fluid -= $temp_2 mech_data
