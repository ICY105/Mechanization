...
execute if score $temp_0 mech_data matches -1 unless data block ~ ~ ~ Items[{Slot:10b}] run scoreboard players set $temp_0 mech_data 10
execute if score $temp_0 mech_data matches -1 unless data block ~ ~ ~ Items[{Slot:12b}] run scoreboard players set $temp_0 mech_data 12
execute if score $temp_0 mech_data matches -1 unless data block ~ ~ ~ Items[{Slot:5b}] run scoreboard players set $temp_0 mech_data 6
