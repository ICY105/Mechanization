...
execute if block ~ ~ ~ minecraft:spawner align xyz run summon minecraft:armor_stand ~0.5 ~0.5 ~0.5 {Tags:["mechanization", "mechanization.new", "mechanization.spawner_controller", "mechanization.redstone_control", "energy.receive", "smithed.block"],Marker:1b,Invisible:1,Invulnerable:1,NoGravity:1,DisabledSlots:2039583,ArmorItems:[{},{},{},{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:6422019}}]}
