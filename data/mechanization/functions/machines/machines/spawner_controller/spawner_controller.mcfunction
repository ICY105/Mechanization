...
execute if score @s energy.storage matches ..319 if score #active mechanization.data matches 1 run data merge block ~ ~ ~ {RequiredPlayerRange: 16s, MaxSpawnDelay: 800s, MinSpawnDelay: 200s, Delay: 600s}
execute if score @s energy.storage matches ..319 run scoreboard players set #active mechanization.data 0

execute if score #active mechanization.data matches 0 run data merge block ~ ~ ~ {RequiredPlayerRange: 0s, MaxSpawnDelay: 800s, MinSpawnDelay: 200s, Delay: 600s}
