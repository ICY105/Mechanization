...
execute if block ~ ~ ~ minecraft:daylight_detector[inverted=false] store success entity @s Item.tag.CustomModelData int 6422909 if entity @s
execute if block ~ ~ ~ minecraft:daylight_detector[inverted=true] store success entity @s Item.tag.CustomModelData int 6422910 if entity @s
...
execute unless block ~ ~ ~ minecraft:daylight_detector run kill @e[tag=mech_solar_panel_model,distance=..0.5]
