...
execute if score #success mechanization.data matches 0 if block ~1 ~1 ~ #minecraft:dirt_like if block ~1 ~2 ~ minecraft:air store success score #success mechanization.data run setblock ~1 ~2 ~ minecraft:melon
execute if score #success mechanization.data matches 0 if block ~-1 ~1 ~ #minecraft:dirt_like if block ~-1 ~2 ~ minecraft:air store success score #success mechanization.data run setblock ~-1 ~2 ~ minecraft:melon
execute if score #success mechanization.data matches 0 if block ~ ~1 ~1 #minecraft:dirt_like if block ~ ~2 ~1 minecraft:air store success score #success mechanization.data run setblock ~ ~2 ~1 minecraft:melon
execute if score #success mechanization.data matches 0 if block ~ ~1 ~-1 #minecraft:dirt_like if block ~ ~2 ~-1 minecraft:air store success score #success mechanization.data run setblock ~ ~2 ~-1 minecraft:melon
