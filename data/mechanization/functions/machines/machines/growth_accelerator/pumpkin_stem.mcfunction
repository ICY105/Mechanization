execute unless block ~ ~2 ~ pumpkin_stem[age=7] run scoreboard players set temp_0 mechanization.data 1
...
execute if score temp_0 mechanization.data matches 0 if block ~1 ~1 ~ #minecraft:dirt_like if block ~1 ~2 ~ air store success score temp_0 mechanization.data run setblock ~1 ~2 ~ pumpkin
execute if score temp_0 mechanization.data matches 0 if block ~-1 ~1 ~ #minecraft:dirt_like if block ~-1 ~2 ~ air store success score temp_0 mechanization.data run setblock ~-1 ~2 ~ pumpkin
execute if score temp_0 mechanization.data matches 0 if block ~ ~1 ~1 #minecraft:dirt_like if block ~ ~2 ~1 air store success score temp_0 mechanization.data run setblock ~ ~2 ~1 pumpkin
execute if score temp_0 mechanization.data matches 0 if block ~ ~1 ~-1 #minecraft:dirt_like if block ~ ~2 ~-1 air store success score temp_0 mechanization.data run setblock ~ ~2 ~-1 pumpkin