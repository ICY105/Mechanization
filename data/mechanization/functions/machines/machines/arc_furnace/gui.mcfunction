...
execute if score @s mechanization.stored_fluid matches 1.. run data modify block ~ ~ ~ Items[{Slot:5b}].tag.display.Name set from block -29999999 0 1602 Text1
...
execute if score @s mechanization.stored_fluid matches 1.. run data modify block ~ ~ ~ Items[{Slot:5b}].tag.display.Lore append from block -29999999 0 1602 Text1
execute if score @s mechanization.stored_fluid matches 1.. run data modify block ~ ~ ~ Items[{Slot:5b}].tag.display.color set from entity @s Item.tag.tank.tag.ctc.traits.liquid.color
...
execute unless score @s mechanization.timer matches 1.. run item replace block ~ ~ ~ container.6 with minecraft:structure_block{du_gui:1b,CustomModelData:6422900,display:{Name:'{"text":""}'}}
execute if score @s mechanization.timer matches 1.. run item replace block ~ ~ ~ container.6 with minecraft:structure_block{du_gui:1b,CustomModelData:6422901,display:{Name:'{"text":""}'}}
