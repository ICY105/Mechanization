...
execute if score @s[tag=mechanization.upgraded.ender] mechanization.fluid.0 matches 0 if data storage mechanization:temp obj.input_item{id:"minecraft:raw_iron"} run scoreboard players add @s mechanization.fluid.0 180
...
execute if score @s[tag=mechanization.upgraded.ender] mechanization.fluid.0 matches 0 if data storage mechanization:temp obj.input_item{id:"minecraft:raw_copper"} run scoreboard players add @s mechanization.fluid.0 180
...
execute if score @s[tag=mechanization.upgraded.ender] mechanization.fluid.0 matches 0 if data storage mechanization:temp obj.input_item{id:"minecraft:raw_gold"} run scoreboard players add @s mechanization.fluid.0 180
...
execute if score @s[tag=mechanization.upgraded.ender] mechanization.fluid.0 matches 0 if data storage mechanization:temp obj.input_item{id:"minecraft:raw_iron_block"} run scoreboard players add @s mechanization.fluid.0 1620
...
execute if score @s[tag=mechanization.upgraded.ender] mechanization.fluid.0 matches 0 if data storage mechanization:temp obj.input_item{id:"minecraft:raw_copper_block"} run scoreboard players add @s mechanization.fluid.0 1620
...
execute if score @s[tag=mechanization.upgraded.ender] mechanization.fluid.0 matches 0 if data storage mechanization:temp obj.input_item{id:"minecraft:raw_gold_block"} run scoreboard players add @s mechanization.fluid.0 1620
