...
execute if score @s mech_fluid matches 0 if data storage du:temp obj.input_item{id:"minecraft:raw_copper_block"} run loot replace block -29999999 0 1601 container.0 loot mechanization:base/liquids/vial_of_molten_copper
...
execute if score @s mech_fluid matches 0 if data storage du:temp obj.input_item{id:"minecraft:raw_gold_block"} run loot replace block -29999999 0 1601 container.0 loot mechanization:base/liquids/vial_of_molten_gold
