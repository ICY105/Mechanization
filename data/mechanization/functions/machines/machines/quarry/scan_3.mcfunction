...
execute if block ^-1 ^ ^ #minecraft:fences rotated ~90 0 positioned ^ ^ ^1 if score temp_0 mech_data matches -1.. run function mechanization:machines/machines/quarry/scan_4