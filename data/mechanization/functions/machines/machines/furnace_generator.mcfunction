...
execute store result score temp_1 mech_data run data get block ~ ~ ~ BurnTime
...
execute if score temp_0 mech_data matches 1 if entity @s[tag=mech_upgrade_nether] run scoreboard players add @s mech_power 30
...
execute if score temp_1 mech_data matches 19000.. store result block ~ ~ ~ BurnTime short 0.5 run scoreboard players get temp_1 mech_data
