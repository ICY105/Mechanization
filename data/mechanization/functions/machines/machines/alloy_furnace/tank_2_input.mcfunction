...
execute if data block ~ ~ ~ Items[{Slot:4b}].tag.ctc.traits.liquid.molten run scoreboard players set $in_0 mechanization.data 0
...
execute if data block ~ ~ ~ Items[{Slot:4b}].tag{mech_itemid:1108} unless data block ~ ~ ~ Items[{Slot:4b}].tag.ctc.traits.liquid run scoreboard players set $in_0 mechanization.data 0
...
execute if score $in_0 mechanization.data matches 0.. if data block ~ ~ ~ Items[{Slot:4b}] run data modify storage du:temp obj.input_item set from block ~ ~ ~ Items[{Slot:4b}]
execute if score $in_0 mechanization.data matches 0.. if data block ~ ~ ~ Items[{Slot:22b}] run data modify storage du:temp obj.output_item set from block ~ ~ ~ Items[{Slot:22b}]
...
#store data
execute if score $in_0 mechanization.data matches 0.. unless data storage du:temp obj.input_item.id run item replace block ~ ~ ~ container.4 with minecraft:air
execute if score $in_0 mechanization.data matches 0.. run data modify storage du:temp obj.output_item.Slot set value 22b
