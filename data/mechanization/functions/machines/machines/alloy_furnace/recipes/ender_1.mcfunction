...
execute if score temp_3 mech_data matches 0 run replaceitem block ~ ~ ~ container.7 firework_star{mech_itemid: 2113, Explosion: {Colors: [I; 8388727]}, HideFlags: 32, display: {Name: "{\"text\":\"Ender Ingot\",\"color\":\"dark_purple\",\"italic\":false}"}, OreDict: ["ingotEnder"]} 4