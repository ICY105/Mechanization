...
execute if score temp_3 mech_data matches 0 run replaceitem block ~ ~ ~ container.7 firework_star{mech_itemid: 2106, Explosion: {Colors: [I; 6710886]}, HideFlags: 32, display: {Name: "{\"text\":\"Steel Ingot\",\"color\":\"gray\",\"italic\":false}"}, OreDict: ["ingotSteel"]} 1