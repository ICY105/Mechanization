...
execute if score $temp_6 mech_data matches 0 if score $temp_0 mech_data matches 4.. if data storage du:temp obj.slot1{id:"minecraft:netherite_scrap"} unless predicate mechanization:alloy_furnace_nether_upgrade store success score $temp_6 mech_data run scoreboard players remove $temp_0 mech_data 2
execute if score $temp_6 mech_data matches 0 if score $temp_1 mech_data matches 4.. if data storage du:temp obj.slot2{id:"minecraft:netherite_scrap"} unless predicate mechanization:alloy_furnace_nether_upgrade store success score $temp_6 mech_data run scoreboard players remove $temp_1 mech_data 2
execute if score $temp_6 mech_data matches 0 if score $temp_2 mech_data matches 4.. if data storage du:temp obj.slot3{id:"minecraft:netherite_scrap"} unless predicate mechanization:alloy_furnace_nether_upgrade store success score $temp_6 mech_data run scoreboard players remove $temp_2 mech_data 2
