...
execute if score $temp_6 mechanization.data matches 3 run tag @s add mech_errored
...
execute if score $temp_6 mechanization.data matches 2 run tag @s add mech_errored
