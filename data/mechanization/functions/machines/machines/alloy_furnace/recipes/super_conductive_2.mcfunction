...
execute if score temp_4 mech_data matches 0 if score temp_3 mech_data matches 0 run loot replace block ~ ~ ~ container.7 loot mechanization:base/super_conductive_ingot
