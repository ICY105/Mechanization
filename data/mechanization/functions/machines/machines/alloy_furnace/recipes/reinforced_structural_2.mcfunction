...
execute if score temp_3 mech_data matches 1.. unless data block ~ ~ ~ Items[{Slot:7b,tag:{OreDict:["ingotReinforcedStructural"]}}] run scoreboard players set temp_4 mech_data 1
...
execute if score temp_4 mech_data matches 0 run scoreboard players remove temp_2 mech_data 1
...
execute if score temp_4 mech_data matches 0 if score temp_3 mech_data matches 0 run loot replace block ~ ~ ~ container.7 loot mechanization:base/reinforced_structural_ingot
