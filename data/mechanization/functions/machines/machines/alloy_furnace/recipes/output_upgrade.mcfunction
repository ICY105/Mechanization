...
execute if score $temp_6 mechanization.data matches 3 if score $temp_5 mechanization.data matches 3857.. run scoreboard players set $temp_6 mechanization.data 0
execute if score $temp_6 mechanization.data matches 3 run function mechanization:machines/machines/alloy_furnace/recipes/titanium_steel
...
execute if score $temp_6 mechanization.data matches 3 if score $temp_5 mechanization.data matches 3857.. run scoreboard players set $temp_6 mechanization.data 0
execute if score $temp_6 mechanization.data matches 3 run function mechanization:machines/machines/alloy_furnace/recipes/reinforced_structural_alloy
...
execute if score $temp_6 mechanization.data matches 3 if score $temp_5 mechanization.data matches 3857.. run scoreboard players set $temp_6 mechanization.data 0
execute if score $temp_6 mechanization.data matches 3 run function mechanization:machines/machines/alloy_furnace/recipes/super_conductive_alloy
...
execute if score $temp_6 mechanization.data matches 3 run function mechanization:machines/machines/alloy_furnace/recipes/nether_alloy
...
execute if score $temp_6 mechanization.data matches 3 if score $temp_5 mechanization.data matches 3425.. run scoreboard players set $temp_6 mechanization.data 0
execute if score $temp_6 mechanization.data matches 3 run function mechanization:machines/machines/alloy_furnace/recipes/ender_alloy
...
execute if score $temp_6 mechanization.data matches 2 run function mechanization:machines/machines/alloy_furnace/recipes/netherite
