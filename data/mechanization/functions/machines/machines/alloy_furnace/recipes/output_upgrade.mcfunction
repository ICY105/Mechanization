...
execute if score $temp_6 mech_data matches 3 run function mechanization:machines/machines/alloy_furnace/recipes/steel
...
execute if score $temp_6 mech_data matches 3 if score $temp_5 mech_data matches 3857.. run scoreboard players set $temp_6 mech_data 0
execute if score $temp_6 mech_data matches 3 run function mechanization:machines/machines/alloy_furnace/recipes/structural_alloy
...
execute if score $temp_6 mech_data matches 3 run function mechanization:machines/machines/alloy_furnace/recipes/crystal_composite
...
execute if score $temp_6 mech_data matches 3 if score $temp_5 mech_data matches 3857.. run scoreboard players set $temp_6 mech_data 0
execute if score $temp_6 mech_data matches 3 run function mechanization:machines/machines/alloy_furnace/recipes/titanium_steel
...
execute if score $temp_6 mech_data matches 3 if score $temp_5 mech_data matches 3857.. run scoreboard players set $temp_6 mech_data 0
execute if score $temp_6 mech_data matches 3 run function mechanization:machines/machines/alloy_furnace/recipes/reinforced_structural_alloy
...
execute if score $temp_6 mech_data matches 3 if score $temp_5 mech_data matches 3857.. run scoreboard players set $temp_6 mech_data 0
execute if score $temp_6 mech_data matches 3 run function mechanization:machines/machines/alloy_furnace/recipes/super_conductive_alloy
...
execute if score $temp_6 mech_data matches 3 run function mechanization:machines/machines/alloy_furnace/recipes/nether_alloy
...
execute if score $temp_6 mech_data matches 3 if score $temp_5 mech_data matches 3425.. run scoreboard players set $temp_6 mech_data 0
execute if score $temp_6 mech_data matches 3 run function mechanization:machines/machines/alloy_furnace/recipes/ender_alloy
...
execute if score $temp_6 mech_data matches 2 run function mechanization:machines/machines/alloy_furnace/recipes/netherite
...
scoreboard players operation @s mech_fluid = $temp_3 mech_data
scoreboard players operation @s du_data = $temp_4 mech_data
scoreboard players operation @s mech_usedid = $temp_5 mech_data
execute if score @s mech_fluid matches 0 run data modify entity @s Item.tag.tank_1 set value {}
