...
execute unless data storage mechanization:temp obj.tank3.tag.mechanization.liquid{id:"molten_nether_alloy"} run loot replace block -30000000 0 3201 container.0 loot mechanization:base/liquids/vial_of_molten_nether_alloy
execute unless data storage mechanization:temp obj.tank3.tag.mechanization.liquid{id:"molten_nether_alloy"} run data modify entity @s Item.tag.tank_3 set from block -30000000 0 3201 Items[0]
