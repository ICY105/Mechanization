...
execute if data entity @s Item.tag.tank_1.tag.ctc.traits.liquid.molten run scoreboard players add $temp_0 mech_data 17
execute store result block ~ ~ ~ Items[{Slot:11b}].tag.CustomModelData int 1 run scoreboard players get $temp_0 mech_data
execute if score @s mech_fluid matches 1.. run data modify storage du:temp var set from entity @s Item.tag.tank_1.tag.ctc.traits.liquid.name
...
execute if score @s mech_fluid matches 1.. run data modify block ~ ~ ~ Items[{Slot:11b}].tag.display.Name set from block -29999999 0 1602 Text1
...
execute if score @s mech_fluid matches 1.. run data modify block ~ ~ ~ Items[{Slot:11b}].tag.display.Lore append from block -29999999 0 1602 Text1
execute if score @s mech_fluid matches 1.. run data modify block ~ ~ ~ Items[{Slot:11b}].tag.display.color set from entity @s Item.tag.tank_1.tag.ctc.traits.liquid.color
...
scoreboard players operation $temp_0 mech_data /= $cons.250 du_data
scoreboard players add $temp_0 mech_data 6422900
execute if data entity @s Item.tag.tank_2.tag.ctc.traits.liquid.molten run scoreboard players add $temp_0 mech_data 17
...
scoreboard players operation $temp_0 mech_data = @s mech_usedid
scoreboard players operation $temp_1 mech_data = @s mech_usedid
scoreboard players add $temp_0 mech_data 249
scoreboard players operation $temp_0 mech_data /= $cons.250 du_data
scoreboard players add $temp_0 mech_data 6422900
execute if data entity @s Item.tag.tank_3.tag.ctc.traits.liquid.molten run scoreboard players add $temp_0 mech_data 17
execute store result block ~ ~ ~ Items[{Slot:17b}].tag.CustomModelData int 1 run scoreboard players get $temp_0 mech_data
execute if score @s mech_usedid matches 1.. run data modify storage du:temp var set from entity @s Item.tag.tank_3.tag.ctc.traits.liquid.name
execute if score @s mech_usedid matches 1.. run data modify block -29999999 0 1602 Text1 set value '{"nbt":"var","storage":"du:temp","interpret":true,"italic":false}'
execute if score @s mech_usedid matches 1.. run data modify block ~ ~ ~ Items[{Slot:17b}].tag.display.Name set from block -29999999 0 1602 Text1
execute if score @s mech_usedid matches 1.. run data modify block -29999999 0 1602 Text1 set value '{"translate":"mech.lore.liquid_amount","italic":false,"color":"gray","with":[{"score":{"name":"$temp_1","objective":"mech_data"}}]}'
execute if score @s mech_usedid matches 1.. run data modify block ~ ~ ~ Items[{Slot:17b}].tag.display.Lore append from block -29999999 0 1602 Text1
execute if score @s mech_usedid matches 1.. run data modify block ~ ~ ~ Items[{Slot:17b}].tag.display.color set from entity @s Item.tag.tank_3.tag.ctc.traits.liquid.color
