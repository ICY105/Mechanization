...
data modify block -30000000 0 3202 Text1 set value '[{"text":"Entity: ","color":"gray","italic":false},{"nbt":"object.tag.spawner_data.SpawnData.id","storage":"mechanization:temp","color":"gray","italic":false}]'
