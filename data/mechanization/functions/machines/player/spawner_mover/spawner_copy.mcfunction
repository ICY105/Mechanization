...
data modify block -30000000 0 3202 Text1 set value '[{"text":"Entity: ","color":"gray","italic":false},{"nbt":"object.tag.mechanization.spawner_data.SpawnData.entity.id","storage":"mechanization:temp","color":"gray","italic":false}]'
data modify storage mechanization:temp object.tag.display.Lore set value []
data modify storage mechanization:temp object.tag.display.Lore prepend from block -30000000 0 3202 Text1
