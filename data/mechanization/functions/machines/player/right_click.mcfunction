...
execute if score @s[gamemode=!adventure] mechanization.item_id matches 18 if data entity @s SelectedItem.tag.mechanization{id:"spawner_controller"} run function mechanization:machines/blocks/spawner_controller/place
