...
execute if score @s[gamemode=!adventure] mechanization.item_id matches 17 if data entity @s SelectedItem.tag.mechanization{id:"spawner_controller"} run function mechanization:machines/machines/spawner_controller/place
