...
execute if score temp_0 mech_data matches 1 at @e[tag=mech_ray_start] run summon armor_stand ~ ~ ~ {Tags:["mech_spawner_controller","mech_receiver"],Marker:1b,Invisible:1,Invulnerable:1,NoGravity:1,DisabledSlots:2039583,ArmorItems:[{},{},{},{id:diamond_shovel,Count:1b,tag:{Unbreakable:1,Damage:77}}]}
