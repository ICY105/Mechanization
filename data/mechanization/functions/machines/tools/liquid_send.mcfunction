...
execute if entity @s[tag=mech_liquid_tank] run function mechanization:machines/machines/liquid_tank/send_liquid
execute if entity @s[tag=mech_steam_generator] run function mechanization:machines/machines/steam_generator/send_liquid
