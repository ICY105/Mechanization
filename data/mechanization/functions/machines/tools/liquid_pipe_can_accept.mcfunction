...
execute if entity @s[tag=mech_reformer] run scoreboard players set $out_0 mech_data 1
execute if entity @s[tag=mech_ench_station] run scoreboard players set $out_0 mech_data 1
