...
scoreboard players operation temp_0 mech_data = out_0 du_data
...
scoreboard players add temp_2 mech_data 16

scoreboard players set in_0 du_data 10
function du:math/random
scoreboard players operation temp_3 mech_data = out_0 du_data

function mechanization:machines/worldgen/tin_ore/displace_x