...
execute if score #count mechanization.data matches ..63 if score @s[tag=mechanization.upgraded,tag=!mechanization.upgraded.ender] mechanization.data matches 5 if score @s mechanization.fluid.0 matches 288.. run function mechanization:machines/machines/casting_basin/recipes/output_rod
execute if score #count mechanization.data matches ..63 if score @s[tag=mechanization.upgraded,tag=!mechanization.upgraded.ender] mechanization.data matches 6 if score @s mechanization.fluid.0 matches 432.. run function mechanization:machines/machines/casting_basin/recipes/output_plate
execute if score #count mechanization.data matches ..63 if score @s[tag=mechanization.upgraded,tag=!mechanization.upgraded.ender] mechanization.data matches 7 if score @s mechanization.fluid.0 matches 576.. run function mechanization:machines/machines/casting_basin/recipes/output_gear

execute if score #count mechanization.data matches ..63 if score @s[tag=mechanization.upgraded.ender] mechanization.data matches 5 if score @s mechanization.fluid.0 matches 144.. run function mechanization:machines/machines/casting_basin/recipes/output_rod
execute if score #count mechanization.data matches ..63 if score @s[tag=mechanization.upgraded.ender] mechanization.data matches 6 if score @s mechanization.fluid.0 matches 288.. run function mechanization:machines/machines/casting_basin/recipes/output_plate
execute if score #count mechanization.data matches ..63 if score @s[tag=mechanization.upgraded.ender] mechanization.data matches 7 if score @s mechanization.fluid.0 matches 432.. run function mechanization:machines/machines/casting_basin/recipes/output_gear
