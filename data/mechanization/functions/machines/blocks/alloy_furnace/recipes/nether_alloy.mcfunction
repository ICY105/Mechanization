...
scoreboard players set #success mechanization.data 0
execute if score #success mechanization.data matches 0 if score #storage.0 mechanization.data matches 4000.. if data storage mechanization:temp obj.tank_1.tag{id:"lava"} store success score #success mechanization.data run scoreboard players remove #storage.0 mechanization.data 4000
execute if score #success mechanization.data matches 0 if score #storage.1 mechanization.data matches 4000.. if data storage mechanization:temp obj.tank_2.tag{id:"lava"} store success score #success mechanization.data run scoreboard players remove #storage.1 mechanization.data 4000
