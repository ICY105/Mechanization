...
# Summon Entity & Init
summon minecraft:item_frame ~ ~ ~ {Tags:["mechanization", "mechanization.solar_panel.model", "smithed.block"], CustomName:'{"translate":"mech.block.solar_panel"}', Item:{id:"minecraft:blast_furnace", tag:{CustomModelData:6422908}, Count:1b}, Invisible:1b, Invulnerable:1b, Fixed:1b, Silent:1b}
