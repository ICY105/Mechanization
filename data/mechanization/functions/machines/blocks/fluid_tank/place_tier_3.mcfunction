...
# Summon Entity & Init
summon minecraft:item_display ~ ~ ~ {Tags:["mechanization", "mechanization.new", "mechanization.liquid_tank", "mechanization.fluid_tank.t3", "fluid.tank", "smithed.block"], CustomName:'{"translate":"block.mechanization.tier_3_fluid_tank"}', item:{id:"minecraft:blast_furnace", tag:{CustomModelData:6422025}, Count:1b}}
