...
# Summon Entity & Init
summon minecraft:item_display ~ ~ ~ {Tags:["mechanization", "mechanization.new", "mechanization.electric_lamp", "mechanization.redstone_control", "mechanization.has_block_hitbox", "energy.receive", "smithed.block"], CustomName:'{"translate":"block.mechanization.electric_lamp"}', item:{id:"minecraft:blast_furnace", tag:{CustomModelData:6422032}, Count:1b}}
