...
execute if entity @s[tag=mechanization.thermoelectric_generator] if score #network.tank fluid.data matches 0 if score #temperature mechanization.data matches 100.. run scoreboard players set #out fluid.data 0
