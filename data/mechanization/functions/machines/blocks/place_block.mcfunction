...
# Liquid Tanks
execute if score #id mechanization.data matches 32 if data storage smithed.custom_block:main blockApi{id:"mechanization:tier_1_liquid_tank"} run function mechanization:machines/blocks/liquid_tank/place_tier_1
execute if score #id mechanization.data matches 32 if data storage smithed.custom_block:main blockApi{id:"mechanization:tier_2_liquid_tank"} run function mechanization:machines/blocks/liquid_tank/place_tier_2
execute if score #id mechanization.data matches 32 if data storage smithed.custom_block:main blockApi{id:"mechanization:tier_3_liquid_tank"} run function mechanization:machines/blocks/liquid_tank/place_tier_3
...
execute if score #id mechanization.data matches 24 if data storage smithed.custom_block:main blockApi{id:"mechanization:turn_table"} run function mechanization:machines/blocks/turn_table/place
...
execute if score #id mechanization.data matches 25 if data storage smithed.custom_block:main blockApi{id:"mechanization:liquid_pipe"} run function mechanization:machines/blocks/liquid_pipe/place
...
execute if score #id mechanization.data matches 26 if data storage smithed.custom_block:main blockApi{id:"mechanization:super_piston"} run function mechanization:machines/blocks/super_piston/place
...
execute if score #id mechanization.data matches 33 if data storage smithed.custom_block:main blockApi{id:"mechanization:super_sticky_piston"} run function mechanization:machines/blocks/super_sticky_piston/place
