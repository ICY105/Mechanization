...
# trigger teleport
execute if score #dimension mechanization.data matches 0 positioned ~ ~1 ~ align xyz run title @a[dx=0,dy=0,dz=0] actionbar [{"translate":"text.mechanization.teleporter.no_destination","color":"green"}]
