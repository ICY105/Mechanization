...
execute if score #output_count mechanization.data matches 0..58 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:mangrove_log"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_other mechanization.data
execute if score #output_count mechanization.data matches 0..58 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:cherry_log"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_other mechanization.data

execute if score #output_count mechanization.data matches 0..58 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:oak_wood"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_other mechanization.data
execute if score #output_count mechanization.data matches 0..58 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:birch_wood"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_other mechanization.data
execute if score #output_count mechanization.data matches 0..58 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:spruce_wood"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_other mechanization.data
execute if score #output_count mechanization.data matches 0..58 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:jungle_wood"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_other mechanization.data
execute if score #output_count mechanization.data matches 0..58 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:dark_oak_wood"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_other mechanization.data
execute if score #output_count mechanization.data matches 0..58 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:acacia_wood"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_other mechanization.data
execute if score #output_count mechanization.data matches 0..58 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:crimson_stem"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_other mechanization.data
execute if score #output_count mechanization.data matches 0..58 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:warped_stem"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_other mechanization.data
execute if score #output_count mechanization.data matches 0..58 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:mangrove_wood"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_other mechanization.data
execute if score #output_count mechanization.data matches 0..58 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:cherry_wood"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_other mechanization.data

execute if score #output_count mechanization.data matches 0..58 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:stripped_oak_log"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_other mechanization.data
execute if score #output_count mechanization.data matches 0..58 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:stripped_birch_log"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_other mechanization.data
execute if score #output_count mechanization.data matches 0..58 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:stripped_spruce_log"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_other mechanization.data
execute if score #output_count mechanization.data matches 0..58 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:stripped_jungle_log"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_other mechanization.data
execute if score #output_count mechanization.data matches 0..58 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:stripped_dark_oak_log"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_other mechanization.data
execute if score #output_count mechanization.data matches 0..58 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:stripped_acacia_log"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_other mechanization.data
execute if score #output_count mechanization.data matches 0..58 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:stripped_crimson_stem"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_other mechanization.data
execute if score #output_count mechanization.data matches 0..58 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:stripped_warped_stem"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_other mechanization.data
execute if score #output_count mechanization.data matches 0..58 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:stripped_mangrove_log"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_other mechanization.data
execute if score #output_count mechanization.data matches 0..58 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:stripped_cherry_log"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_other mechanization.data

execute if score #output_count mechanization.data matches 0..58 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:stripped_oak_wood"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_other mechanization.data
execute if score #output_count mechanization.data matches 0..58 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:stripped_birch_wood"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_other mechanization.data
execute if score #output_count mechanization.data matches 0..58 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:stripped_spruce_wood"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_other mechanization.data
execute if score #output_count mechanization.data matches 0..58 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:stripped_jungle_wood"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_other mechanization.data
execute if score #output_count mechanization.data matches 0..58 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:stripped_dark_oak_wood"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_other mechanization.data
execute if score #output_count mechanization.data matches 0..58 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:stripped_acacia_wood"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_other mechanization.data
execute if score #output_count mechanization.data matches 0..58 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:stripped_crimson_stem"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_other mechanization.data
execute if score #output_count mechanization.data matches 0..58 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:stripped_warped_stem"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_other mechanization.data
execute if score #output_count mechanization.data matches 0..58 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:stripped_mangrove_wood"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_other mechanization.data
execute if score #output_count mechanization.data matches 0..58 if data block ~ ~ ~ Items[{Slot:0b,id:"minecraft:stripped_cherry_wood"}] run scoreboard players operation @s mechanization.time = #machines.cf.grinder.speed_other mechanization.data
