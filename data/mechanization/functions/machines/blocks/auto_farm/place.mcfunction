...
# Summon Entity & Init
summon minecraft:item_display ~ ~ ~ {Tags:["mechanization", "mechanization.new", "mechanization.auto_farm", "mechanization.redstone_control", "mechanization.upgradable", "mechanization.has_block_hitbox", "energy.receive", "smithed.block"], CustomName:'{"translate":"block.mechanization.auto_farm"}', item:{id:"minecraft:blast_furnace", tag:{CustomModelData:6422005}, Count:1b}}
