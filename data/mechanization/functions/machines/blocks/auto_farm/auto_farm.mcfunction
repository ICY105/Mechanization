...
execute if score #active mechanization.data matches 1 if score @s energy.storage >= #machines.cf.auto_farm.power mechanization.data if entity @s[tag=mechanization.upgraded] run tp @e[type=minecraft:item,distance=..5] ~ ~1 ~
